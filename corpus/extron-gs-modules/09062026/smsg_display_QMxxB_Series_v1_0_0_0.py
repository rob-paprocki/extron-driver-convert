...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False' and self._DeviceID != 254:
            self.AddMatchString(re.compile(b'\xAA\xFF[\x00-\xE0]\x03\x41\x13([\x00\x01])[\x00-\xFF]'), self.__MatchAudioMute, None)
            self.AddMatchString(re.compile(b'\xAA\xFF[\x00-\xE0]\x03\x41\x14([\x18\x1F\x20\x60\x21\x22\x23\x24\x31\x32\x25])[\x00-\xFF]'), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'\xAA\xFF[\x00-\xE0]\x04\x41\x89([\x00-\xFF])([\x00-\xE1])[\x00-\xFF]'), self.__MatchVideoWallSize, None)
            self.AddMatchString(re.compile(b'\xAA\xFF[\x00-\xE0]\x03\x41\x12([\x00-\x64])[\x00-\xFF]'), self.__MatchVolume, None)
            self.AddMatchString(re.compile(b'\xAA\xFF[\x00-\xE0][\x00-\xFF]\x4E([\x13\x14\x11\\x5D\x84\\x5C\x89\x12])'), self.__MatchError, None)
    ...
    def SetAudioMute(self, value, qualifier):
        ...
        if value in ValueStateValues:
            AudioMuteCmdString = self.build_set(0x13, ValueStateValues[value])
    ...
    def UpdateAudioMute(self, value, qualifier):
        ...
        AudioMuteCmdString = self.build_get(0x13)
    ...
    def SetVideoWall(self, value, qualifier):
        ...
        if value in ValueStateValues:
            VideoWallCmdString = self.build_set(0x84, ValueStateValues[value])
    ...
    def UpdateVideoWall(self, value, qualifier):
        ...
        VideoWallCmdString = self.build_get(0x84)
    ...
    def SetVideoWallMode(self, value, qualifier):
        ...
        if value in ValueStateValues:
            VideoWallModeCmdString = self.build_set(0x5C, ValueStateValues[value])
    ...
    def UpdateVideoWallMode(self, value, qualifier):
        ...
        VideoWallModeCmdString = self.build_get(0x5C)
    ...
    def SetVideoWallSize(self, value, qualifier):
        ...
        if 1 <= horizontal <= 15 and 1 <= vertical <= 15 and 1 <= valueInt <= 225:
            if valueInt <= horizontal * vertical:
                position = horizontal * 16 + vertical
                VideoWallSizeCmdString = self.build_set(0x89, bytes([position, valueInt]))
    ...
    def UpdateVideoWallSize(self, value, qualifier):
        ...
        if 1 <= int(qualifier['Row']) <= 15 and 1 <= int(qualifier['Column']) <= 15:
            VideoWallSizeCmdString = self.build_get(0x89)
    ...
    def __MatchVideoWallSize(self, match, tag):
        ...
        value = str(ord(match.group(2)))
        self.WriteStatus('VideoWallSize', value, qualifier)

    def SetVolume(self, value, qualifier):

        if 0 <= value <= 100:
            VolumeCmdString = self.build_set(0x12, bytes([value]))
    ...
    def UpdateVolume(self, value, qualifier):
        ...
        VolumeCmdString = self.build_get(0x12)
