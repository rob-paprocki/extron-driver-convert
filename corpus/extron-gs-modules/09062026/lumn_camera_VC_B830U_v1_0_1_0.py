...
class DeviceClass:
    ...
    def DeviceID(self, value):
        if 1 <= int(value) <= 7:
            ...
            self.Discard('Invalid DeviceID: {}.\r\n Please use a valid range of 1 - 7'.format(value))
    ...
    def SetAutoExposure(self, value, qualifier):
        ...
        AutoExposureCmdString = bytes([self.DeviceID, 0x01, 0x04, 0x39, state, 0xFF])
    ...
    def SetBacklight(self, value, qualifier):
        ...
        BacklightCmdString = bytes([self.DeviceID, 0x01, 0x04, 0x33, state, 0xFF])
    ...
    def SetFocus(self, value, qualifier):
        ...
        FocusCmdString = bytes([self.DeviceID, 0x01, 0x04, 0x08, state, 0xFF])
    ...
    def SetFocusMode(self, value, qualifier):
        ...
        FocusModeCmdString = bytes([self.DeviceID, 0x01, 0x04, 0x38, state, 0xFF])
    ...
    def SetFreeze(self, value, qualifier):
        ...
        FreezeCmdString = bytes([self.DeviceID, 0x01, 0x04, 0x62, state, 0xFF])
    ...
    def UpdateFreeze(self, value, qualifier):
        ...
        FreezeCmdString = bytes([self.DeviceID, 0x09, 0x04, 0x62, 0xFF])
    ...
    def SetIris(self, value, qualifier):
        ...
        IrisCmdString = bytes([self.DeviceID, 0x01, 0x04, 0x0B, state, 0xFF])
    ...
    def SetPanTilt(self, value, qualifier):
        ...
        if 1 <= panSpeed <= 24 and 1 <= tiltSpeed <= 24:
            PanTiltCmdString = bytes([self.DeviceID, 0x01, 0x06, 0x01, panSpeed, tiltSpeed, state[0], state[1], 0xFF])
    ...
    def SetPower(self, value, qualifier):
        ...
        PowerCmdString = bytes([self.DeviceID, 0x01, 0x04, 0x00, state, 0xFF])
    ...
    def SetPreset(self, value, qualifier):
        ...
        state = int(value)
        if 0 <= state <= 127:
            PresetRecallCmdString = bytes([self.DeviceID, 0x01, 0x04, 0x3F, function, state, 0xFF])
    ...
    def SetZoom(self, value, qualifier):
        ...
        ZoomCmdString = bytes([self.DeviceID, 0x01, 0x04, 0x07, state, 0xFF])
