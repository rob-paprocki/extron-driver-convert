...
class DeviceClass:
    ...
    def UpdateMACAddress(self, value, qualifier):
        ...
        MACAddressCmdString = '~00555 1\r'
        res = self.__UpdateHelper('MACAddress', MACAddressCmdString, value, qualifier)
        if res:
            try:
                value = res[2:-1]
                self.WriteStatus('MACAddress', value, qualifier)
            except (ValueError, IndexError, AttributeError):
    ...
    def UpdateSerialNumber(self, value, qualifier):
        ...
        SerialNumberCmdString = '~00353 1\r'
    ...
    def UpdateSoftwareVersion(self, value, qualifier):
        ...
        SoftwareVersionCmdString = '~00122 1\r'
        res = self.__UpdateHelper('SoftwareVersion', SoftwareVersionCmdString, value, qualifier)
        if res:
            try:
                value = res[2:-1]
