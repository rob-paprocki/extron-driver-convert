...
class DeviceSerialClass:
    ...
    def SetAVMute(self, value, qualifier):
        ...
        AVMuteCmdString = ValueStateValues[value].format(self.DeviceID)
    ...
    def SetDisplayMode(self, value, qualifier):
        ...
        DisplayModeCmdString = ValueStateValues[value].format(self.DeviceID)
    ...
    def UpdateDisplayMode(self, value, qualifier):
        ...
        DisplayModeCmdString = '~{}123 1\r'.format(self.DeviceID)
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'VGA'             : '~{}12 5\r', 
            'Video'           : '~{}12 10\r', 
            'Network Display' : '~{}12 18\r', 
            'USB Display'     : '~{}12 19\r', 
            'Multimedia'      : '~{}12 23\r'
        }

        InputCmdString = ValueStateValues[value].format(self.DeviceID)
    ...
    def UpdateInput(self, value, qualifier):
        ...
        InputCmdString = '~{}121 1\r'.format(self.DeviceID)
    ...
    def UpdateLampUsage(self, value, qualifier):
        ...
        LampUsageCmdString = '~{}108 1\r'.format(self.DeviceID)
    ...
    def SetPower(self, value, qualifier):
        ...
        PowerCmdString = ValueStateValues[value].format(self.DeviceID)
    ...
    def UpdatePower(self, value, qualifier):
        ...
        PowerCmdString = '~{}124 1\r'.format(self.DeviceID)
...
class DeviceEthernetClass:
    ...
    def SetPowerOff(self, value, qualifier):
        ...
        PowerOffCmdString = '~{}00 0\r\r'.format(self.DeviceID)
