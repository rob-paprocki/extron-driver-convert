...
class DeviceSerialClass:
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'Full 1'      : b'\x8C\x00\x44\x03\x01\x06\xDA', 
            'Full 2'      : b'\x8C\x00\x44\x03\x01\x07\xDB'
        }
    ...
    def SetPictureMode(self, value, qualifier):
        ...
        ValueStateValues = {
            'Vivid'    : b'\x8C\x00\x20\x03\x01\x00\xB0', 
            'Standard' : b'\x8C\x00\x20\x03\x01\x01\xB1', 
            'Cinema'   : b'\x8C\x00\x20\x03\x01\x02\xB2', 
            'Custom'   : b'\x8C\x00\x20\x03\x01\x03\xB3', 
            'Cine2'    : b'\x8C\x00\x20\x03\x01\x06\xB6', 
            'Sports'   : b'\x8C\x00\x20\x03\x01\x07\xB7', 
            'Game'     : b'\x8C\x00\x20\x03\x01\x08\xB8', 
            'Graphics' : b'\x8C\x00\x20\x03\x01\x09\xB9'
        }
