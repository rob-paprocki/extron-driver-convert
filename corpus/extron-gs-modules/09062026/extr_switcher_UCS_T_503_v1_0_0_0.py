...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'Sig(?P<Input1>[0-1]) (?P<Input2>[0-1]) (?P<Input3>[0-1])\*(?P<Output1>[0-1]) (?P<Output2>[0-1])\r\n'), self.__MatchInputSignalStatus, None)
            self.AddMatchString(re.compile(b'HdcpO(?P<Output1>[0-2]) (?P<Output2>[0-2])\r\n'), self.__MatchOutputHDCPStatus, None)
            ...
            self.AddMatchString(re.compile(b'Vmt(?P<value>[0-2])\*[0-2]\r\n'), self.__MatchVideoMute, None)
    ...
    def UpdateInputHDCPAuthorization(self, value, qualifier):
        ...
        if 1 <= int(qualifier['Input']) <= 3:
            ...
            self.Discard('Invalid Command for UpdateInputHDCPAuthorization')
    ...
    def __MatchInputSignalStatus(self, match, tag):
        ...
        output1 = ValueStateValues[match.group('Output1').decode()]
        self.WriteStatus('OutputSignalStatus', output1, {'Output': '1'})
        output2 = ValueStateValues[match.group('Output2').decode()]
        self.WriteStatus('OutputSignalStatus', output2, {'Output': '2'})
    ...
    def __MatchOutputHDCPStatus(self, match, tag):
        ...
        value1 = ValueStateValues[match.group('Output1').decode()]
        self.WriteStatus('OutputHDCPStatus', value1, {'Output': '1'})
        value2 = ValueStateValues[match.group('Output2').decode()]
        self.WriteStatus('OutputHDCPStatus', value2, {'Output': '2'})
