...
class DeviceClass:
    def __init__(self):
        ...
        if 'Serial' not in self.ConnectionType:
            ...
            self.md5hash = b''
            self.AddMatchString(re.compile(b'(NTCONTROL|PDPCONTROL) 1 ([a-f0-9]{8})\r'), self.__MatchAuthentication, None)
            self.AddMatchString(re.compile(b'(ERRA|PDPCONTROL ERRA)\r'), self.__MatchFaliedPassword, None)
        else:
            self.Delim = b''
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'Normal':           b'DAM:NORM',
            'Real':             b'DAM:NATV',
            'Horizontal Fit':   b'DAM:HFIT',
            'Vertical Fit':     b'DAM:VFIT',
            'Zoom 1':           b'DAM:ZOOM',
            'Zoom 2':           b'DAM:ZOM2'
            }
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'Slot':                 b'IMS:SL1',
            'PC':                   b'IMS:PC1',
            'Screen Transfer':      b'IMS:NW1',
            'USB/Internal Memory':  b'IMS:UD1',
            'Memory Viewer':        b'IMS:MV1',
            'Whiteboard':           b'IMS:WB1'
            }
    ...
    def SetPictureMode(self, value, qualifier):
        ...
        ValueStateValues = {
            'Vivid Signage':    b'VPC:MENVIV',
            'Natural Signage':  b'VPC:MENNAT',
            'Standard':         b'VPC:MENSTD',
            'Surveillance':     b'VPC:MENSUV',
            'Graphic':          b'VPC:MENGRH',
            'Dicom':            b'VPC:MENDCM'
            }
    ...
    def __CheckResponseForErrors(self, sourceCmdName, response):
        ...
        DEVICE_ERROR_CODES = {
            ...
            'PDPCONTROL ERRA':     'Mismatching state of a password',
        }
