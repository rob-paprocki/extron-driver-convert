...
class DeviceSerialClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK([0129][0-3])x', re.I), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'([cembladf]) [0-9a-f]{2} NG(.*)x', re.I), self.__MatchError, None)
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            ...
            self.Error(['Device ID Parameter Out of Range'])
