...
class DeviceClass:
    def __init__(self):
        ...
        self.Models = {
            'RLNK-415R': self.matl_20_2964_4,
            'RLNK-915R': self.matl_20_2964_8
        }
    ...
    def __UpdateHelper(self, command, commandstring, value, qualifier):
        ...
        if self.Unidirectional == 'True' or not self.authenticated:
            if command == 'SequencePowerOutletsStatus':
            ...
            if not self.VerboseDisabled:
                self.Send(commandstring)
            elif command == 'SequencePowerOutletsStatus':
    ...
    def matl_20_2964_4(self):

        self.outlets = 4

    def matl_20_2964_8(self):
