...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'\'OK\',\r'), self.__MatchHeartbeat, None)
            self.AddMatchString(re.compile(b'\'?(P|R)([0-9]{3})( |M|P)\'?,?\r'), self.__MatchMicrophoneStatus, None)

    def SetClear(self, value, qualifier):

        ClearCmdString = '\'P068\',\r'
    ...
    def __MatchMicrophoneStatus(self, match, tag):
        ...
        mic_num = int(match.group(2).decode())
        mic_status = MicStatus[match.group(1).decode()]
        self.WriteStatus('MicrophoneStatus', mic_status, {'Microphone': str(mic_num)})

    def SetMode(self, value, qualifier):

        ValueStateValues = {
            'Request-to-Talk' : '\'P072\',\r', 
            'Manual'          : '\'P073\',\r', 
            'Override'        : '\'P074\',\r', 
            'Auto'            : '\'P075\',\r',
        }
    ...
    def SetNext(self, value, qualifier):

        NextCmdString = '\'P067\',\r'
        self.__SetHelper('Next', NextCmdString, value, qualifier)
