...
class DeviceClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'PhantomPower': {'Parameters':['Mic/Line'], 'Status': {}},
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(compile(b'GrpmD0?6\*([-+]?[0-9]{1,3})\r\n'), self.__MatchGroupTreble, None)
            self.AddMatchString(compile(b'Vmt([1-3])\*([0-2])\r\n'), self.__MatchVideoMute, None)
    ...
    def SetLineInputGain(self, value, qualifier):
        ...
        Type = qualifier['Type']
        Input = qualifier['Input']
        if ValueConstraints['Min'] <= value <= ValueConstraints['Max'] and Input in ['1', '2', '3', '4', '5', '6', '7', '8'] and Type in TypeValues:
    ...
    def UpdateLineInputGain(self, value, qualifier):
        ...
        Type = qualifier['Type']
        Input = qualifier['Input']
        if Input in ['1', '2', '3', '4', '5', '6', '7', '8'] and Type in TypeValues:
            self.__UpdateHelper('LineInputGain', 'w{0}{1:02}AU\r'.format(TypeValues[Type],int(Input)*2-2), value, qualifier)
        else:
    ...
    def __MatchGlobalVideoMute(self, match, tag):
        ...
        for i in OutputNames:
            self.WriteStatus('VideoMute', value, {'Output': OutputNames[i]})
    ...
    def UpdateHDCPOutputStatus(self, value, qualifier):
        ...
        if Output in OutputValues:
            HDCPOutputStatusCmdString = 'wO{0}HDCP\r'.format(OutputValues[Output])
    ...
    def __MatchHDCPOutputStatus(self, match, tag):
        ...
        qualifier = {'Output': OutputNames[int(match.group(1))]}
    ...
    def SetOutputFormat(self, value, qualifier):
        ...
        Output = qualifier['Output']
        if Output in OutputValues:
            commandString = 'w{0}*{1}VTPO\r'.format(OutputValues[Output], OutputFormatTypeValues[value])
    ...
    def UpdateOutputFormat(self, value, qualifier):
        ...
        Output = qualifier['Output']
        if Output in OutputValues:
            commandString = 'w{0}VTPO\r'.format(OutputValues[Output])
    ...
    def SetHDCPInputAuthorization(self, value, qualifier):
        ...
        Input = qualifier['Input']
        if Input in ['1', '2', '3', '4', '5', '6', '7', '8'] and Input not in ['1', '2']:
    ...
    def SetPhantomPower(self, value, qualifier):
        ...
        PhantomPowerCmdString = 'wZ4000{0}*{1}AU\r'.format(MicLineStates[qualifier['Mic/Line']], ValueStateValues[value])
    ...
    def UpdatePhantomPower(self, value, qualifier):
        ...
        PhantomPowerCmdString = 'wZ4000{0}AU\r'.format(MicLineStates[qualifier['Mic/Line']])
    ...
    def SetVideoMute(self, value, qualifier):
        ...
        Output = qualifier['Output']
        if Output in OutputValues:
            VideoMuteCmdString = '{0}*{1}B'.format(OutputValues[Output], ValueStateValues[value])
    ...
    def UpdateVideoMute(self, value, qualifier):
        ...
        Output = qualifier['Output']
        if Output in OutputValues:
            VideoMuteCmdString = '{0}*B'.format(OutputValues[Output])
    ...
    def __MatchError(self, match, tag):
        ...
        DEVICE_ERROR_CODES = {
            ...
            '06' : 'Invalid input channel change',
            '10' : 'Invalid command',
