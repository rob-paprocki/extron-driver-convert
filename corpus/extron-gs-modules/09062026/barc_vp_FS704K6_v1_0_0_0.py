...
class DeviceClass:
    ...
    def SetIllumination(self, value, qualifier):
        ...
        if ValueConstraints['Min'] <= value <= ValueConstraints['Max']:
            ...
            print('Invalid Command for SetIllumination')
    ...
    def SetTestPatternSelect(self, value, qualifier):
        ...
        if value in ValueStateValues:
            ...
            print('Invalid Command for SetTestPatternSelect')
    ...
    def __MatchError(self, match, tag):
        print('Error number {0} occured: {1}'.format(match.group(2).decode(),match.group(3).decode()))
