...
class DeviceSerialClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'b [0-9A-F]{2} OK(90|A0|91|A1|C0|D0|95|A5|60)x',re.I), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'(u|i|j|c|e|m|b|a|d|f|x) ([0-9A-F]{2}) NG(.*?)x',re.I), self.__MatchError, None)            
