...
class DeviceSerialClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'o [0-9a-f]{2} OK0(0|1|2)x'), self.__MatchLocalKeyLock, None)
            ...
            self.AddMatchString(re.compile(b'p [0-9a-f]{2} OK0(0|1|2)x'), self.__MatchRemoteControllerKeyLock, None)
            ...
            self.AddMatchString(re.compile(b'(u|c|e|m|b|l|a|d|f|X|p|o) [0-9a-f]{2} NG(.*)x',re.I), self.__MatchError, None)
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            ...
            self.displayID = '{0:02X}'.format(int(value))
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        CmdString = 'kc {0} {1}\r'.format(self.displayID, States[value])
        self.__SetHelper('AspectRatio', CmdString, value, qualifier)

    def UpdateAspectRatio(self, value, qualifier):
        self.__UpdateHelper('AspectRatio', 'kc {0} FF\r'.format(self.displayID) , value, qualifier)
    ...
    def SetAudioMute(self, value, qualifier):
        ...
        CmdString = 'ke {0} {1}\r'.format(self.displayID, States[value])
        self.__SetHelper('AudioMute', CmdString, value, qualifier)

    def UpdateAudioMute(self, value, qualifier):
        self.__UpdateHelper('AudioMute', 'ke {0} FF\r'.format(self.displayID) , value, qualifier)
    ...
    def SetAutoImage(self, value, qualifier):
        ...
        self.__SetHelper('AutoImage', 'ju {0} 01\r'.format(self.displayID) , value, qualifier)
    ...
    def SetExecutiveMode(self, value, qualifier):
        ...
        CmdString = 'km {0} {1}\r'.format(self.displayID, States[value])
        self.__SetHelper('ExecutiveMode', CmdString, value, qualifier)

    def UpdateExecutiveMode(self, value, qualifier):
        self.__UpdateHelper('ExecutiveMode', 'km {0} FF\r'.format(self.displayID) , value, qualifier)
    ...
    def SetInput(self, value, qualifier):
        ...
        CmdString = 'xb {0} {1}\r'.format(self.displayID, States[value])
        self.__SetHelper('Input', CmdString, value, qualifier)

    def UpdateInput(self, value, qualifier):
        self.__UpdateHelper('Input', 'xb {0} FF\r'.format(self.displayID) , value, qualifier)
    ...
    def SetKeypad(self, value, qualifier):
        ...
        CmdString = 'mc {0} {1}\r'.format(self.displayID, States[value])
    ...
    def SetLocalKeyLock(self, value, qualifier):
        ...
        CmdString = 'to {0} {1}\r'.format(self.displayID, States[value])
        self.__SetHelper('LocalKeyLock', CmdString, value, qualifier)

    def UpdateLocalKeyLock(self, value, qualifier):
        self.__UpdateHelper('LocalKeyLock', 'to {0} FF\r'.format(self.displayID) , value, qualifier)
    ...
    def SetOnScreenDisplay(self, value, qualifier):
        ...
        CmdString = 'kl {0} {1}\r'.format(self.displayID, States[value])
        self.__SetHelper('OnScreenDisplay', CmdString, value, qualifier)

    def UpdateOnScreenDisplay(self, value, qualifier):
        self.__UpdateHelper('OnScreenDisplay', 'kl {0} FF\r'.format(self.displayID) , value, qualifier)
    ...
    def SetPictureMode(self, value, qualifier):
        ...
        CmdString = 'dx {0} {1}\r'.format(self.displayID, States[value])
        self.__SetHelper('PictureMode', CmdString, value, qualifier)

    def UpdatePictureMode(self, value, qualifier):
        self.__UpdateHelper('PictureMode', 'dx {0} FF\r'.format(self.displayID) , value, qualifier)
    ...
    def SetPower(self, value, qualifier):
        ...
        CmdString = 'ka {0} {1}\r'.format(self.displayID, States[value])
        self.__SetHelper('Power', CmdString, value, qualifier)

    def UpdatePower(self, value, qualifier):

        self.__UpdateHelper('Power', 'ka {0} FF\r'.format(self.displayID) , value, qualifier)
    ...
    def SetRemoteControllerKeyLock(self, value, qualifier):
        ...
        CmdString = 'tp {0} {1}\r'.format(self.displayID, States[value])
        self.__SetHelper('RemoteControllerKeyLock', CmdString, value, qualifier)

    def UpdateRemoteControllerKeyLock(self, value, qualifier):
        self.__UpdateHelper('RemoteControllerKeyLock', 'tp {0} FF\r'.format(self.displayID) , value, qualifier)
    ...
    def SetVideoMute(self, value, qualifier):
        ...
        CmdString = 'kd {0} {1}\r'.format(self.displayID, States[value])
        self.__SetHelper('VideoMute', CmdString, value, qualifier)

    def UpdateVideoMute(self, value, qualifier):
        self.__UpdateHelper('VideoMute', 'kd {0} FF\r'.format(self.displayID) , value, qualifier)
    ...
    def SetVolume(self, value, qualifier):
        ...
        if 0 <= value <= 100:
            CmdString = 'kf {0} {1:02X}\r'.format(self.displayID, value)
            self.__SetHelper('Volume', CmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetVolume')

    def UpdateVolume(self, value, qualifier):
        self.__UpdateHelper('Volume', 'kf {0} FF\r'.format(self.displayID) , value, qualifier)
...
class DeviceEthernetClass:
    ...
    def SetPowerOff(self, value, qualifier):
        ...
        CmdString = 'ka {0} 00\r'.format(self.displayID)
        self.__SetHelper('Power', CmdString, value, qualifier)
