...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'HdcpO([0-2])\r'), self.__MatchHDCPOutputStatus, None)
            self.AddMatchString(re.compile(b'In(1|2) All\r\n'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'Sig0 (0|1)\*(0|1)\r\n'), self.__MatchInputSignalStatus, None)
            self.AddMatchString(re.compile(b'Vmt([0-2])\r\n'), self.__MatchVideoMute, None)
            self.AddMatchString(re.compile(b'Vol([-]\d{1,3}|\d{1,3})\r\n'), self.__MatchVolume, None)
