...
class DeviceClass:
    ...
    def __init__(self):
        ...
        self.AddMatchString(re.compile(b'kb [0-9]{2} (RGB|HDMI1|HDMI2|HDMI3|DP)'), self.__MatchInput, None)
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        AspectRatioCmdString = 'kc {0} {1}'.format(self.DeviceID, ValueStateValues[value])
    ...
    def SetExecutiveMode(self, value, qualifier):
        ...
        ExecutiveModeCmdString = 'km {0} {1}'.format(self.DeviceID, ValueStateValues[value])
    ...
    def SetInput(self, value, qualifier):
        ...
        InputCmdString = 'kb {0} {1}'.format(self.DeviceID, ValueStateValues[value])
    ...
    def SetMute(self, value, qualifier):
        ...
        MuteCmdString = 'ke {0} {1}'.format(self.DeviceID, ValueStateValues[value])
