...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'ASPECT=(00|20|30|40|50|60|A0)( 30)?\r:'), self.__MatchAspectRatio, None)
    ...
    def SetSplitScreenLeftInput(self, value, qualifier):
        ...
        SplitScreenLeftInputCmdString = 'SPS 03 {0}\r'.format(ValueStateValues[value])
    ...
    def SetSplitScreenRightInput(self, value, qualifier):
        ...
        SplitScreenRightInputCmdString = 'SPS 04 {0}\r'.format(ValueStateValues[value])
