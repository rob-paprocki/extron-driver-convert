...
class DeviceEthernetClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(rb'\"playback\.status\",\"value\":\"(Playing|Stopped|Paused|FF|FR|video playback|photo playback|TrayOpen|NoMedia)\"}'), self.__MatchPlaybackStatus, None)
            self.AddMatchString(re.compile(rb'\"main\.power\",\"value\":\"(on|off)\"}'), self.__MatchPower, None)
