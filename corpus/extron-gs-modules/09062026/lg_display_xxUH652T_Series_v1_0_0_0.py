...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'c [0-9a-f]{2} OK0([1246])x', re.I), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK(00|01|10|11|20|40|90|91|92)x', re.I), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'l [0-9a-f]{2} OK0([10])x', re.I), self.__MatchOnScreenDisplay, None)
            self.AddMatchString(re.compile(b'd [0-9a-f]{2} OK(01|10|00)x', re.I), self.__MatchVideoMute, None)
            self.AddMatchString(re.compile(b'f [0-9a-f]{2} OK([0-9a-f]{2})x', re.I), self.__MatchVolume, None)
            self.AddMatchString(re.compile(b'([cembldf]) ([0-9a-f]{2}) NG(.*?)x', re.I), self.__MatchError, None)
