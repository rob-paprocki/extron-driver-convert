...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\x02QMI:(HM1|HM2|VD1|DV1|PC1|UD1)\x03'), self.__MatchInput, None)
    ...
    def CommandStringBuild(self, command, commandstring):
        if self.Security == 'Admin':
            commandstring = self.md5hash.encode(encoding='iso-8859-1') + commandstring.encode(encoding='iso-8859-1') + self.Delim.encode(encoding='iso-8859-1') # MD5 Hash String needs to be encoded
        else:
            commandstring = commandstring.encode(encoding='iso-8859-1') + self.Delim.encode(encoding='iso-8859-1')
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        AspectRatioCmdString = self.CommandStringBuild('AspectRatio', '\x02DAM:{0}\x03'.format(AspectRatioState[value]))   
        self.__SetHelper('AspectRatio', AspectRatioCmdString, value, qualifier)

    def UpdateAspectRatio(self, value, qualifier):

        AspectRatioCmdString = self.CommandStringBuild('AspectRatio', '\x02QAS\x03')  
    ...
    def SetAudioMute(self, value, qualifier):
        ...
        AudioMuteCmdString = self.CommandStringBuild('AudioMute', '\x02AMT:{0}\x03'.format(AudioMuteState[value]))
        self.__SetHelper('AudioMute', AudioMuteCmdString, value, qualifier)

    def UpdateAudioMute(self, value, qualifier):

        AudioMuteCmdString = self.CommandStringBuild('AudioMute', '\x02QAM\x03')  
    ...
    def SetAutoImage(self, value, qualifier):
        ...
        AutoImageCmdString = self.CommandStringBuild('AutoImage', '\x02DGE:ASU1\x03')
        self.__SetHelper('AutoImage', AutoImageCmdString, value, qualifier)
    def SetButtonLock(self, value, qualifier):

        ButtonLockState = {
            'Menu and Enter Lock' : 'MEN', 
            'All Lock' : 'ALL',
            'Off' : 'OFF'
            }

        ButtonLockCmdString = self.CommandStringBuild('ButtonLock', '\x02OSP:BTL{0}\x03'.format(ButtonLockState[value]))
        self.__SetHelper('ButtonLock', ButtonLockCmdString, value, qualifier)

    def UpdateButtonLock(self, value, qualifier):

        ButtonLockCmdString = self.CommandStringBuild('ButtonLock', '\x02QSP:BTL\x03')  
        self.__UpdateHelper('ButtonLock', ButtonLockCmdString, value, qualifier)

    def __MatchButtonLock(self, match, tag):

        ButtonLockState = {
            'MEN' : 'Menu and Enter Lock', 
            'ALL' : 'All Lock',
            'OFF' : 'Off'
            }
    ...
    def SetInput(self, value, qualifier):
        ...
        InputCmdString = self.CommandStringBuild('Input', '\x02IMS:{0}\x03'.format(InputState[value]))
        self.__SetHelper('Input', InputCmdString, value, qualifier)

    def UpdateInput(self, value, qualifier):

        InputCmdString = self.CommandStringBuild('Input', '\x02QMI\x03')  
    ...
    def SetOnScreenDisplay(self, value, qualifier):
        ...
        OnScreenDisplayCmdString = self.CommandStringBuild('OnScreenDisplay', '\x02OSP:OSD{0}\x03'.format(OSDState[value]))
        self.__SetHelper('OnScreenDisplay', OnScreenDisplayCmdString, value, qualifier)

    def UpdateOnScreenDisplay(self, value, qualifier):

        OnScreenDisplayCmdString = self.CommandStringBuild('OnScreenDisplay', '\x02QSP:OSD\x03')  
    ...
    def SetPower(self, value, qualifier):
        ...
        PowerCmdString = self.CommandStringBuild('Power', '\x02{0}\x03'.format(PowerState[value]))
        self.__SetHelper('Power', PowerCmdString, value, qualifier)

    def UpdatePower(self, value, qualifier):


        PowerCmdString = self.CommandStringBuild('Power', '\x02QPW\x03')  
    ...
    def SetVideoMute(self, value, qualifier):
        ...
        VideoMuteCmdString = self.CommandStringBuild('VideoMute', '\x02VMT:{0}\x03'.format(VideoMuteState[value]))
        self.__SetHelper('VideoMute', VideoMuteCmdString, value, qualifier)

    def UpdateVideoMute(self, value, qualifier):

        VideoMuteCmdString = self.CommandStringBuild('VideoMute', '\x02QVM\x03')
    ...
    def SetVolume(self, value, qualifier):
        ...
        if 0 <= value <= 100:
            VolumeCmdString = self.CommandStringBuild('Volume', '\x02AVL:{0:03d}\x03'.format(value))
    ...
    def UpdateVolume(self, value, qualifier):
        ...
        VolumeCmdString = self.CommandStringBuild('Volume', '\x02QAV\x03')  
