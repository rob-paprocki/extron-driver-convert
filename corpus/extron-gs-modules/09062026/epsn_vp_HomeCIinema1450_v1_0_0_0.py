...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'ERR=(0[013467])\r:'), self.__MatchDeviceStatus, None)
            self.AddMatchString(re.compile(b'FREEZE=(ON|OFF)\r:'), self.__MatchFreeze, None)
            self.AddMatchString(re.compile(b'SOURCE=(10|11|14|20|21|24|30|40|41|51|52|53|A0)\r:'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'LUMINANCE=(0[013])\r:'), self.__MatchLampMode, None)
    ...
    def SetSplitScreenSource(self, value, qualifier):
        ...
        SplitScreenSourceCmdString = 'SPS {0} {1}\r'.format(SideStates[qualifier['Side']], ValueStateValues[value])
    ...
    def __UpdateHelper(self, command, commandstring, value, qualifier):
        ...
        if self.Unidirectional == 'True':
            self.Discard('Inappropriate Update Command ' + command)
        else:
