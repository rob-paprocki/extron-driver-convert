...
class DeviceClass:
    ...
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'CrossPoint 300 88': self.extr_15_801_88,
            'CrossPoint 300 816': self.extr_15_801_816,
            'CrossPoint 300 84': self.extr_15_801_84,
            'CrossPoint 300 1212': self.extr_15_801_1212,
            'CrossPoint 300 1616': self.extr_15_801_1616,
            'CrossPoint 300 124': self.extr_15_801_124,
            'CrossPoint 300 168': self.extr_15_801_168,
            'CrossPoint 300 128': self.extr_15_801_128,
        }
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(compile(b'In(\d{2}) Aud((\+|-)[0-9]{2})\r\n'), self.__MatchInputGain, None)
            ...
            self.AddMatchString(compile(b'(?:Out(\d+) In(\d+) (All|Vid|RGB|Aud))|(?:In(\d+) (All|Vid|RGB|Aud))\r\n'), self.__MatchOutputTieStatus, None)
    ...
    def SetInputGain(self, value, qualifier):
        ...
        if 1 <= int(inputVal) <= self.InputSize and -18 <= value <= 24:
            if value < 0:
                InputGainCmdString = '{0}*{1}g'.format(inputVal, abs(value))
            else:
    ...
    def SetVolume(self, value, qualifier):
        ...
        output = int(qualifier['Output'])
        if 0 <= value <= 64 and 1 <= output <= self.OutputSize:
    ...
    def extr_15_801_1212(self):

        self.InputSize = 12
        self.OutputSize = 12

    def extr_15_801_124(self):

        self.InputSize = 12
        self.OutputSize = 4

    def extr_15_801_128(self):

        self.InputSize = 12
        self.OutputSize = 8

    def extr_15_801_1616(self):

        self.InputSize = 16
        self.OutputSize = 16

    def extr_15_801_168(self):

        self.InputSize = 16
        self.OutputSize = 8

    def extr_15_801_816(self):

        self.InputSize = 8
        self.OutputSize = 16

    def extr_15_801_88(self):

        self.InputSize = 8
        self.OutputSize = 8

    def extr_15_801_84(self):
