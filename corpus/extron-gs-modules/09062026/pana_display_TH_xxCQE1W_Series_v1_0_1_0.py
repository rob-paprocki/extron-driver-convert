...
class DeviceClass:
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            '16:9': b'\x02DAM:1609\x03',
            '14:9': b'\x02DAM:1409\x03',
            '4:3': b'\x02DAM:0403\x03',
            'Cinema': b'\x02DAM:CINM\x03',
            'Auto': b'\x02DAM:AUTO\x03'
        }
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'HDMI 3': b'\x02IMS:HM3\x03',
            'HDMI 4': b'\x02IMS:HM4\x03',
            'USB-C': b'\x02IMS:UC1\x03',
            'PC': b'\x02IMS:PC1\x03',
            'Wireless Display': b'\x02IMS:WD1\x03'
        }

        if value in ValueStateValues:
            InputCmdString = b''.join([self.md5hash, ValueStateValues[value], self.Delim])
    ...
    def SetPictureMode(self, value, qualifier):
        ...
        ValueStateValues = {
            'Signage': b'\x02VPC:MENSNG\x03',
            'Natural': b'\x02VPC:MENNAT\x03',
            'Text': b'\x02VPC:MENTXT\x03',
            'Game': b'\x02VPC:MENGAM\x03',
            'Sports': b'\x02VPC:MENSPT\x03'
        }
