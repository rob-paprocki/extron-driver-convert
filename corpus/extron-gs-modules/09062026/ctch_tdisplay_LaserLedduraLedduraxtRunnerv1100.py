...
class DeviceClass:
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            self._DeviceID = 0
        elif 0 <= int(value) <= 256 and (int(value) != 138 or int(value) != 169):
    ...
    def SetInput(self, value, qualifier):
        ...
        InputCmdString = pack('>5B', 0xA9, 0x15, self._DeviceID, self.InputStateValues[value], 0x8A)
    ...
    def UpdateInput(self, value, qualifier):
        ...
        if res:
            try:
                value = self.InputStateNames[res[4:5]]
    ...
    def SetOnScreenDisplay(self, value, qualifier):
        ...
        OnScreenDisplayCmdString = pack('>5B', 0xA9, 0x16, self._DeviceID, 0xB7, 0x8A)
    ...
    def SetTVChannel(self, value, qualifier):
        ...
        TVChannelCmdString = pack('>5B', 0xA9, 0x16, self._DeviceID, ValueStateValues[value], 0x8A)
    ...
    def __CheckResponseForErrors(self, sourceCmdName, response):
        ...
        if response[1:2] == b'\x4E':# and response[4:5] in DEVICE_ERROR_CODES:
            print('{0} : {1}'.format(sourceCmdName, DEVICE_ERROR_CODES[response[4:5]]))
            response = ''
        return response
