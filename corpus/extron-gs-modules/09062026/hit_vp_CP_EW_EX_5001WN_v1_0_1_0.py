...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.Deliregex = re.compile(b'(\x06|\x15|\x1C[\x00-\xFF]{2}|\x1D[\x00-\xFF]{2}|\x1F[\x00-\xFF]{2}|[a-fA-F0-9]{8})')
    ...
    def UpdateFilterUsage(self, value, qualifier):
        ...
        res1 = self.__UpdateHelper('FilterUsage', FilterUsageCmdString, value, qualifier)
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'USB A' : b'\xBE\xEF\x03\x06\x00\x5E\xD1\x01\x00\x00\x20\x06\x00', 
            'USB B' : b'\xBE\xEF\x03\x06\x00\xFE\xD7\x01\x00\x00\x20\x0C\x00'
        }
    ...
    def SetVolume(self, value, qualifier):
        ...
        inputType = qualifier['InputSelect']
        if inputType in InputSelectStates:
            VolumeCmdString = InputSelectStates[inputType][value]
    ...
    def UpdateVolumeStatus(self, value, qualifier):
        ...
        VolumeStatusStateQualifier = {
            ...
            'USB A'         : b'\xBE\xEF\x03\x06\x00\x45\xCC\x02\x00\x66\x20\x00\x00',
            'USB B'         : b'\xBE\xEF\x03\x06\x00\x9D\xCF\x02\x00\x6C\x20\x00\x00',
        }

        inputType = qualifier['InputSelect']
        if inputType in VolumeStatusStateQualifier:
            VolumeStatusCmdString = VolumeStatusStateQualifier[inputType]
    ...
    def __CheckResponseForErrors(self, sourceCmdName, response):
        ...
        if response and len(response) == 8:
            ...
            response = ''
        if response and response[0:1] in DEVICE_ERROR_CODES:
