...
class DeviceClass:
    ...
    def UpdateBrightness(self, value, qualifier):
        ...
        BrightnessCmdString = '/brightness?token={}&ts=1554869513'.format(self.MagicCode)
    ...
    def UpdateInput(self, value, qualifier):
        ...
        InputCmdString = '/input?token={}&ts=1554869513'.format(self.MagicCode)
    ...
    def UpdateModelName(self, value, qualifier):
        ...
        ModelNameCmdString = '/infomations?token={}&ts=1554869513'.format(self.MagicCode)
    ...
    def SetScreenMute(self, value, qualifier):
        ...
        ScreenMuteCmdString = '/screen'
        jsonData = dumps(
                    {'state':ValueStateValues[value]}
                    )
        self.__SetHelper('ScreenMute', value, qualifier, ScreenMuteCmdString, jsonData.encode())
    ...
    def UpdateScreenMute(self, value, qualifier):
        ...
        ScreenMuteCmdString = '/screen?token={}&ts=1554869513'.format(self.MagicCode)
        res = self.__UpdateHelper('ScreenMute', value, qualifier, ScreenMuteCmdString)
        if res:
            try:
    ...
    def UpdateVolume(self, value, qualifier):
        ...
        VolumeCmdString = '/volume?token={}&ts=1554869513'.format(self.MagicCode)
