...
class DeviceClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'NetPA U 2004 FX': self.extr_31_17638_2004,
            'NetPA U 2008 FX': self.extr_31_17638_2008
        }
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'32Stat ([0-2]{3})\*([0-2 *]{16})(\d{1,3}\.\d{1}C)\*(\d+)\*(\d+)\*([0-2 *]{4})([0-2])\*([01][0-2]{5}\S+)\r\n'), self.__MatchFaultStatus, None)
            self.AddMatchString(re.compile(b'(53|54|60|61|67|68)Stat ([0-2]|[0-9]{1,4}\*[0-9]{1,4})\r\n', re.I), self.__MatchSystemFault, None)
