...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'CURRENT\.ZONE:(ZONE\.[1-4])\r'), self.__MatchCurrentZone, None)
            ...
            self.AddMatchString(re.compile(b'(IR|KEY)\.LOCK:(ENABLE|DISABLE)\r'), self.__MatchExecutiveMode, None)
            ...
            self.AddMatchString(re.compile(b'MULTI\.VIEW:(SINGLE|DUAL|TRIPLE|QUAD|PIP)\r'), self.__MatchMultiSourceView, None)
    ...
    def SetCurrentZone(self, value, qualifier):
        ...
        CurrentZoneCmdString = 'CURRENT.ZONE={0}\r'.format(ValueStateValues[value])
        self.__SetHelper('CurrentZone', CurrentZoneCmdString, value, qualifier)

    def UpdateCurrentZone(self, value, qualifier):

        CurrentZoneCmdString = 'CURRENT.ZONE?\r'
        self.__UpdateHelper('CurrentZone', CurrentZoneCmdString, value, qualifier)

    def __MatchCurrentZone(self, match, tag):
        ...
        value = ValueStateValues[match.group(1).decode()]
        self.WriteStatus('CurrentZone', value, None)
    ...
    def SetExecutiveMode(self, value, qualifier):
        ...
        ExecutiveModeCmdString = '{0}.LOCK={1}\r'.format(TypeStates[qualifier['Type']], ValueStateValues[value])
    ...
    def UpdateExecutiveMode(self, value, qualifier):
        ...
        ExecutiveModeCmdString = '{0}.LOCK?\r'.format(TypeStates[qualifier['Type']])
    ...
    def SetMultiSourceView(self, value, qualifier):
        ...
        MultiSourceViewCmdString = 'MULTI.VIEW={0}\r'.format(ValueStateValues[value])
    ...
    def SetPowerSavingMode(self, value, qualifier):
        ...
        PowerSavingModeCmdString = 'POWER.SAVE.MODE={0}\r'.format(ValueStateValues[value])
