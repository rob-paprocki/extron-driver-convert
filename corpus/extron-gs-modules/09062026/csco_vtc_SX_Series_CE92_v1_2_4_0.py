...
class DeviceClass:
    ...
    def __init__(self):
        ...
        self.Models = {
            'SX10 CE9.2.X': self.csco_12_3300_SX20_SX10,
            'SX20 CE9.2.X': self.csco_12_3300_SX20_SX10,
            'SX80 CE9.2.X': self.csco_12_3300_SX80,
        }
    ...
    def UpdateH323AliasIDStatus(self, value, qualifier):
        ...
        FirmwareVersionCmdString = 'xConfiguration H323 H323Alias ID\r'
        self.__UpdateHelper('H323AliasIDStatus', FirmwareVersionCmdString, qualifier)
    ...
    def csco_12_3300_SX20_SX10(self):
