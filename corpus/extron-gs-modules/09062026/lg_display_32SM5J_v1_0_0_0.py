...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'b [0-9a-f]{2,3} OK(90|91|A1|A0|C2|D2)x', re.I), self.__MatchInput, None)
    ...
    def __MatchError(self, match, tag):
        ...
        self.Error(['{0} Error: {1}'.format(CommandCode[match.group(1).decode().lower()],
