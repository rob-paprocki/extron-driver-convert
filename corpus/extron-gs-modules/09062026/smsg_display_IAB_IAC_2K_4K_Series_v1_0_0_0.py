...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'\xAA\xFF[\x00-\xFD]\x03\x41\x15([\x10\x18\x20\x21\x22])[\x00-\xFF]'), self.__MatchAspectRatio, None)
            self.AddMatchString(re.compile(b'\xAA\xFF[\x00-\xFD]\x03\x41\x13([\x01\x00])[\x00-\xFF]'), self.__MatchAudioMute, None)
            self.AddMatchString(re.compile(b'\xAA\xFF[\x00-\xFD]\x03\x41\x5D([\x01\x00])[\x00-\xFF]'), self.__MatchExecutiveMode, None)
            self.AddMatchString(re.compile(b'\xAA\xFF[\x00-\xFD]\x03\x41\x14([\x21\x23\x31\x25\x62\x20\x14])[\x00-\xFF]'), self.__MatchInput, None)
