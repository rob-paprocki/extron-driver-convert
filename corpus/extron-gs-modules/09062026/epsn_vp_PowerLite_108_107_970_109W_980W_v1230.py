...
class DeviceClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'PowerLite 108': self.epsn_1_3370_A,
            'PowerLite 107': self.epsn_1_3370_A,
            'PowerLite 970': self.epsn_1_3370_A,
            'PowerLite 109W': self.epsn_1_3370_WU,
            'PowerLite 980W': self.epsn_1_3370_WU,
            'PowerLite 990U': self.epsn_1_3370_WU,
            'EB-107': self.epsn_1_3370_A,
            'EB-108': self.epsn_1_3370_A,
            'EB-109W': self.epsn_1_3370_WU,
            'EB-970': self.epsn_1_3370_A,
            'EB-980W': self.epsn_1_3370_WU,
            'EB-990U': self.epsn_1_3370_WU,
            'EB-W39': self.epsn_1_3370_WU,
        }
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'ASPECT=(00|10|20|20 30|00 30|30 30|30|40|50|60)\r:'), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'SOURCE=(11|12|14|24|30|A0|41|51|52|53)\r:'), self.__MatchInput, None)
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        AspectRatioCmdString = 'ASPECT {}0\r'.format(self.aspect_values[value])
    ...
    def __MatchAspectRatio(self, match, tag):
        ...
        value = self.aspect_states[match.group(1).decode()]
