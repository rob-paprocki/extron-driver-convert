...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'OP ASPECT = ([0-8])\r'), self.__MatchAspectRatio, None)
            self.AddMatchString(re.compile(b'OP FREEZE = (0|1)\r'), self.__MatchFreeze, None)
            self.AddMatchString(re.compile(b'OP INPUT\.SEL = ([0-7])\r'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'OP LASER\.HOURS = (\d+)\r'), self.__MatchLaserHours, None)
            self.AddMatchString(re.compile(b'OP LASER\.MODE = ([0-2])\r'), self.__MatchLaserMode, None)
            self.AddMatchString(re.compile(b'OP PIC\.MODE = ([0-2])\r'), self.__MatchPictureMode, None)
            self.AddMatchString(re.compile(b'OP PIP\.SEL = ([0-7])\r'), self.__MatchPIPInput, None)
            self.AddMatchString(re.compile(b'OP PIP\.MODE = (0|1)\r'), self.__MatchPIPMode, None)
            self.AddMatchString(re.compile(b'OP PIP\.POS = ([0-4])\r'), self.__MatchPIPPosition, None)
            self.AddMatchString(re.compile(b'OP STATUS = ([0-4])\r'), self.__MatchPower, None)
            self.AddMatchString(re.compile(b'OP IR\.ENABLE = (0|1)\r'), self.__MatchRemoteSensor, None)
    ...
    def SetFreeze(self, value, qualifier):
        ...
        FreezeCmdString = 'op freeze = {0}\r'.format(ValueStateValues[value])
    ...
    def SetInput(self, value, qualifier):
        ...
        InputCmdString = 'op input.sel = {0}\r'.format(ValueStateValues[value])
    ...
    def SetLaserMode(self, value, qualifier):
        ...
        LaserModeCmdString = 'op laser.mode = {0}\r'.format(ValueStateValues[value])
    ...
    def SetPictureMode(self, value, qualifier):
        ...
        PictureModeCmdString = 'op pic.mode = {0}\r'.format(ValueStateValues[value])
    ...
    def SetPIPInput(self, value, qualifier):
        ...
        PIPInputCmdString = 'op pip.sel = {0}\r'.format(ValueStateValues[value])
    ...
    def SetPIPMode(self, value, qualifier):
        ...
        PIPModeCmdString = 'op pip.mode = {0}\r'.format(ValueStateValues[value])
        self.__SetHelper('PIPMode', PIPModeCmdString, value, qualifier)

    def UpdatePIPMode(self, value, qualifier):

        PIPModeCmdString = 'op pip.mode ?\r'
    ...
    def SetPIPPosition(self, value, qualifier):
        ...
        PIPPositionCmdString = 'op pip.pos = {0}\r'.format(ValueStateValues[value])
    ...
    def SetRemoteSensor(self, value, qualifier):
        ...
        RemoteSensorCmdString = 'op ir.enable = {0}\r'.format(ValueStateValues[value])
        self.__SetHelper('RemoteSensor', RemoteSensorCmdString, value, qualifier)

    def UpdateRemoteSensor(self, value, qualifier):

        RemoteSensorCmdString = 'op ir.enable ?\r'
        self.__UpdateHelper('RemoteSensor', RemoteSensorCmdString, value, qualifier)

    def __MatchRemoteSensor(self, match, tag):
        ...
        value = ValueStateValues[match.group(1).decode()]
        self.WriteStatus('RemoteSensor', value, None)
    ...
    def SetVideoMute(self, value, qualifier):
        ...
        VideoMuteCmdString = 'op blank = {0}\r'.format(ValueStateValues[value])
