...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'In([1-2]) Aud([-+][0-9]{2})\r\n'), self.__MatchAudioGainAttenuation, None)
    ...
    def SetAudioFormat(self, value, qualifier):
        ...
        if qualifier['Input'] in ['1', '2'] and value in ValueStateValues:
            AudioFormatCmdString = 'wI{}*{}AFMT\r'.format(qualifier['Input'], ValueStateValues[value])
    ...
    def UpdateAudioFormat(self, value, qualifier):
        ...
        if qualifier['Input'] in ['1', '2']:
            AudioFormatCmdString = 'wI{}AFMT\r'.format(qualifier['Input'])
    ...
    def SetAudioGainAttenuation(self, value, qualifier):
        ...
        if -18 <= value <= 24:
            if qualifier['Input'] in ['1', '2']:
                if value < 0:
                    AudioGainAttenuationCmdString = qualifier['Input']  + '*' + str(abs(value)) + 'g'
                else:
                    AudioGainAttenuationCmdString = qualifier['Input']  + '*' +  str(abs(value)) + 'G'
    ...
    def UpdateAudioGainAttenuation(self, value, qualifier):
        ...
        if qualifier['Input'] in ['1', '2']:
            AudioGainAttenuationCmdString = '{}G'.format(qualifier['Input'])
    ...
    def UpdateHDCPInputAuthorization(self, value, qualifier):
        ...
        if 1 <= int(qualifier['Input']) <= 2:
            HDCPInputAuthorizationCmdString = 'wE{}HDCP\r'.format(qualifier['Input'])
    ...
    def UpdateHDCPOutputStatus(self, value, qualifier):
        ...
        HDCPOutputStatusCmdString = 'wO{}HDCP\r'.format(qualifier['Output'])
    ...
    def SetVideoMute(self, value, qualifier):
        ...
        if qualifier['Output'] in ['1', '2'] and value in ValueStateValues:
            VideoMuteCmdString = '{}*{}B'.format(qualifier['Output'], ValueStateValues[value])
