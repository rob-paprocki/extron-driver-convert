...
class DeviceSerialClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'=SER:([O|W|E]{18,20})\r'), self.__MatchDeviceStatus, None)
            self.AddMatchString(re.compile(b'=SIS:([0-8])\r'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'=SL(T|2):(\d+)H(\d+)M\r'), self.__MatchLampUsage, None)
    ...
    def __MatchDeviceStatus(self, match, tag):
        ...
        deviceStatusList = ['Lamp 1', 'Lamp 2', 'Filter', 'Unknown', 'Temperature 1',
                            'Color Wheel', 'DMD Temp', 'Liquid Pump', 'Fan 1', 'Fan 2',
                            'Fan 3', 'Fan 4', 'Fan 5', 'Fan 6', 'Fan 7',
                            'Fan 8', 'Fan 9', 'Fan 10', 'Fan 11', 'Fan 12']
    ...
    def SetLampSelect(self, value, qualifier):
        ...
        LampSelectCmdString = '#LPD:{0}\r'.format(ValueStateValues[value])
    ...
    def UpdateLampUsage(self, value, qualifier):
        ...
        LampUsageCmdString = '#SL{0}\r'.format(LampStates[qualifier['Lamp']])
    ...
    def __MatchLampUsage(self, match, tag):
        ...
        qualifier = {}
        qualifier['Lamp'] = LampStates[match.group(1).decode()]
...
class DeviceEthernetClass:
    ...
    def UpdateLampStatus(self, value, qualifier):
        ...
        if res:
            try:
                lampStatus1 = res[res.index(' ') + 1]
                lampStatus2 = res[res.index('\r') - 1]
                if lampStatus1 == '1' and lampStatus2 == '1':
                    value = 'Both On'
                elif lampStatus1 == '1':
                    value = 'Lamp 1 On'
                elif lampStatus2 == '1':
    ...
    def UpdateLampUsage(self, value, qualifier):
        ...
        if res:
            try:
                lampOneIndex = res.index(' ')
                lampTwoIndex = res.index('\r') - 2

                lampOneValue = int(res[7:lampOneIndex])
                lampTwoValue = int(res[lampOneIndex + 2:lampTwoIndex])

                self.WriteStatus('LampUsage', lampOneValue, {'Lamp': '1'})
                self.WriteStatus('LampUsage', lampTwoValue, {'Lamp': '2'})
