...
class DeviceClass:
    ...
    def __init__(self):
        ...
        self.Models = {
            ...
            'NP-0202DT': self.syna_31_1717_02_dual,
            'NP-0201DT': self.syna_31_1717_02_single,
            'NP-05B': self.syna_31_1717_05,
            'NP-1601DU': self.syna_31_1717_16_dual,
            'NP-0501DU': self.syna_31_1717_05
        }
    ...
    def UpdateOutletStatus(self, value, qualifier):
        ...
        OutletStatusCmdString = '$A5\r\n'
        self.__UpdateHelper('RequiredPolling', OutletStatusCmdString, value, qualifier)
    ...
    def syna_31_1717_02_single(self):

        self.portCount = 2
        self.modelType = 'Single'

    def syna_31_1717_02_dual(self):

        self.portCount = 2
        self.modelType = 'Dual'

    def syna_31_1717_05(self):

        self.portCount = 5
        self.modelType = 'Single'
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'\$A5\s*\$A0,([01]{5})'), self.__MatchOutletStatus, None)
