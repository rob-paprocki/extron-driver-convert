...
class DeviceClass:
    ...
    def SetPictureMode(self, value, qualifier):
        ...
        if value in ValueStateValues:
            PictureModeCmdString = self.__build_setstring(b'02', b'1A', ValueStateValues[value])
    ...
    def UpdatePictureMode(self, value, qualifier):
        ...
        PictureModeCmdString = self.__build_getstring(b'02', b'1A')
    ...
    def SetPowerSave(self, value, qualifier):
        ...
        if value in ValueStateValues:
            temp = b''.join([b'\x010', bytes([self._DeviceID]), b'0A0A\x02CA0B010', ValueStateValues[value], b'\x03'])
            PowerSaveCmdString = b''.join([temp, self.__calculate_checksum(temp), b'\r'])
            self.__SetHelper('PowerSave', PowerSaveCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetPowerSave')
    ...
    def UpdatePowerSave(self, value, qualifier):
        ...
        temp = b''.join([b'\x010', bytes([self._DeviceID]), b'0A08\x02CA0B00\x03'])
        PowerSaveCmdString = b''.join([temp, self.__calculate_checksum(temp), b'\r'])
