...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'8[0-9]{2}rB([0-9]{3})\r'), self.__MatchBacklight, None)
            self.AddMatchString(re.compile(b'8[0-9]{2}r([opq])00([01])\r'), self.__MatchExecutiveMode, None)
            self.AddMatchString(re.compile(b'8[0-9]{2}rj[01](04|14|06|09|0A)\r'), self.__MatchInput, None)
    ...
    def SetBacklight(self, value, qualifier):
        ...
        if 0 <= value <= 100:
            BacklightCmdString = '8{0}AB{1:03d}\r'.format(self._DeviceID, value)
    ...
    def UpdateBacklight(self, value, qualifier):
        ...
        BacklightCmdString = '8{0}aB000\r'.format(self._DeviceID)
    ...
    def SetExecutiveMode(self, value, qualifier):
        ...
        if qualifier['Type'] in TypeStates and value in ValueStateValues:
            ExecutiveModeCmdString = '8{0}s{1}{2}\r'.format(self._DeviceID, TypeStates[qualifier['Type']], ValueStateValues[value])
    ...
    def __MatchInput(self, match, tag):
        ...
        ValueStateValues = {
            '04': 'HDMI 1',  # 801rj004\r
            '14': 'HDMI 2',  # 801rj014\r
            '06': 'VGA',  # 801rj006\r
            '09': 'DisplayPort',  # 801rj009\r
            '0A': 'Embedded Player'  # 801rj10A\r
        }
