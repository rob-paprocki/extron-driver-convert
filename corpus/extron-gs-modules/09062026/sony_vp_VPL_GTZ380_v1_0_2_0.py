...
class DeviceClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'PicturePosition': {'Parameters': ['Mode'], 'Status': {}},
            'Power': {'Status': {}},
            'VideoMute': {'Status': {}},
        }
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        ValueStateValues = {
            'Normal': '"normal"',
            'Anamorphic Zoom': '"v_stretch"',
            'Squeeze': '"squeeze"',
            '1.85:1 Zoom': '"1.85_1_zoom"',
            '2.35:1 Zoom': '"2.35_1_zoom"',
            'Anamorphic Stretch': '"stretch"',
            'H Stretch': '"h_stretch"'
        }
    ...
    def UpdateAspectRatio(self, value, qualifier):
        ...
        ValueStateValues = {
            '"normal"': 'Normal',
            '"v_stretch"': 'Anamorphic Zoom',
            '"squeeze"': 'Squeeze',
            '"1.85_1_zoom"': '1.85:1 Zoom',
            '"2.35_1_zoom"': '2.35:1 Zoom',
            '"stretch"': 'Anamorphic Stretch',
            '"h_stretch"': 'H Stretch'
        }
    ...
    def SetPicturePosition(self, value, qualifier):
        ...
        if qualifier['Mode'] in ModeStates and value in ValueStateValues:
            PicturePositionCmdString = 'pic_pos_{0} {1}\r\n'.format(ModeStates[qualifier['Mode']], ValueStateValues[value])
            self.__SetHelper('PicturePosition', PicturePositionCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetPicturePosition')
