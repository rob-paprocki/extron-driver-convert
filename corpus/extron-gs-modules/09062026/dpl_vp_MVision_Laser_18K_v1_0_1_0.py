...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'(ack|ACK) input = ([0-5])\r'), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'(ack|ACK) pip\.input = ([0-5])\r'), self.__MatchPIPInput, None)
            ...
            self.AddMatchString(re.compile(b'(ack|ACK) pic.mute = ([01])\r'), self.__MatchVideoMute, None)
    ...
    def SetVideoMute(self, value, qualifier):
        ...
        VideoMuteCmdString = '*pic.mute = {0}\r'.format(ValueStateValues[value])
