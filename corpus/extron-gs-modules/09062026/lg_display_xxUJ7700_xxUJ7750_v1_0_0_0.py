...
class DeviceSerialClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'b [0-9A-F]{2} OK(00|01|10|11|20|40|60|90|91|92|93)x', re.I), self.__MatchInput, None)
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            ...
            print('Invalid DeviceID. Supported range is from 1 to 99 or Broadcast.')
