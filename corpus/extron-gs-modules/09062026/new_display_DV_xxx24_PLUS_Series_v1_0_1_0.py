...
class DeviceSerialClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x50([\x19\x1F\x18\x30])\xCF'), self.__MatchInput, None)
    ...
    def SetAudioMute(self, value, qualifier):
        ...
        if value in ValueStateValues:
            AudioMuteCmdString =  b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x0F' + ValueStateValues[value] + b'\xCF'
    ...
    def SetBacklight(self, value, qualifier):
        ...
        if value in ValueStateValues:
            BacklightCmdString = b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x0E' + ValueStateValues[value] + b'\xCF'
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'USB C':   b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x51\xCF',
        }
    ...
    def __MatchInput(self, match, tag):
        ...
        ValueStateValues = {
            ...
            b'\x1F': 'HDMI 2',
            b'\x18': 'USB C',
            b'\x30': 'Android' # Automatically switches to 'Android' if no input signal.
            }
    ...
    def SetVolume(self, value, qualifier):
        ...
        if 0 <= value <= 100:
            VolumeCmdString =  b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x05' + bytes([value]) + b'\xCF'
...
class DeviceEthernetClass:
    ...
    def SetPowerOff(self, value, qualifier):
        ...
        PowerOffCmdString = b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x01\xCF'
