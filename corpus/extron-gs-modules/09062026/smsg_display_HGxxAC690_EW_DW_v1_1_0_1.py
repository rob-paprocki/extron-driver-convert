...
class DeviceClass:
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'Composite': b'\x58\x80\x06\x01\x03\xE2',
    ...
    def __MatchPower(self, match, tag):
        ...
        self.WriteStatus('OnScreenDisplay', OSDStates[value[6]], None)
    ...
    def SetVolume(self, value, qualifier):
        ...
        if ValueConstraints['Min'] <= value <= ValueConstraints['Max']:
            ChkSum = 0x58 + 0x80 + 0x0D + 0x02 + value & 255
            VolumeCmdString = pack('>BBBBBBB', 0x58, 0x80, 0x0D, 0x02, value, 0x00, ChkSum)
    ...
    def __UpdateHelper(self, command, commandstring, value, qualifier):
        ...
        if self.Unidirectional == 'True':
            self.Discard('Inappropriate Command. Unidirectional mode or ID is set to broadcast.')
        else:
