...
class DeviceClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'MP-WU8801': self.max_1_4037_8801,
            'MP-WU8701': self.max_1_4037_8701,
        }
    ...
    def SetClosedCaptionChannel(self, value, qualifier):
        ...
        ClosedCaptionChannelCmdString = ClosedCaptionState[value]
    ...
    def UpdateInput(self, value, qualifier):
        ...
        if res:
            try:
                value = self.updateInputState[res[1]]
    ...
    def UpdateVolumeLevelStatus(self, value, qualifier):
        ...
        if inputType in self.updateVolumeLevelStatusStates:
            VolumeLevelStatusCmdString = self.updateVolumeLevelStatusStates[inputType]
    ...
    def SetVolumeStep(self, value, qualifier):
        ...
        inputType = qualifier['Input']
        if inputType in self.setVolumeStepStates:
            VolumeStepCmdString = self.setVolumeStepStates[inputType][value]
    ...
    def max_1_4037_8801(self):
        self.setInputState = {
            ...
            '3G-SDI': b'\xBE\xEF\x03\x06\x00\x5E\xDE\x01\x00\x00\x20\x12\x00',
        ...
        self.updateVolumeLevelStatusStates = {
            ...
            '3G-SDI': b'\xBE\xEF\x03\x06\x00\xC1\xE5\x02\x00\xE5\x20\x00\x00',
