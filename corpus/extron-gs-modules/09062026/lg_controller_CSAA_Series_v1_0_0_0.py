...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False' and self._DeviceID != '00':
            ...
            self.AddMatchString(re.compile(b'b [a-f0-9]{2,3} OK(90|a0|91|a1|c2|d2|c0|d0)x', re.I), self.__MatchInput, None)
    ...
    def DeviceID(self, value):
        if 0 <= int(value) <= 1000:
            ...
            self.Error(['Device ID should be a value between 0 to 1000, where 0 corresponds to Broadcast.'])
