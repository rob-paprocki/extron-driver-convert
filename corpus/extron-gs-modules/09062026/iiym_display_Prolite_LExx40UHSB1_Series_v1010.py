...
class DeviceClass:
    def __init__(self):
        ...
        self.Models = {
            'Prolite LE6540UHS-B1': self.iiym_10_3675_657586,
            'Prolite LE7540UHS-B1': self.iiym_10_3675_657586,
            'Prolite LE8640UHS-B1': self.iiym_10_3675_657586,
            'Prolite LE5540UHS-B1': self.iiym_10_3675_4355,
            'Prolite LE4340UHS-B1': self.iiym_10_3675_4355,
        }
    ...
    def SetInput(self, value, qualifier):
        ...
        InputCmdString = b''.join([b'\xA6', self._DeviceID, b'\x00\x00\x00\x07\x01\xAC', self.InputStateValues[value], b'\x00\x00\x00'])
    ...
    def UpdateInput(self, value, qualifier):
        ...
        if res:
            try:
                value = self.InputStateNames[res[7]]
    ...
    def SetIRRemoteLock(self, value, qualifier):
        ...
        IRRemoteLockCmdString = b''.join([b'\xA6', self._DeviceID, b'\x00\x00\x00\x04\x01\x1C', ValueStateValues[value]])
        IRRemoteLockCmdString = b''.join([IRRemoteLockCmdString, reduce(xor, IRRemoteLockCmdString).to_bytes(1, 'big')])
    ...
    def UpdateIRRemoteLock(self, value, qualifier):
        ...
        IRRemoteLockCmdString = b''.join([b'\xA6', self._DeviceID, b'\x00\x00\x00\x03\x01\x1D'])
        IRRemoteLockCmdString = b''.join([IRRemoteLockCmdString, reduce(xor, IRRemoteLockCmdString).to_bytes(1, 'big')])
    ...
    def SetVolume(self, value, qualifier):
        ...
        if ValueConstraints['Min'] <= value <= ValueConstraints['Max']:
            VolumeCmdString = b''.join([b'\xA6', self._DeviceID, b'\x00\x00\x00\x04\x01\x44', value.to_bytes(1, 'big')])
