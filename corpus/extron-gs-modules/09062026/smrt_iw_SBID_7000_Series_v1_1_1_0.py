...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'powerstate=(on|standby|ready|powersave|updateon|updateready)\r'), self.__MatchPower, None)
    ...
    def SetPower(self, value, qualifier):
        ...
        state = {'On':'on', 'Off':'standby', 'Ready':'ready', 'Power Save':'powersave'}[value]
