...
class DeviceClass:
    ...
    def SetAudioMute(self, value, qualifier):
        ...
        if value in ['On', 'Off']:
            AudioMuteCmdString = 'set mute={}\r'.format(value.lower())
    ...
    def SetInput(self, value, qualifier):
        ...
        if value in ['OPS', 'HDMI 1', 'HDMI 2', 'HDMI 3', 'VGA']:
            InputCmdString = 'set input={}\r'.format(value.replace(' ', ''))
    ...
    def SetPower(self, value, qualifier):
        ...
        ValueStateValues = {
            'On' : 'on',
            'Screen Off, Display Ready' : 'ready',
        }
    ...
    def UpdatePower(self, value, qualifier):
        ...
        ValueStateValues = {
            'on'          : 'On',
            'ready'       : 'Screen Off, Display Ready',
            'updateon'    : 'Screen On, Firmware Updating',
            'updateready' : 'Screen Off, Firmware Updating'
        }
