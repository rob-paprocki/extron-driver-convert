...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'c [0-9a-f]{2} OK(01|02|04|05|06|07|09|0B|1[0-9a-f])x', re.I), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK(00|01|02|03|04|10|11|20|40|90|91|92|93)x', re.I), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'(c|e|m|b|l|a|d|f) [0-9a-f]{2} NG(.*)x', re.I), self.__MatchError, None)
    ...
    def __MatchError(self, match, tag):
        ...
        errorstring = 'Error with Command: {0}, State: {1}'.format(CommandCode[match.group(1).decode().lower()], match.group(2).decode())
