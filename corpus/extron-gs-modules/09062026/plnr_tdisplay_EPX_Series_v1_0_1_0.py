...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\x07\x01\x00\x4D\x49\x4e([\x00\x09\x10\x0A-\x0E])\x08'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'\x07\x01\x00\x53\x43\x4D([\x00-\x04])\x08'), self.__MatchPictureMode, None)
            self.AddMatchString(re.compile(b'\x07\x01\x00\x50\x49([\x4E\x4F\x50])([\x00\x09\x10\x0A-\x0E])\x08'), self.__MatchPIPInput, None)
    ...
    def SetPIPInput(self, value, qualifier):
        ...
        if value in ValueStateValues and qualifier['PIP Window'] in PIPWindowStates:
    ...
    def SetPIPPresetRecall(self, value, qualifier):
        ...
        ValueStateValues = {
            'Preset1 Recall': b'\x00',
            'Preset2 Recall': b'\x01',
            'Preset3 Recall': b'\x02',
            'Preset4 Recall': b'\x03'
        }
