...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False' and self.DeviceID != '99':
            ...
            self.AddMatchString(re.compile(b'8[0-9]{2}rj0(01|03|04|14|24|34|06|0A|07|17)\r'), self.__MatchInput, None)
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        CmdString = '8{0}s100{1}\r'.format(self.DeviceID, States[value])
    ...
    def SetAudioMute(self, value, qualifier):
        ...
        CmdString = '8{0}s600{1}\r'.format(self.DeviceID, States[value])
        self.__SetHelper('AudioMute', CmdString, value, qualifier)
    def UpdateAudioMute(self, value, qualifier):
        self.__UpdateHelper('AudioMute', '8{0}gg000\r'.format(self.DeviceID), value, qualifier)
    ...
    def SetBrightness(self, value, qualifier):
        ...
        if 0 <= value <= 100:
            CmdString = '8{0}s${1:03d}\r'.format(self.DeviceID, value)
    ...
    def UpdateBrightness(self, value, qualifier):
        self.__UpdateHelper('Brightness', '8{0}gb000\r'.format(self.DeviceID), value, qualifier)
    ...
    def SetExecutiveMode(self, value, qualifier):
        ...
        CmdString = '8{0}s{1}00{2}\r'.format(self.DeviceID, TypeStates[qualifier['Type']], States[value])
    ...
    def UpdateExecutiveMode(self, value, qualifier):
        ...
        CmdString = '8{0}g{1}000\r'.format(self.DeviceID, TypeStates[qualifier['Type']])
    ...
    def SetInput(self, value, qualifier):
        ...
        CmdString = '8{0}s\x220{1}\r'.format(self.DeviceID, States[value])
        self.__SetHelper('Input', CmdString, value, qualifier)
    def UpdateInput(self, value, qualifier):
        self.__UpdateHelper('Input', '8{0}gj000\r'.format(self.DeviceID), value, qualifier)
    ...
    def SetIRRemote(self, value, qualifier):
        ...
        CmdString = '8{0}sB00{1}\r'.format(self.DeviceID, States[value])
        self.__SetHelper('IRRemote', CmdString, value, qualifier)
    def UpdateIRRemote(self, value, qualifier):
        self.__UpdateHelper('IRRemote', '8{0}gn000\r'.format(self.DeviceID), value, qualifier)
    ...
    def SetKeypad(self, value, qualifier):
        ...
        if 0 <= int(value) <= 9:
            CmdString = '8{0}s@00{1}\r'.format(self.DeviceID, value)
    ...
    def SetMenuNavigation(self, value, qualifier):
        ...
        CmdString = '8{0}sA00{1}\r'.format(self.DeviceID, States[value])
    ...
    def SetPower(self, value, qualifier):
        ...
        CmdString = '8{0}s!00{1}\r'.format(self.DeviceID, States[value])
        self.__SetHelper('Power', CmdString, value, qualifier)
    def UpdatePower(self, value, qualifier):
        
        self.__UpdateHelper('Power', '8{0}gl000\r'.format(self.DeviceID), value, qualifier)
    ...
    def SetVolume(self, value, qualifier):
        ...
        if 0 <= value <= 100:
            CmdString = '8{0}s5{1:03d}\r'.format(self.DeviceID, value)
            self.__SetHelper('Volume', CmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetVolume')
    def UpdateVolume(self, value, qualifier):
        self.__UpdateHelper('Volume', '8{0}gf000\r'.format(self.DeviceID), value, qualifier)
