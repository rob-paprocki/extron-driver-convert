...
class DeviceClass:
    def __init__(self):
        ...
        self.Models = {
            'PowerLite L690SE': self.epsn_1_17426_L69XSE,
            'PowerLite L695SE': self.epsn_1_17426_L69XSE,
            'PowerLite L890E': self.epsn_1_17426_Other,
            'PowerLite L895E': self.epsn_1_17426_Other,
            'PowerLite L790SE': self.epsn_1_17426_Other,
            'PowerLite L795SE': self.epsn_1_17426_Other,
            'PowerLite L690E': self.epsn_1_17426_Other,
            'PowerLite L890U': self.epsn_1_17426_Other,
            'PowerLite L790U': self.epsn_1_17426_Other,
            'PowerLite L690U': self.epsn_1_17426_Other,
            'PowerLite L695SU': self.epsn_1_17426_Other,
            'PowerLite L690SU': self.epsn_1_17426_Other
        }
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'ASPECT=([23456A]0)\r:'), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'SOURCE=(30|A0|52|53|56|80)\r:'), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'PWR=(0[0-59])\r:'), self.__MatchPower, None)
    ...
    # sending other commands, otherwise the device will close the connection.
    ...
    def SetInput(self, value, qualifier):
        ...
        if value in self.InputSetValues:
            InputCmdString = 'SOURCE {}\r'.format(self.InputSetValues[value])
    ...
    def __MatchInput(self, match, tag):
        ...
        value = self.InputStatusValues[match.group(1).decode()]
    ...
    def SetVolume(self, value, qualifier):
        ...
        if 0 <= value <= 20:
            VolumeCmdString = VolumeCmdString = 'VOL {}\r'.format(VolumeStateTable[value])
