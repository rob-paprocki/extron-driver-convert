...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False' and self._DeviceID != '99':
            ...
            self.AddMatchString(re.compile(b'8[0-9]{2}ro00([01])\r'), self.__MatchExecutiveMode, None)
            self.AddMatchString(re.compile(b'8[0-9]{2}rj[01](04|14|24|06|07|0A)\r'), self.__MatchInput, None)
    ...
    def SetExecutiveMode(self, value, qualifier):
        ...
        if value in ValueStateValues:
            ExecutiveModeCmdString = '8{0}s4{1}\r'.format(self._DeviceID, ValueStateValues[value])
    ...
    def UpdateExecutiveMode(self, value, qualifier):
        ...
        ExecutiveModeCmdString = '8{0}go000\r'.format(self._DeviceID)
