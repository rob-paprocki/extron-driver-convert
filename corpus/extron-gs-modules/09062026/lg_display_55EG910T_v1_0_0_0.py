...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK(20|40|90|91|92)x', re.I), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'([ucembadf]) [0-9a-f]{2} NG(.*)x', re.I), self.__MatchError, None)
