...
class DeviceClass:
    ...
    def SetAutoFocus(self, value, qualifier):
        ...
        if value in ValueStateValues:
            AutoFocusCmdString = self.SetHeader(pack('>6B', 0x81, 0x01, 0x04, 0x38, ValueStateValues[value], 0xFF))
    ...
    def SetPanTilt(self, value, qualifier):
        ...
        if 1 <= pan_speed <= 24 and 1 <= tilt_speed <= 24 and value in ValueStateValues:
            if value == 'Home':
                PanTiltCmdString = self.SetHeader(pack('>5B', 0x81, 0x01, 0x06, ValueStateValues[value], 0xFF))
            else:
    ...
    def SetPreset(self, value, qualifier):
        ...
        if action in ActionStates and 0 <= int(value) <= 255 and int(value) not in [0x5F, 0xA0, 0xA1, 0xA2, 0xA3, 0xA4, 0xA5]:
            PresetCmdString = self.SetHeader(pack('>7B', 0x81, 0x01, 0x04, 0x3F, ActionStates[action], int(value), 0xFF))
