...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'c [0-9a-f]{2} OK(01|02|06|0B|30|31)x', re.I), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK(00|01|10|11|20|40|90|91)x', re.I), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'(q|c|e|m|b|l|a|d|f|t) [0-9a-f]{2} NG(.*)x', re.I), self.__MatchError, None)
    ...
    def DeviceID(self, value):
        if 1 <= int(value) <= 99:
            ...
            self.Error(['Invalid Device ID value.'])
    ...
    def SetEnergySaving(self, value, qualifier):
        ...
        CmdString = 'jq {0} {1}\r'.format(self._DeviceID, ValueStateValues[value])
        self.__SetHelper('EnergySaving', CmdString, value, qualifier)

    def UpdateEnergySaving(self, value, qualifier):

        CmdString = 'jq {0} FF\r'.format(self._DeviceID)
        self.__UpdateHelper('EnergySaving', CmdString, value, qualifier)
