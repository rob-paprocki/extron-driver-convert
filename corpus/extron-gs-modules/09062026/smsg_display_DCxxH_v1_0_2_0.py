...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\xAA\xFF[\x00-\xFF]\x03\x41\x14(\x14|\x18|\x08|\x20|\x21|\x22|\x23|\\x24|\x1F)[\x00-\xFF]'), self.__MatchInput, None)
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            ...
            self.Error(['Device ID set to an invalid value. It should be a number between 0-99 or Broadcast.'])
