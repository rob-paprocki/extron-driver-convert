...
class DeviceClass:
    def __init__(self):
        ...
        self.Models = {
            '19LH20': self.lg_10_3587_1hdmi,
            '22LH20': self.lg_10_3587_1hdmi,
            '22LH200C': self.lg_10_3587_1hdmi,
            '26LH20': self.lg_10_3587_2hdmi,
            '32LH20': self.lg_10_3587_2hdmi,
            '37LH20': self.lg_10_3587_2hdmi,
            '42LH20': self.lg_10_3587_2hdmi,
            '19LU55': self.lg_10_3587_2hdmi,
            '22LU55': self.lg_10_3587_2hdmi,
            '32CL10': self.lg_10_3587_2hdmi,
            '32CL20': self.lg_10_3587_2hdmi,
            '32LH30': self.lg_10_3587_3hdmi,
            '37LH30': self.lg_10_3587_3hdmi,
            '42LH30': self.lg_10_3587_3hdmi,
            '47LH30': self.lg_10_3587_3hdmi,
            '32LF11': self.lg_10_3587_3hdmi,
            '26LU55': self.lg_10_3587_3hdmi,
            '37LF11': self.lg_10_3587_3hdmi,
            '42LF11': self.lg_10_3587_3hdmi,
            '47LF11': self.lg_10_3587_3hdmi,
            '47LF21': self.lg_10_3587_3hdmi,
            '42CL11': self.lg_10_3587_3hdmi,
        }
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'c [0-9a-f]{2} OK([0|1][0-9A-F])x'), self.__MatchAspectRatio, None)
            self.AddMatchString(re.compile(b'e [0-9a-f]{2} OK0(0|1)x'), self.__MatchAudioMute, None)
            self.AddMatchString(re.compile(b'm [0-9a-f]{2} OK0(0|1)x'), self.__MatchExecutiveMode, None)
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK([0-9]{2})x'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'l [0-9a-f]{2} OK0(0|1)x'), self.__MatchOnScreenDisplay, None)
            self.AddMatchString(re.compile(b'a [0-9a-f]{2} OK0(0|1)x'), self.__MatchPower, None)
            self.AddMatchString(re.compile(b'd [0-9a-f]{2} OK0(0|1)x'), self.__MatchVideoMute, None)
            self.AddMatchString(re.compile(b'f [0-9a-f]{2} OK([0-9a-fA-F]{2})x'), self.__MatchVolume, None)
            self.AddMatchString(re.compile(b'(u|c|e|m|b|l|a|d|f) [0-9a-f]{2} NG(.*)x'), self.__MatchError, None)
    ...
    def SetInput(self, value, qualifier):
        ...
        InputCmdString = 'xb {0} {1}\r'.format(self.DeviceID, self.setInputStates[value])
    ...
    def SetKeypad(self, value, qualifier):
        ...
        if 0 <= int(value) <= 9:
            KeypadCmdString = 'mc {0} 1{1}\r'.format(self.DeviceID, value)
    ...
    def __CheckResponseForErrors(self, sourceCmdName, response):
        ...
        if 'OK' in response:
            ...
            self.Error(['{0}: Error, non-viable function or communication error.'.format(sourceCmdName)])
            return ''
    ...
    def __MatchError(self, match, tag):
        ...
        self.Error(['{0} Error: {1}'.format(DEVICE_ERROR_CODES[match.group(1).decode()], match.group(2).decode())])
