...
class DeviceClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'PG703X': self.view_1_3111_PG703X,
            'PG703W': self.view_1_3111_PG703W,
            'PA603X': self.view_1_3111_PA,
            'PA502X': self.view_1_3111_PA,
            'PG603W': self.view_1_3111_PG603W,
            'PG603X': self.view_1_3111_PG603X,
            'PA502XP': self.view_1_3111_PA,
            'PA503XP': self.view_1_3111_PA,
            }
    ...
    def UpdateVolume(self, value, qualifier):
        ...
        res = self.__UpdateHelper('Volume', b'\x07\x14\x00\x05\x00\x34\x00\x00\x14\x03\x64' , value, qualifier)
        if res:
            try:
    ...
    def view_1_3111_PG703W(self):

        self.Inputs = {
            'VGA'         : b'\x00\x60', 
            'HDMI 1'      : b'\x03\x63',
            'HDMI 2/ MHL' : b'\x0E\x6E',
            'Composite'   : b'\x05\x65', 
            'S-Video'     : b'\x06\x66',
            }
