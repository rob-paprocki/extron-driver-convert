...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x81([\x00\x01])\xCF'), self.__MatchBacklightStatus, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x35([\x00-\x02])\xCF'), self.__MatchDisplayMode, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x50([\x30\x17\x20\x1F\x1E\x00\x19])\xCF'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x82([\x00\x01])\xCF'), self.__MatchMuteStatus, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x37([\x00\x01])\xCF'), self.__MatchPower, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x84([\x00\x01])\xCF'), self.__MatchScreenLockStatus, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x33([\x00-\x64])\xCF'), self.__MatchVolumeStatus, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x83([\x00\x01])\xCF'), self.__MatchWhiteboardStatus, None)
    def SetBacklight(self, value, qualifier):

        BacklightCmdString = b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x15\xCF'
        self.__SetHelper('Backlight', BacklightCmdString, value, qualifier)
    def UpdateBacklightStatus(self, value, qualifier):

        BacklightStatusCmdString = b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x81\xCF'
        self.__UpdateHelper('BacklightStatus', BacklightStatusCmdString, value, qualifier)

    def __MatchBacklightStatus(self, match, tag):
        ...
        self.WriteStatus('BacklightStatus', value, None)
    ...
    def UpdateDisplayMode(self, value, qualifier):
        ...
        DisplayModeCmdString = b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x35\xCF'
    ...
    def SetInput(self, value, qualifier):
        ...
        InputState = {
            ...
            'HDMI Rear 1'   : b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x52\xCF',
            'HDMI Rear 2'   : b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x53\xCF',
            'VGA'           : b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x54\xCF',
        ...
        self.__SetHelper('Input', InputCmdString, value, qualifier) #Query delay not needed, based on testing with the device
    ...
    def SetMenuNavigation(self, value, qualifier):
        ...
        self.__SetHelper('MenuNavigation', MenuNavigationCmdString, value, qualifier) #Query delay not needed, tested with device
    ...
    def UpdateMuteStatus(self, value, qualifier):
        ...
        MuteStatusCmdString = b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x82\xCF'
    ...
    def SetPower(self, value, qualifier):
        ...
        self.__SetHelper('Power', PowerCmdString, value, qualifier) #Based on testing with the device
    ...
    def SetScreenLock(self, value, qualifier):

        ScreenLockCmdString = b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x57\xCF'
        self.__SetHelper('ScreenLock', ScreenLockCmdString, value, qualifier)
    def UpdateScreenLockStatus(self, value, qualifier):

        ScreenLockStatusCmdString = b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x84\xCF'
        self.__UpdateHelper('ScreenLockStatus', ScreenLockStatusCmdString, value, qualifier)

    def __MatchScreenLockStatus(self, match, tag):
        ...
        value = ValueStateValues[match.group(1)]
        self.WriteStatus('ScreenLockStatus', value, None)
    ...
    def SetVolumeStep(self, value, qualifier):
        ...
        self.__SetHelper('VolumeStep', VolumeStepCmdString, value, qualifier) # Query delay not needed, based on testing with the device
    ...
    def UpdateWhiteboardStatus(self, value, qualifier):

        WhiteboardStatusCmdString = b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x83\xCF'
        self.__UpdateHelper('WhiteboardStatus', WhiteboardStatusCmdString, value, qualifier)

    def __MatchWhiteboardStatus(self, match, tag):
        ...
        value = ValueStateValues[match.group(1)]
        self.WriteStatus('WhiteboardStatus', value, None)
