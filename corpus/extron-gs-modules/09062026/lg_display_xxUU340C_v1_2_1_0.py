...
class DeviceSerialClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'c [0-9a-f]{2} OK0([1269])x'), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK(00|10|01|11|20|40|90|91|92)x'), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'([ceublamdf]) [0-9a-f]{2} NG.*?x'), self.__MatchError, None)

        self.regexSet = re.compile(b'[ceublamdf] [0-9a-f]{2} (?:OK|NG).*?x')
    ...
    def SetExecutiveMode(self, value, qualifier):
        ...
        ExecutiveModeCmdString = 'km {0} {1}\r'.format(self._DeviceID, ExecutiveModeState[value])
    ...
    def SetInput(self, value, qualifier):
        ...
        self.__SetHelper('Input', InputCmdString, value, qualifier)  # Based on testing queryDelay is not needed
    ...
    def SetOnScreenDisplay(self, value, qualifier):
        ...
        OnScreenDisplayCmdString = 'kl {0} {1}\r'.format(self._DeviceID, OnScreenDisplayState[value])
    ...
    def SetVideoMute(self, value, qualifier):
        ...
        self.__SetHelper('VideoMute', VideoMuteCmdString, value, qualifier)  # Based on testing, queryDelay is not needed
    ...
    def __MatchError(self, match, tag):
        ...
        self.Error(['{}: An error occurred.'.format(Command[match.group(1).decode()])])
...
class DeviceEthernetClass:
    def __init__(self):
        ...
        self.CommandOIDDict = {
            ...
            'AutoImage': '1.3.6.1.4.1.7824.300.3.20.0',
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        AspectRatioCmdString = self.SNMP.encodeMsg('Set', 'AspectRatio', AspectRatioState[value])
        self.__SetHelper('AspectRatio', AspectRatioCmdString, value, qualifier)
    ...
    def SetAudioMute(self, value, qualifier):
        ...
        AudioMuteCmdString = self.SNMP.encodeMsg('Set', 'AudioMute', AudioMuteState[value])
        self.__SetHelper('AudioMute', AudioMuteCmdString, value, qualifier)

    def SetAutoImage(self, value, qualifier):

        AutoImageCmdString = self.SNMP.encodeMsg('Set', 'AutoImage', '01')
        self.__SetHelper('AutoImage', AutoImageCmdString, value, qualifier)
    ...
    def SetChannel(self, value, qualifier):
        ...
        ChannelCmdString = self.SNMP.encodeMsg('Set', 'Channel', ValueStateValues[value])
        self.__SetHelper('Channel', ChannelCmdString, value, qualifier)
    ...
    def SetExecutiveMode(self, value, qualifier):
        ...
        ExecutiveModeCmdString = self.SNMP.encodeMsg('Set', 'ExecutiveMode', ExecutiveModeState[value])
        self.__SetHelper('ExecutiveMode', ExecutiveModeCmdString, value, qualifier)
    ...
    def SetInput(self, value, qualifier):
        ...
        InputCmdString = self.SNMP.encodeMsg('Set', 'Input', InputState[value])
    ...
    def SetKeypad(self, value, qualifier):
        ...
        KeypadCmdString = self.SNMP.encodeMsg('Set', 'Keypad', KeypadState[value])
        self.__SetHelper('Keypad', KeypadCmdString, value, qualifier)
    ...
    def SetMenuNavigation(self, value, qualifier):
        ...
        MenuNavigationCmdString = self.SNMP.encodeMsg('Set', 'MenuNavigation', MenuNavigationState[value])
        self.__SetHelper('MenuNavigation', MenuNavigationCmdString, value, qualifier)
    ...
    def SetVideoMute(self, value, qualifier):
        ...
        VideoMuteCmdString = self.SNMP.encodeMsg('Set', 'VideoMute', VideoMuteState[value])
