...
class DeviceSerialClass:
    ...
    def UpdateLaserHours(self, value, qualifier):
        ...
        if 1 <= int(qualifier['Laser']) <= 2:
            LaserHoursCmdString = self.construct_command('QVX', 'LRTS3=0{}'.format(int(qualifier['Laser']) - 1))
...
class DeviceEthernetClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'%1ERST=([012]{3}0[012]{2})\r'), self.__MatchDeviceStatus, None)
            ...
            self.AddMatchString(re.compile(b'%2INPT=(3[1-4])\r'), self.__MatchInput, None)
