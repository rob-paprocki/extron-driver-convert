...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'\x38[0-9]{2}\x72\x77\x30\x30(\x30|\x31|\x32|\x33|\x34|\x35|\x36|\x37)\x0D'), self.__MatchAspectRatio, None)
            self.AddMatchString(re.compile(b'\x38[0-9]{2}\x72\x67\x30\x30(\x30|\x31)\x0D'), self.__MatchAudioMuteStatus, None)
            self.AddMatchString(re.compile(b'\x38[0-9]{2}\x72\x69\x30\x30(\x30|\x31)\x0D'), self.__MatchButtonAndIRControl, None)
            self.AddMatchString(re.compile(b'\x38[0-9]{2}\x72\x6A([\x30\x31][\x30\x32][\x30\x31\x32])\x0D'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'\x38[0-9]{2}\x72\x6C\x30\x30(\x32|\x31)\x0D'), self.__MatchPower, None)
            self.AddMatchString(re.compile(b'\x38[0-9]{2}\x72\x66([0-9]{3})\x0D'), self.__MatchVolumeStatus, None)
    ...
    def SetAudioMute(self, value, qualifier):
        ...
        AudioMuteCmdString = b''.join([b'\x38', self.DeviceID, b'\x73\x36\x30\x30\x32\x0D'])
        self.__SetHelper('AudioMute', AudioMuteCmdString, value, qualifier)
    def UpdateAudioMuteStatus(self, value, qualifier):

        AudioMuteStatusCmdString = b''.join([b'\x38', self.DeviceID, b'\x67\x67\x30\x30\x30\x0D'])
    ...
    def SetButtonAndIRControl(self, value, qualifier):
        ...
        ButtonAndIRControlCmdString = b''.join([b'\x38', self.DeviceID, b'\x73\x43\x30\x30', ValueStateValues[value], b'\x0D'])
    ...
    def SetFreeze(self, value, qualifier):
        ...
        FreezeCmdString = b''.join([b'\x38', self.DeviceID, b'\x73\x40\x30\x33\x32\x0D'])
    ...
    def UpdatePower(self, value, qualifier):
        ...
        PowerCmdString = b''.join([b'\x38', self.DeviceID, b'\x67\x6C\x30\x30\x30\x0D'])
    ...
    def SetVideoMute(self, value, qualifier):
        ...
        VideoMuteCmdString = b''.join([b'\x38', self.DeviceID, b'\x73\x40\x30\x33\x31\x0D'])
    ...
    def SetVolume(self, value, qualifier):
        ...
        VolumeCmdString = b''.join([b'\x38', self.DeviceID, b'\x73\x35', ValueStateValues[value], b'\x0D'])
