...
class DeviceClass:
    ...
    def UpdateAspectRatio(self, value, qualifier):
        ...
        if res:
            try:
                self.WriteStatus('AspectRatio',  States[res[0:-1]] , qualifier)
    ...
    def SetATVChannelDirectCommand(self, value, qualifier):
        ...
        if temp:
            if 1 <= int(temp) <= 99:
                self.__SetHelper('ATVChannelDirectCommand', 'DCCH{0} \r'.format(temp.zfill(3)) , value, qualifier)
            else:
    ...
    def UpdateAudioMute(self, value, qualifier):
        ...
        if res:
            try:
                self.WriteStatus('AudioMute',  States[res[0:-1]] , qualifier)
            except (KeyError, IndexError):
    ...
    def SetAVMode(self, value, qualifier):
        ...
        self.__SetHelper('AVMode', States[value] , value, qualifier)
    ...
    def UpdateAVMode(self, value, qualifier):
        ...
        if res:
            try:
                self.WriteStatus('AVMode',  States[res[0:-1]] , qualifier)
            except (KeyError, IndexError):
    ...
    def UpdateInput(self, value, qualifier):
        ...
        if res:
            try:
                self.WriteStatus('Input',  States[res[0:1]] , qualifier)
            except (KeyError, IndexError):
    ...
    def UpdatePower(self, value, qualifier):
        ...
        if res:
            try:
                self.WriteStatus('Power',  States[res[0:-1]] , qualifier)
            except (KeyError, IndexError):
    ...
    def SetVolume(self, value, qualifier):
        ...
        if 0 <= value <= 60:
            self.__SetHelper('Volume', 'VOLM{0:02d}  \r'.format(value) , value, qualifier)
        else:
