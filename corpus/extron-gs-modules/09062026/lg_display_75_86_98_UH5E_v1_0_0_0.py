...
class DeviceSerialClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False' and self.DeviceID != '00':
            ...
            self.AddMatchString(re.compile(b'b [a-f0-9]{2,3} OK(90|a0|91|a1|92|a2|c0|d0|e2)x'), self.__MatchInput, None)
    ...
    def SetInput(self, value, qualifier):
        ...
        InputCmdString = 'xb {} {}\r'.format(self.DeviceID, ValueStateValues[value])
