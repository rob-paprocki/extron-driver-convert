...
class DeviceSerialClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            '7043XE' : self.clrt_39_5204_other,
            '7065XE' : self.clrt_39_5204_65,
            '7086XE' : self.clrt_39_5204_other
        }
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b':01r\x3A(000|001|002|021|022|003|101|103)\r'), self.__MatchInput, None)
    ...
    def SetInput(self, value, qualifier):
        ...
        if value in self.SetInputValues:
            InputCmdString = self.build_set('\x3A', self.SetInputValues[value])
    ...
    def __MatchInput(self, match, tag):
        ...
        value = self.UpdateInputValues[match.group(1).decode()]
