...
class DeviceClass:
    ...
    def SetHDR(self, value, qualifier):
        ...
        HDRCmdString = ValueStateValues[value]
        self.__SetHelper('HDR', HDRCmdString, value, qualifier)
    def SetInput(self, value, qualifier):

        ValueStateValues = {
            'HDMI 1'           : '~0012 1\r', 
            'HDMI 2'           : '~0012 15\r', 
            'Component(YPbPr)' : '~0012 14\r', 
            'VGA'              : '~0012 5\r', 
            'Multimedia'       : '~0012 23\r'
        }
    ...
    def SetPureMotion(self, value, qualifier):
        ...
        PureMotionCmdString = ValueStateValues[value]
        self.__SetHelper('PureMotion', PureMotionCmdString, value, qualifier)
