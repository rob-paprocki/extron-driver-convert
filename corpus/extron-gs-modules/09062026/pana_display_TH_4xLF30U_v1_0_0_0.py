...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\x02QMI:(PC1|DV1|HM1|HM2)\x03'), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'\x02(ERR[1-5A]|ER401)\x03'), self.__MatchError, None)
    ...
    def SetPower(self, value, qualifier):
        ...
        if value in ValueStateValues:
            PowerCmdString = '\x02{}\x03'.format(ValueStateValues[value])
    ...
    def __MatchError(self, match, tag):
        ...
        self.Error(['An error occurred: {}.'.format(ErrorCodeValues[value])])
