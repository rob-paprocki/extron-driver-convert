...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'b ([0-9a-f]{2}) OK(0|1|2|4|6|7|8|9|A)([0-3])x'), self.__MatchInput, None)
    ...
    def SetInput(self, value, qualifier):
        ...
        if(InputNum in ('1', '2', '3', '4')):
            InputCmdString = 'xb {0} {1}{2}\r'.format(self._DeviceID, ValueStateValues[value], State[InputNum])
    ...
    def __MatchInput(self, match, tag):
        ...
        if self._DeviceID == match.group(1).decode().lower():
            InputNum = State[match.group(3).decode()]
            value = ValueStateValues[match.group(2).decode()]
            qualifier = {'Input': InputNum}
    ...
    def __CheckResponseForErrors(self, sourceCmdName, response):
        ...
        if b'OK' in response:
            ...
            print('Error in command: {0}'.format(sourceCmdName))
