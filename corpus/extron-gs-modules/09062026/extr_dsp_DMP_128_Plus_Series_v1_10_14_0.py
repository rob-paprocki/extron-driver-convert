...
class DeviceClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'DigitalOutputStatus': {'Parameters':['Digital I/O Channel','Digital Output'], 'Status': {}},
        ...
        self.ReDialString = ''  # variable to store redial string
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'VoipAD([1-8]),([0-9]+)\r\n'), self.__MatchAutoAnswerDelay, None)
            self.AddMatchString(re.compile(b'VoipAA([1-8]),([0-2])\r\n'), self.__MatchAutoAnswerMode, None)
            self.AddMatchString(re.compile(b'DsG(4001[2-9])\*([0-9 -]{1,5})\r\n'), self.__MatchAuxInputGain, None)
            self.AddMatchString(re.compile(b'DsM(4001[2-9])\*([01])\r\n'), self.__MatchAuxInputMute, None)
            self.AddMatchString(re.compile(b'DsG(4011[2-9])\*([0-9 -]{1,5})\r\n'), self.__MatchAuxInputPremixerGain, None)
            self.AddMatchString(re.compile(b'DsM(4011[2-9])\*([01])\r\n'), self.__MatchAuxInputPremixerMute, None)
            self.AddMatchString(re.compile(b'DsG(60008|60009|60010|60011|60012|60013|60014|60015)\*([0-9 -]{1,5})\r\n'), self.__MatchAuxOutputGain, None)
            self.AddMatchString(re.compile(b'DsM(60008|60009|60010|60011|60012|60013|60014|60015)\*([01])\r\n'), self.__MatchAuxOutputMute, None)
            self.AddMatchString(re.compile(b'DsG(60108|60109|60110|60111|60112|60113|60114|60115)\*([0-9 -]{1,5})\r\n'), self.__MatchAuxOutputPostmixerTrim, None)
            self.AddMatchString(re.compile(b'VoipIncoming([1-8]),([0-5]),([^,]*),([0-9*#+]+),.*\r\n'), self.__MatchCallerID, None)
            self.AddMatchString(re.compile(b'VoipNAME([1-8]),([0-5]),([^,]*),([0-9*#%]+)\r\n'), self.__MatchCallerName, None)
            self.AddMatchString(re.compile(b'VoipNAME([1-8]),([0-5]),none,none\r\n'), self.__MatchCallerName, 'none')
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}DsG(40000|40001|40002|40003|40004|40005|40006|40007|40008|40009|40010|40011)\*([0-9 -]{1,5})\r\n'), self.__MatchDanteInputGain, None)
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}DsM(40000|40001|40002|40003|40004|40005|40006|40007|40008|40009|40010|40011)\*([01])\r\n'), self.__MatchDanteInputMute, None)
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}DsG(6000[0-7])\*([0-9 -]{1,5})\r\n'), self.__MatchDanteOutputAttenuation, None)
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}DsM(6000[0-7])\*([01])\r\n'), self.__MatchDanteOutputMute, None)
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}GrpmD([0-9]{1,2})\*([0-9 -]{1,5})\r\n'), self.__MatchDanteGroup, None)
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}DsG(40100|40101|40102|40103|40104|40105|40106|40107|40108|40109|40110|40111)\*([0-9 -]{1,5})\r\n'), self.__MatchDantePremixerGain, None)
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}DsG(50100|50101|50102|50103|50104|50105|50106|50107|50108|50109|50110|50111|50112|50113|50114|50115)\*([0-9 -]{1,5})\r\n'), self.__MatchDanteATInputPremixerGain, None)
            self.AddMatchString(re.compile(b'ExprC([A-Za-z0-9- ]+)\*1\r\n'), self.__MatchDanteConnect, None)
            self.AddMatchString(re.compile(b'DsH400([01][0-9])\*([0-9 -]{1,5})\r\n'), self.__MatchDigitalInputGain, None)
            self.AddMatchString(re.compile(b'Gpi([1-8])\*([0-1])\r\n'), self.__MatchDigitalInputStatus, None)
            self.AddMatchString(re.compile(b'Gpot([1-8])\*([12])\*(1?[0-9])\*\d\r\n'), self.__MatchDigitalOutputStatus, None)
            self.AddMatchString(re.compile(b'VoipDND([1-8]),([0-1])\r\n'), self.__MatchDoNotDisturb, None)
            self.AddMatchString(re.compile(b'VoipDUR([1-8]),([1-8]),([0-9]+)\r\n'), self.__MatchCallDuration, None)
            self.AddMatchString(re.compile(b'(Pno60-151[1-3]-(01|10))\r\n'), self.__MatchPartNumber, None)
            self.AddMatchString(re.compile(b'DsG(502[0-9]{2})\*([0-9 -]{1,5})\r\n'), self.__MatchExpansionInputPremixerGain, None)
            self.AddMatchString(re.compile(b'DsM(502[0-9]{2})\*([01])\r\n'), self.__MatchExpansionInputPremixerMute, None)
            self.AddMatchString(re.compile(b'DsG(60016|60017|60018|60019|60020|60021|60022|60023|60024|60025|60026|60027|60028|60029|60030|60031)\*([0-9 -]{1,5})\r\n'), self.__MatchExpansionOutputAttenuation, None)
            self.AddMatchString(re.compile(b'DsM(60016|60017|60018|60019|60020|60021|60022|60023|60024|60025|60026|60027|60028|60029|60030|60031)\*([01])\r\n'), self.__MatchExpansionOutputMute, None)
            self.AddMatchString(re.compile(b'DsG(60116|60117|60118|60119|60120|60121|60122|60123|60124|60125|60126|60127|60128|60129|60130|60131)\*([0-9 -]{1,5})\r\n'), self.__MatchExpansionOutputPostmixerTrim, None)
            ...
            self.AddMatchString(re.compile(b'DsG(40000|40001|40002|40003|40004|40005|40006|40007|40008|40009|40010|40011)\*([0-9 -]{1,5})\r\n'), self.__MatchInputGain, None)
            self.AddMatchString(re.compile(b'DsM(40000|40001|40002|40003|40004|40005|40006|40007|40008|40009|40010|40011)\*([01])\r\n'), self.__MatchInputMute, None)
            self.AddMatchString(re.compile(b'DsV(400[01][0-9])\*[01]\*([0-9]{1,4})\*[01]\r\n'), self.__MatchInputSignalLevelMonitor, 'Enabled')
            self.AddMatchString(re.compile(b'DsJ(400[01][0-9])\*0\r\n'), self.__MatchInputSignalLevelMonitor, 'Disabled')
            self.AddMatchString(re.compile(b'DsD(400[01][0-9])\*([0-9]{1,2})\r\n'), self.__MatchInputSource, None)
            self.AddMatchString(re.compile(b'Mcro(STARTED|FINISHED)(\d{1,2})\r\n'), self.__MatchMacroStatus, 'StartedFinished')
            self.AddMatchString(re.compile(b'Mcro(FAILED|KILLED)(\d{1,2})\*(\d+)\r\n'), self.__MatchMacroStatus, 'FailedKilled')
            self.AddMatchString(re.compile(b'DsG2([0-9]{2})([0-9]{2})\*([0-9 -]{1,5})\r\n'), self.__MatchMixpointGain, None)
            self.AddMatchString(re.compile(b'DsM2([0-9]{2})([0-9]{2})\*([01])\r\n'), self.__MatchMixpointMute, None)
            self.AddMatchString(re.compile(b'DsM(6000[0-7])\*([01])\r\n'), self.__MatchOutputMute, None)
            self.AddMatchString(re.compile(b'DsG(6010[0-7])\*([0-9 -]{1,5})\r\n'), self.__MatchOutputPostmixerTrim, None)
            self.AddMatchString(re.compile(b'DsG(6000[0-7])\*([0-9 -]{1,5})\r\n'), self.__MatchOutputAttenuation, None)
            self.AddMatchString(re.compile(b'DsZ4000([0-7])\*([01])\r\n'), self.__MatchPhantomPower, None)
            self.AddMatchString(re.compile(b'Play([1-8])\*([01])\r\n'), self.__MatchPlayerControl, None)
            self.AddMatchString(re.compile(b'CplyA([1-8])\*([ \s\S]+?)\r\n'), self.__MatchPlayerFilenameStatus, None)
            self.AddMatchString(re.compile(b'CplyM([1-8])\*([01])\r\n'), self.__MatchPlayerRepeat, None)
            self.AddMatchString(re.compile(b'DsG(40100|40101|40102|40103|40104|40105|40106|40107|40108|40109|40110|40111)\*([0-9 -]{1,5})\r\n'), self.__MatchPremixerGain, None)
            self.AddMatchString(re.compile(b'DsM(40100|40101|40102|40103|40104|40105|40106|40107|40108|40109|40110|40111)\*([01])\r\n'), self.__MatchPremixerMute, None)
            self.AddMatchString(re.compile(b'DsG(50100|50101|50102|50103|50104|50105|50106|50107|50108|50109|50110|50111|50112|50113|50114|50115)\*([0-9 -]{1,5})\r\n'), self.__MatchVirtualReturnGain, None)
            self.AddMatchString(re.compile(b'DsM(50100|50101|50102|50103|50104|50105|50106|50107|50108|50109|50110|50111|50112|50113|50114|50115)\*([01])\r\n'), self.__MatchVirtualReturnMute, None)
            self.AddMatchString(re.compile(b'VoipLS([1-8]),([0-5]),([0-5]),([0-5]),([0-5]),([0-5]),([0-5]),([0-5]),([0-5])\r\n'), self.__MatchCallStatus, 'LineStatus')
            self.AddMatchString(re.compile(b'Voip(Busy|Rejected|Unreachable|Terminated)([1-8]),([1-8])\r\n'), self.__MatchCallStatus, 'CallStatus')
            self.AddMatchString(re.compile(b'VoipRS([1-8]),([0-4])\r\n'), self.__MatchRegistrationStatus, None)
            self.AddMatchString(re.compile(b'UphnH1\*([01])\r\n'), self.__MatchUSBCallStatus, None)
            self.AddMatchString(re.compile(b'VoipREJ([1-8]),([1-8]),[01]\r\n'), self.__MatchReject, None)
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}32Stat([0-3]{5})\*([0-3]{5})\*([0-3]{5})\*([0-3]{5})\*([0-3]{5})\r\n'), self.__MatchFaultStatus, None)
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}(53|54|60|61)Stat([0-2])\r\n'), self.__MatchSystemFault, None)
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}(55|57|58|62|64)Stat([0-2]{4})\r\n'), self.__MatchChannelFault, None)
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}20Stat([0-9]{1,3})\r\n'), self.__MatchDanteTemperature, None)
            self.AddMatchString(re.compile(b'{dante@([A-Za-z0-9- ]+)}NtfyM1111\*1\r\n'), self.__MatchNotify, None)  # Notify for unsolicited status
    ...
    def SetAutoAnswerDelay(self, value, qualifier):
        ...
        if 0 <= int(value) <= 30 and 0 < int(qualifier['Line']) < 9:
    ...
    def SetAutoAnswerMode(self, value, qualifier):
        ...
        if value in ValueStateValues and 0 < int(qualifier['Line']) < 9:
    ...
    def SetAuxInputMute(self, value, qualifier):
        ...
        if value in ValueStateValues and 1 <= channel <= 8:
    ...
    def SetAuxInputPremixerMute(self, value, qualifier):
        ...
        channel = qualifier['Input']
        if value in ValueStateValues and 0 < int(channel) <= 8:
    ...
    def SetAuxOutputMute(self, value, qualifier):
        ...
        channel = qualifier['Output']
        if value in ValueStateValues and 0 < int(channel) <= self.MAX_AUX_OUTPUTS:
    ...
    def __MatchCallerID(self, match, tag):
        ...
        self.WriteStatus('CallerID', '{0}: {1}'.format(name, extension), {'Line': Line, 'Appearance': appearance})
    ...
    def __MatchCallerName(self, match, tag):
        ...
        if tag == 'none':
            ...
            extension = match.group(4).decode()
            if '%23' in extension:
                extension = extension.replace('%23', '#')
    ...
    def SetDoNotDisturb(self, value, qualifier):
        ...
        if value in ValueStateValues and 1 <= int(qualifier['Line']) <= 8:
        ...
        if 1 <= int(qualifier['Line']) <= 8:
            if value == 'Dial':
                ...
                if number:
                    ...
                    try:
                        self.ReDialString = '\x1BDIAL{0},{1}VOIP\r\n'.format(qualifier['Line'], number)
                    except:
                        self.ReDialString = ''
                        self.ReDialString = '\x1BDIAL{0},{1}VOIP\r\n'.format(qualifier['Line'], number)
            elif value == 'Redial':
    ...
    def SetDialDTMF(self, value, qualifier):
        ...
        if value in '0123456789*#' and 1 <= int(qualifier['Line']) <= 8 and 1 <= int(qualifier['Appearance']) <= 8:
    ...
    def UpdateDigitalOutputStatus(self, value, qualifier):
        ...
        if 1 <= int(qualifier['Digital I/O Channel']) <= 8 and qualifier['Digital Output'] in ['1', '2']:
            DigitalOutputStatusCmdString = 'w{0}*{1}GPOT\r\n'.format(qualifier['Digital I/O Channel'], qualifier['Digital Output'])
            self.__UpdateHelper('DigitalOutputStatus', DigitalOutputStatusCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for UpdateDigitalOutputStatus')

    def __MatchDigitalOutputStatus(self, match, tag):
        ...
        ValueStateValues = {
            ...
            '6'  : 'Macro High',
            '7'  : 'Macro Low',
            '8'  : 'Preset Recall High',
            '9'  : 'Preset Recall Low',
            '10' : 'Automix Gate On High',
            '11' : 'Automix Gate On Low',
            '12' : 'Signal Presence High',
            '13' : 'Signal Presence Low',
        }

        qualifier = {
            'Digital I/O Channel' : match.group(1).decode(),
            'Digital Output' : match.group(2).decode()
        }
    ...
    def SetExpansionBusMixpointMute(self, value, qualifier):
        ...
        inputQual = qualifier['Input']
        outputQual = qualifier['Output']
        if value in ValueStateValues and inputQual in self.ExpansionBusInputStateValues and outputQual in self.MixpointOutputStateValues:
            inputValue = self.ExpansionBusInputStateValues[inputQual]
            outputValue = self.MixpointOutputStateValues[outputQual]
    ...
    def SetExpansionInputPremixerMute(self, value, qualifier):
        ...
        channel = int(qualifier['Input'])
        if value in ValueStateValues and 1 <= channel <= self.MAX_EXPANSION_INPUTS:
    ...
    def SetExpansionOutputMute(self, value, qualifier):
        ...
        channel = qualifier['Output']
        if value in ValueStateValues and 0 < int(channel) <= 16:
    ...
    def SetHook(self, value, qualifier):
        ...
        if value in HookStateValues and 1 <= int(qualifier['Line']) <= 8 and 1 <= int(qualifier['Appearance']) <= 8:
    ...
    def SetInputMute(self, value, qualifier):
        ...
        channel = int(qualifier['Input'])
        if value in MuteStateValues and 1 <= channel <= 12:
    ...
    def SetInputSource(self, value, qualifier):
        ...
        if value in ValueStateValues and 1 <= int(qualifier['Input']) <= 12:
    ...
    def __MatchMacroStatus(self, match, tag):
        ...
        if 1 <= macro <= 64:
            if tag == 'StartedFinished':
                value = 'Macro {0} {1}.'.format(match.group(1).decode().title(), macro)
                self.WriteStatus('MacroStatus', value, None)
            elif tag == 'FailedKilled':
                value = 'Macro {0} {1} Step {2}.'.format(match.group(1).decode().title(), macro, match.group(3).decode())
                self.WriteStatus('MacroStatus', value, None)
    ...
    def SetOutputMute(self, value, qualifier):
        ...
        channel = int(qualifier['Output'])
        if value in MuteStateValues and 1 <= channel <= 8:
    ...
    def SetPhantomPower(self, value, qualifier):
        ...
        if value in state and 1 <= inputVal <= 8:
            PhantomPowerCmdString = 'wZ4000{0}*{1}AU\r'.format(inputVal - 1, state[value])
    ...
    def SetPlayerControl(self, value, qualifier):
        ...
        if value in ValueStateValues and 1 <= int(playerID) <= 8:
    ...
    def __MatchRegistrationStatus(self, match, tag):
        ...
        qualifier = {'Line': match.group(1).decode()}
        value = ValueStateValues[match.group(2).decode()]
