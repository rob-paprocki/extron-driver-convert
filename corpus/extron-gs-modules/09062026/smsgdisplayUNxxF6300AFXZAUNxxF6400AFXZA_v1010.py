...
class DeviceClass:
    ...
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'UN60F6300AFXZA': self.smsg_10_511_F63,
            'UN75F6300AFXZA': self.smsg_10_511_F63,
            'UN65F6300AFXZA': self.smsg_10_511_F63,
            'UN55F6300AFXZA': self.smsg_10_511_F63,
            'UN50F6300AFXZA': self.smsg_10_511_F63,
            'UN46F6300AFXZA': self.smsg_10_511_F63,
            'UN40F6300AFXZA': self.smsg_10_511_F63,
            'UN32F6300AFXZA': self.smsg_10_511_F63,
            'UN75F6400AFXZA': self.smsg_10_511_F64,
        }
    ...
    def SetChannelTVStep(self, value, qualifier):
        ...
        ChannelTVStepStateValues = {
            'Up': b'\x08\x22\x03\x00\x01\x00\xD2',
            'Down': b'\x08\x22\x03\x00\x02\x00\xD1',
        }
        ChannelTVStepCmdString = ChannelTVStepStateValues[value]
    ...
    def SetPictureSize(self, value, qualifier):
        ...
        PictureSizeCmdString = PictureSizeStateValues[value]
        self.__SetHelper('PictureSize', PictureSizeCmdString, value, qualifier)
    ...
    def smsg_10_511_F63(self):
        ...
        self.InputStateValues = {
            ...
            'DVI': b'\x08\x22\x0A\x00\x06\x00\xC6',
        }

    def smsg_10_511_F64(self):
