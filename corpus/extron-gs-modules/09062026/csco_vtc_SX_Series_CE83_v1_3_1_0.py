...
class DeviceClass:
    def __init__(self):
        ...
        self.Models = {
            'SX80 CE8.3.X': self.csco_12_2756_SX80,
            'SX20 CE8.3.X': self.csco_12_2756_SX20,
            'SX10 CE8.3.X': self.csco_12_2756_SX10,
        }
        ...
        self._CallHistoryOccurrenceTypeRex = compile('Entry (\d+) OccurrenceType: (\w*)\r\n')
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(compile(b'\*c xConfiguration H323 H323Alias E164: "([0-9*#]{0,30})"\r\n'),self.__MatchH323AliasE164Status, None)
            self.AddMatchString(compile(b'\*c xConfiguration H323 H323Alias ID: "([ \S]{0,49})"\r\n'),self.__MatchH323AliasIDStatus, None)
            ...
            self.AddMatchString(compile(b'\*s Standby State: (Standby|EnteringStandby|Off)\r\n'), self.__MatchStandby, None)
    ...
    def SetAudioOutput(self, value, qualifier):
        ...
        if Output and value in ['On', 'Off']:
            ...
            self.Discard('AudioOutput Invalid Command')
    ...
    def SetCallHistoryRefresh(self, value, qualifier):
        ...
        self.startCallHist = 0
        CallHistoryCmdString = 'xCommand CallHistory Recents Filter: All Offset: 0 Limit: 150 Order: Occurrence{}\r'.format(self._CallHistoryOccurrenceType)
        res = self.SendAndWait(CallHistoryCmdString, 10, deliTag=b'** end')
        if res:
            res = res.decode()
            ...
            self.HistoryoccurrenceTypeList = dict(findall(self._CallHistoryOccurrenceTypeRex, res))
            self.HistoryoccurrenceCountList = dict(findall(self._CallHistoryOccurrenceTypeCount, res))
    ...
    def SetCallHistoryNavigation(self, value, qualifier):
        ...
        if value in ['Up', 'Down', 'Page Up', 'Page Down'] and len(self.HistorydisplayNameList) > 0:
            ...
            self.Discard('CallHistoryNavigation Inapropriate Command.\r\nNo contacts to navigate through.')
    ...
    def SetCallHistorySelect(self, value, qualifier):
        ...
        if 1 <= int(value) <= 20:
            ...
            self.Discard('CallHistorySelect Invalid Command')
    ...
    def SetCameraFocus(self, value, qualifier):
        ...
        if 1 <= int(camID) <= 7:
            if value in ['Far', 'Near', 'Stop']:
                ...
                self.Discard('CameraFocus Invalid Command')
    ...
    def SetCameraFocusSX20(self, value, qualifier):
        ...
        if value in ['Far', 'Near', 'Stop']:
            ...
            self.Discard('CameraFocusSX20 Invalid Command')
    ...
    def SetCameraPan(self, value, qualifier):
        ...
        if 1 <= int(camID) <= 7 and 1 <= int(camSpeed) <= 15:
            ...
            if CameraPanCmdString:
                ...
                self.Discard('CameraPan Invalid Command')
        else:
            self.Discard('CameraPan Invalid Command')
    ...
    def SetCameraPanSX20(self, value, qualifier):
        ...
        if 1 <= int(camSpeed) <= 15:
            ...
            if CameraPanCmdString:
                ...
                self.Discard('CameraPanSX20 Invalid Command')
        else:
            self.Discard('CameraPanSX20 Invalid Command')
    ...
    def SetCameraPresetRecall(self, value, qualifier):
        ...
        if 1 <= int(value) <= 35:
            ...
            self.Discard('CameraPresetRecall Invalid Command')
    ...
    def SetCameraPresetSave(self, value, qualifier):
        ...
        if 1 <= int(camID) <= 7 and 1 <= int(value) <= 35:
            ...
            self.Discard('CameraPresetSave Invalid Command')

    def SetCameraPresetSaveSX20(self, value, qualifier):

        if 1 <= int(value) <= 35:
            self.__SetHelper('CameraPresetSaveSX20','xCommand Camera Preset Store PresetId:{0} CameraId:1\r'.format(value), value, qualifier)
        else:
            self.Discard('CameraPresetSaveSX20 Invalid Command')
    ...
    def SetCameraTilt(self, value, qualifier):
        ...
        if 1 <= int(camID) <= 7 and 1 <= int(camSpeed) <= 15:
            ...
            if CameraTiltCmdString:
                ...
                self.Discard('CameraTilt Invalid Command')
        else:
            self.Discard('CameraTilt Invalid Command')
    ...
    def SetCameraTiltSX20(self, value, qualifier):
        ...
        if 1 <= int(camSpeed) <= 15:
            ...
            if CameraTiltCmdString:
                ...
                self.Discard('CameraTiltSX20 Invalid Command')
        else:
            self.Discard('CameraTiltSX20 Invalid Command')
    ...
    def SetCameraZoom(self, value, qualifier):
        ...
        if 1 <= int(camID) <= 7 and 1 <= int(camSpeed) <= 15:
            ...
            if CameraZoomCmdString:
                ...
                self.Discard('CameraZoom Invalid Command')
        else:
            self.Discard('CameraZoom Invalid Command')
    ...
    def SetCameraZoomSX20(self, value, qualifier):
        ...
        if 1 <= int(camSpeed) <= 15:
            ...
            if CameraZoomCmdString:
                ...
                self.Discard('CameraZoomSX20 Invalid Command')
        else:
            self.Discard('CameraZoomSX20 Invalid Command')
    ...
    def SetConnectedDeviceNavigation(self, value, qualifier):
        ...
        if value in ['Up', 'Down', 'Page Up', 'Page Down'] and self.MaxDevices > 0:
            ...
            self.Discard('ConnectedDeviceNavigation Invalid Command, No Devices found.')
    ...
    def SetDisplayMode(self, value, qualifier):
        ...
        if self.DisplayModeStatesSet[value]:
            ...
            self.Discard('DisplayMode Invalid Command')
    ...
    def SetDNSDomainNameCommand(self, value, qualifier):
        ...
        if value:
            ...
            self.Discard('DNSDomainNameCommand Invalid Command')
    ...
    def UpdateDNSServerAddress(self, value, qualifier):
        ...
        DNSServerAddressCmdString = 'xStatus Network 1 DNS Server {0} Address\r'.format(ServerStates[qualifier['Server']])
    ...
    def SetDNSServerAddressCommand(self, value, qualifier):
        ...
        if value:
            ...
            self.Discard('DNSServerAddressCommand Invalid Command')
    ...
    def SetFarEndCameraPresetRecall(self, value, qualifier):
        ...
        if 1 <= int(value) <= 15:
            ...
            self.Discard('FarEndCameraPresetRecall Invalid Command')
    ...
    def SetFarEndCameraSource(self, value, qualifier):
        ...
        if 0 <= int(value) <= 15:
            ...
            self.Discard('FarEndCameraSource Invalid Command')
    ...
    def SetFarEndCameraZoom(self, value, qualifier):
        ...
        if value in ['In', 'Out']:
            ...
            self.Discard('FarEndCameraZoom Invalid Command')
    ...
    def SetH323AliasE164Command(self, value, qualifier):
        ...
        if value:
            ...
            self.Discard('H323AliasE164Command Invalid Command')
    ...
    def SetH323AliasIDCommand(self, value, qualifier):
        ...
        if value:
            ...
            self.Discard('H323AliasIDCommand Invalid Command')
    ...
    def SetH323GatekeeperAddressCommand(self, value, qualifier):
        ...
        if value:
            ...
            self.Discard('H323GatekeeperAddressCommand Invalid Command')
    ...
    def SetH323ProfileAuthenticationLoginNameCommand(self, value, qualifier):
        ...
        if value:
            ...
            self.Discard('H323ProfileAuthenticationLoginNameCommand Invalid Command')
    ...
    def SetHook(self, value, qualifier):
        ...
        if value in ['Accept', 'Reject']:
            ...
            try:
                ...
                self.Discard('Hook Invalid Command. Not In a Call.')
        elif value is 'Dial':
            ...
            if number:
                ...
                self.Discard('Hook Invalid Command. No qualifier "Number" specified.')
        else:
            self.Discard('Hook Invalid Command')
    ...
    def SetInput(self, value, qualifier):
        ...
        if self.InputStates[value]:
            ...
            self.Discard('Input Invalid Command')
    ...
    def UpdateInputSignal(self, value, qualifier):
        ...
        if input_:
            ...
            self.Discard('InputSignal Invalid Command')
    ...
    def SetInputLineLevel(self, value, qualifier):
        ...
        if input_ and 0 <= value <= 24:
            self.__SetHelper('InputLineLevel', 'xConfiguration Audio Input {0} Level:{1}\r'.format(input_, value), value,
                             qualifier)
        else:
            self.Discard('InputLineLevel Invalid Command')
    ...
    def SetInputMicLevel(self, value, qualifier):
        ...
        if input_ and 0 <= value <= self.InputLevelMax:
            ...
            self.Discard('InputMicLevel Invalid Command')
    ...
    def SetInputMute(self, value, qualifier):
        ...
        if input_:
            ...
            self.Discard('InputMute Invalid Command')
    ...
    def SetIPv4AddressCommand(self, value, qualifier):
        ...
        if value:
            ...
            self.Discard('IPv4AddressCommand Invalid Command')
    ...
    def SetIPv4GatewayCommand(self, value, qualifier):
        ...
        if value:
            ...
            self.Discard('IPv4GatewayCommand Invalid Command')
    ...
    def SetIPv4SubnetMaskCommand(self, value, qualifier):
        ...
        if value:
            ...
            self.Discard('IPv4SubnetMaskCommand Invalid Command')
    ...
    def SetIREmulation(self, value, qualifier):
        ...
        if pressType:
            ...
            self.Discard('IREmulation Invalid Command')
    ...
    def SetLayoutSet(self, value, qualifier):
        ...
        if targetValue:
            LayoutSetCmdString = 'xCommand Video Layout LayoutFamily Set Target: {0} LayoutFamily:{1}\r'.format(targetValue, ValueStateValues[value])
            self.__SetHelper('LayoutSet', LayoutSetCmdString, value, qualifier)
        else:
            self.Discard('LayoutSet Invalid Command')
    ...
    def SetOutputLevel(self, value, qualifier):
        ...
        if Output and -24 <= value <= 0:
            ...
            self.Discard('OutputLevel Invalid Command')
    ...
    def SetPhonebookFolderIDNavigation(self, value, qualifier):
        ...
        if self.FolderLimit != 0:
            ...
            self.Discard('PhonebookFolderIDNavigation Invalid Command')
    ...
    def SetPhonebookNavigation(self, value, qualifier):
        ...
        if self.MaxLabel != 0 and self.newList:
            ...
            self.Discard('PhonebookNavigation Invalid Command')
    ...
    def SetPhonebookFolderIDUpdate(self, value, qualifier):
        ...
        if phonebookValue:
            ...
            self.Discard('PhonebookFolderIDUpdate Invalid Command')
    ...
    def SetPhonebookUpdateHandler(self, value, qualifier):
        ...
        if phonebookType in ['Corporate', 'Local']:
            ...
            self.Discard('PhonebookUpdateHandler Invalid Command')
    ...
    def SetPresentation(self, value, qualifier):
        ...
        cmdState = ''
        if 'Stop' == value:
            cmdState = 'xCommand Presentation Stop{0}{1}\r'.format(instanceState[instanceID],inputSourceStates[inputSource])
        elif 'Start' == value:
        ...
        if cmdState:
            ...
            self.Discard('Presentation Invalid Command')
    ...
    def UpdatePresentationSourceStatus(self, value, qualifier):
        ...
        if 1 <= int(instanceID) <= 6:
            ...
            self.Discard('PresentationSourceStatus Invalid Command')
    ...
    def UpdatePresentationSendingModeStatus(self, value, qualifier):
        ...
        if 1 <= int(instanceID) <= 6:
            ...
            self.Discard('PresentationSendingModeStatus Invalid Command')
    ...
    def SetPresetRecall(self, value, qualifier):
        ...
        if 1 <= int(value) <= 15:
            ...
            self.Discard('PresetRecall Invalid Command')
    ...
    def SetPresetSave(self, value, qualifier):
        ...
        if 1 <= int(value) <= 15:
            ...
            self.Discard('PresetSave Invalid Command')
    ...
    def SetSleepTimer(self, value, qualifier):
        ...
        if 1 <= value <= 480:
            ...
            self.Discard('SleepTimer Invalid Command')
    ...
    def SetStandby(self, value, qualifier):
        ...
        if value in ['Activate', 'Deactivate']:
            ...
            self.Discard('Standby Invalid Command')
    ...
    def __MatchError(self, match, tag):
        ...
        self.Discard(match.group(0).decode())
