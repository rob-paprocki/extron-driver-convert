...
class DeviceClass:
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            self._DeviceID = 0
        elif '138' == value or '168' == value:
            print('Invalid DeviceID. 138 and 168 are not supported.')
        elif 0 < int(value) < 256:
            self._DeviceID = int(value)
        else:
            print('DeviceID is out of range. Range is 1 to 255 and broadcast. 138 and 168 are not valid DeviceID')
    ...
    def SetKeypadLock(self, value, qualifier):
        ...
        KeypadLockCmdString = pack('>5B', 0xA9, 0x17, self._DeviceID, ValueStateValues[value], 0x8A)
    ...
    def UpdateKeypadLock(self, value, qualifier):
        ...
        KeypadLockCmdString = pack('>5B', 0xA9, 0x17, self._DeviceID, 0xAA, 0x8A)
