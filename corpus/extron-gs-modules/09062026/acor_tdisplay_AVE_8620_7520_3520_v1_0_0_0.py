...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\x07\x01\x00MIN([\x00\x09\x0A\x0D\x0E])\x08'), self.__MatchInput, None)
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        ValueStateValues = {
            'Native (PointToPoint)': b'\x07\x01\x02ASP\x00\x08',
            'Full Screen (16:9)': b'\x07\x01\x02ASP\x01\x08',
            'Pillarbox (4:3)': b'\x07\x01\x02ASP\x02\x08',
            'Letterbox': b'\x07\x01\x02ASP\x03\x08',
            'Auto': b'\x07\x01\x02ASP\x04\x08'
        }
    ...
    def __MatchAspectRatio(self, match, tag):
        ...
        ValueStateValues = {
            b'\x00': 'Native (PointToPoint)',
            b'\x01': 'Full Screen (16:9)',
            b'\x02': 'Pillarbox (4:3)',
            b'\x03': 'Letterbox',
            b'\x04': 'Auto'
        }
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'IPC/OPS': '\x07\x01\x02MIN\x0E\x08'
        }
    ...
    def SetRCEmulation(self, value, qualifier):
        ...
        ValueStateValues = {
            'Freeze': '\x07\x01\x02RCU\x18\x08',
            'Blank Screen': '\x07\x01\x02RCU\x28\x08',
            'Volume Up': '\x07\x01\x02RCU\x1D\x08',
            'Volume Down': '\x07\x01\x02RCU\x1E\x08'
        }
