...
class DeviceSerialClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'b ([0-9a-f]{2}) OK(60|70|80|90|a0)x', re.I), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'([ucebadf]) [0-9a-f]{2} NG(.*?)x', re.I), self.__MatchError, None)
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            ...
            self.Error(['DeviceID should be a value between 0 to 255 or Broadcast.'])
    ...
    def SetTransport(self, value, qualifier):
        ...
        TransportCmdString = 'mc {0} {1}\r'.format(self._DeviceID, ValueStateValues[value])
