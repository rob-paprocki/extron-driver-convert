...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'c ([0-9a-fA-F]{2}) OK(01|02|06|07|09|0B)x'), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'b ([0-9a-fA-F]{2}) OK(00|01|20|21|40|60|90|91|92)x'), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'd ([0-9a-fA-F]{2}) OK(01|00)x'), self.__MatchVideoMute, None)
    ...
    def SetChannelStep(self, value, qualifier):
        ...
        ChannelStepCmdString = 'mc {0} {1}\r'.format(self._DeviceID, ChannelStepState[value])
    ...
    def SetIRRemoteControl(self, value, qualifier):

        IRRemoteControlState = {
           'Power'              : '08',
           'Energy Saving'      : '95',
           'AV Mode'            : '30',
           'Input'              : '0B',
        ...
        IRRemoteControlCmdString = 'mc {0} {1}\r'.format(self._DeviceID, IRRemoteControlState[value])
        self.__SetHelper('IRRemoteControl', IRRemoteControlCmdString, value, qualifier)
    ...
    def __MatchOnScreenDisplay(self, match, tag):
        ...
        if self._DeviceID == match.group(1).decode().upper():
            value = OnScreenDisplayState[match.group(2).decode()]
