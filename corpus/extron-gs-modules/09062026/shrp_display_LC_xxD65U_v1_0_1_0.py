    ...
    def SetDTVChannelCable1Command(self, value, qualifier):
        ...
        if temp:
            ...
            if count <= 1:
                ...
                if major.isdigit() and minor.isdigit() and 1 <= int(major) <= 999 and 0 <= int(minor) <= 999:
                    ...
                    self.Discard('Invalid Command for DTVChannelCable1Command')
        else:
            self.Discard('Invalid Command for DTVChannelCable1Command')
    ...
    def UpdateInput1Selection(self, value, qualifier):
        ...
        if res:
            try:
                ...
                self.Error(['Input 1 Selection : Invalid/Unexpected Response'])
    ...
    def UpdateInput2Selection(self, value, qualifier):
        ...
        if res:
            try:
                ...
                self.Error(['Input 2 Selection : Invalid/Unexpected Response'])
