...
class DeviceClass:
    ...
    def __init__(self):
        ...
        self.Models = {
            'SX10 CE9.4.X': self.csco_12_3794_SX20_SX10,
            'SX20 CE9.4.X': self.csco_12_3794_SX20_SX10,
            'SX80 CE9.4.X': self.csco_12_3794_SX80,
        }
    ...
    def UpdateCallStatus(self, value, qualifier):
        self.__UpdateHelper('CallStatus', 'xstatus call\r', None)
        ...
        if len(self.__CallID) > 0:
            for index in range(1, len(callList) + 1):
                ...
                try:
                    ...
                    self.WriteStatus('CallStatusDeviceType', '', {'Call': str(index)})
                try:
                    self.WriteStatus('CallStatusType', callStatusTypeList[index - 1], {'Call': str(index)})
                except IndexError:
                    self.WriteStatus('CallStatusType', '', {'Call': str(index)})
        else:
            self.__CallID = []
            index += 1
            while index <= 5:
    ...
    def SetCameraZoomSX20(self, value, qualifier):
        ...
        if 1 <= int(camSpeed) <= 15:
            ...
            if CameraZoomCmdString:
                self.__SetHelper('CameraZoomSX20', CameraZoomCmdString, value, qualifier)
            else:
    ...
    def SetHook(self, value, qualifier):
        ...
        if value in ['Accept', 'Reject']:
            ...
            if number:
                ...
                self.Discard('Invalid Command for SetHook, Missing Parameter "Number".')
        else:
    ...
    def SetLayoutSet(self, value, qualifier):
        ...
        if qualifier['Target'] in ['Local', 'Remote'] and value in ['Auto', 'Custom', 'Equal', 'Overlay', 'Prominent', 'Single']:
            LayoutSetCmdString = 'xCommand Video Layout LayoutFamily Set Target: {0} LayoutFamily:{1}\r'.format(qualifier['Target'], value)
    ...
    def __MatchLayoutSet(self, match, tag):
        ...
        try:
            ...
            value = 'Custom'
        self.WriteStatus('LayoutSet', value, {'Target': Target})
    ...
    def __MatchPeopleCountCurrentOff(self, match, tag):
        """People Count Current MatchString Handler
    ...
    def __MatchPeopleCountOutofCall(self, match, tag):
        """People Count Out of Call MatchString Handler
    ...
    def __MatchPeoplePresence(self, match, tag):
        """People Presence MatchString Handler
    ...
    def __MatchPeoplePresenceDetector(self, match, tag):
        """People Presence Detector MatchString Handler
    ...
    def __MatchSystemUnitNameStatus(self, match, tag):
        """System Unit Name Status MatchString Handler
    ...
    def csco_12_3794_SX20_SX10(self):
