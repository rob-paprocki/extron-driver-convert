...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x82([\x00\x01])\xCF'), self.__MatchAudioMute, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x35([\x00-\x03])\xCF'), self.__MatchDisplayMode, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x50([\x1F\x1E\x18\x17\x16])\xCF'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x45([\x01\x02])\xCF'), self.__MatchMicrophoneMute, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x37([\x00-\x02])\xCF'), self.__MatchPower, None)
            self.AddMatchString(re.compile(b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x01\x33([\x00-\x64])\xCF'), self.__MatchVolume, None)

    def SetAudioMute(self, value, qualifier):

        ValueStateValues = {
            'On':   b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x0F\x00\xCF',
            'Off':  b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x0F\x01\xCF'
            }
    ...
    def SetDisplayMode(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'Custom':   b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x06\x02\xCF',
            'Auto':     b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x06\x03\xCF'
            }
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            'HDMI 1':   b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x52\xCF',
            'HDMI 2':   b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x53\xCF',
            'HDMI 3':   b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x54\xCF',
            'HDMI 4':   b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x55\xCF',
    ...
    def SetMicrophoneMute(self, value, qualifier):
        ...
        ValueStateValues = {
            'On':   b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x0C\x01\xCF',
            'Off':  b'\x7F\x09\x99\xA2\xB3\xC4\x02\xFF\x0C\x02\xCF'
            }
    ...
    def SetPower(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'Sleep':    b'\x7F\x08\x99\xA2\xB3\xC4\x02\xFF\x01\x51\xCF'
            }
