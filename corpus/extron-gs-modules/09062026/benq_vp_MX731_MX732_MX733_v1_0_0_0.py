...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\*SOUR=(RGB|HDMI|HDMI2|NETWORK|USBREADER)#'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'\*LAMPM=(LNOR|ECO|SECO|SECO2)#'), self.__MatchLampMode, None)
            self.AddMatchString(re.compile(b'\*LTIM=(\d+)#'), self.__MatchLampUsage, None)
            self.AddMatchString(re.compile(b'\*APPMOD=(PRESET|SRGB|CINE|BRIGHT|USER1|USER2)#'), self.__MatchPictureMode, None)
    ...
    def SetLampMode(self, value, qualifier):
        ...
        ValueStateValues = {
            'Normal': 'lnor',
            'Eco': 'eco',
            'Smart Eco (ImageCare)': 'seco',
            'Smart Eco (LampCare)': 'seco2'
        }
