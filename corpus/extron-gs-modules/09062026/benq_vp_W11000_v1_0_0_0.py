...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\*KEYLOCK=(ON|OFF)#\r', re.I), self.__MatchKeyLock, None)
    ...
    def SetKeyLock(self, value, qualifier):
        ...
        KeyLockCmdString = '\r*keylock={0}#\r'.format(ValueStateValues[value])
