...
class DeviceSerialClass:
    ...
    def __init__(self):
        ...
        self.Commands = {
            ...
            'ClosedCaptionDigitalSetting': {'Status': {}},
        ...
        self.UpdateRegex = re.compile(b'\x70[\x03-\x04][\x00-\xFF]|\x70[\x00-\x02][\x02][\x00-\x01][\x00-\xFF]|\x70[\x00-\x02][\x03][\x01-\x07][\x00-\xFF]{2}')

    def BuildCommandString(self, commandstring, header):
        csum = header[0]
    ...
    def SetSoundMode(self, value, qualifier):
        ...
        SoundModeCmdString = b''.join([b'\30\x03\x01', ValueStateValues[value]])
    ...
    def __CheckResponseForErrors(self, sourceCmdName, response):
        ...
        DEVICE_ERROR_CODES = {
            1: 'Limit Over Max Value.',
            2: 'Limit Under Min Value.',
            3: 'Command Canceled.',
            4: 'Parse Error.'
        }
    ...
    def __SetHelper(self, command, commandstring, value, qualifier):
        ...
        commandstring = self.BuildCommandString(commandstring, b'\x8C')
    ...
    def __UpdateHelper(self, command, commandstring, value, qualifier):
        ...
        commandstring = self.BuildCommandString(commandstring, b'\x83')
        if self.Unidirectional == 'True':
...
class DeviceEthernetClass:
    ...
    def SetInput(self, value, qualifier):
        ...
        InputCmdString = b''.join(['INPT'.ljust(11, '0').encode(), ValueStateValues[value][0].ljust(8, '0').encode(), ValueStateValues[value][1]])
        self.__SetHelper('Input', InputCmdString, value, qualifier)
