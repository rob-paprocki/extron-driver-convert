...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'BACKLIGHT\.INTENSITY:([1-9]?[0-9]|100)\r'), self.__MatchBrightness, None)
    ...
    def SetBrightness(self, value, qualifier):
        ...
        if 0 <= value <= 100:
            BrightnessCmdString = 'BACKLIGHT.INTENSITY={}\r'.format(value)
    ...
    def UpdateBrightness(self, value, qualifier):
        ...
        BrightnessCmdString = 'BACKLIGHT.INTENSITY?\r'
    ...
    def SetMute(self, value, qualifier):
        ...
        self.__SetHelper('Mute', 'KEY=26\r', value, qualifier)

    def SetPIPMode(self, value, qualifier):

        self.__SetHelper('PIPMode', 'KEY=270\r', value, qualifier)

    def SetPIPSwap(self, value, qualifier):

        self.__SetHelper('PIPSwap', 'KEY=271\r', value, qualifier)
    ...
    def SetVolume(self, value, qualifier):
        ...
        if value in ValueStateValues:
            self.__SetHelper('Volume', 'KEY={}\r'.format(ValueStateValues[value]), value, qualifier)
        else:
