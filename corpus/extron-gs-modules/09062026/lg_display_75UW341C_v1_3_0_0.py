...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'c [0-9a-f]{2} OK(01|02|04|06|09|30|31)x', re.I), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK(00|01|02|10|11|20|40|60|90|91)x', re.I), self.__MatchInput, None)
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            ...
            print('Invalid Device ID Parameter. Range is from 1 to 99 or Broadcast')
    ...
    def SetClosedCaption(self, value, qualifier):
        ...
        ClosedCaptionCmdString = 'mc {0} 39\r'.format(self._DeviceID)
    ...
    def __CheckResponseForErrors(self, sourceCmdName, response):
        ...
        if 'OK' in response:
            ...
            print('There was an error executing command ' + sourceCmdName)
            return ''
