...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'ASPECT=(00|30|40|50)\r:'), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'SOURCE=(30|A0|21|53)\r:'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'LUMINANCE=(00|01|02)\r:'), self.__MatchLampMode, None)
    ...
    def __MatchVolume(self, match, tag):
        ...
        value = VolumeTable[int(match.group(1).decode())]
