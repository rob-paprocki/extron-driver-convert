...
class DeviceClass:
    ...
    def SetDHCPSetting(self, value, qualifier):
        ...
        if value in ValueStateValues:
            self.__SetHelper('DHCPSetting', ValueStateValues[value], value, qualifier)
        else:
            self.Discard('Invalid Command for SetDHCPSetting')

    def UpdateDHCPSetting(self, value, qualifier):

        self.__UpdateHelper('DHCPSetting', 'INFO\r', value, qualifier)
    ...
    def SetPodControl(self, value, qualifier):
        ...
        if value in ValueStateValues and qualifier['Pod Number'] in PodNumberStates:
            self.__SetHelper('PodControl', ValueStateValues[value].format(PodNumberStates[qualifier['Pod Number']]), value, qualifier)
        else:
    ...
    def UpdatePodCurrent(self, value, qualifier):
        ...
        if 1 <= int(qualifier['Pod Number']) <= 2:
    ...
    def SetSequence(self, value, qualifier):
        ...
        if qualifier['Direction'] in ['Up', 'Down'] and 2 <= value <= 60:
            SequenceCmdString = 'SEQ{}{}\r'.format(qualifier['Direction'].upper(), value)
