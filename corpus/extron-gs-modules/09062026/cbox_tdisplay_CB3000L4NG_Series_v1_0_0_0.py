...
class DeviceClass:
    ...
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'CB3080L-4NG': self.cbox_39_3094_A,
            'CB3090L-4NG': self.cbox_39_3094_B,
            'CB30103L-4NG': self.cbox_39_3094_B,
            'CB3060L-4NG': self.cbox_39_3094_A,
            'CB3070L-4NG': self.cbox_39_3094_B,
            'CB3075L-4NG': self.cbox_39_3094_A,
            }
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'!1MUTE=(0|1)\r'), self.__MatchAudioMute, None)
            self.AddMatchString(re.compile(b'!1FREZ=(0|1)\r'), self.__MatchFreeze, None)
