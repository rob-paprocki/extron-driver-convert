...
class DeviceClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'NP-ME401W': self.nec_1_3072_A,
            'NP-ME361W': self.nec_1_3072_A,
            'NP-ME331W': self.nec_1_3072_A,
            'NP-ME301W': self.nec_1_3072_A,
            'NP-ME401X': self.nec_1_3072_B,
            'NP-ME361X': self.nec_1_3072_B,
            'NP-ME331X': self.nec_1_3072_B,
            'NP-ME301X': self.nec_1_3072_B,
        }

        self.Commands = {
            'ConnectionStatus': {'Status': {}},
            'AspectRatioAspectRatio': {'Status': {}},
            'AudioMute': {'Status': {}},
            'AutoImage': {'Status': {}},
            'DeviceStatus': {'Status': {}},
            'FilterUsage': {'Status': {}},
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        AspectRatioCmdString = self.SetAspectRatioState[value]
    ...
    def UpdateLampUsage(self, value, qualifier):
        ...
        lamp = qualifier['Lamp']
        LampValue = LampStates[lamp]

        cks = 0x9C + LampValue
        LampUsageCmdString = pack('>BBBBBBBB', 0x03, 0x96, 0x00, 0x00, 0x02, LampValue, 0x01, cks)
    ...
    def nec_1_3072_A(self):

        self.SetAspectRatioState = {
    ...
    def nec_1_3072_B(self):
        ...
        self.SetAspectRatioState = {
            ...
            '15:9': b'\x03\x10\x00\x00\x05\x18\x00\x00\x05\x00\x35',
            '16:10': b'\x03\x10\x00\x00\x05\x18\x00\x00\x06\x00\x36',
            'Wide': b'\x03\x10\x00\x00\x05\x18\x00\x00\x01\x00\x31',
            'Native': b'\x03\x10\x00\x00\x05\x18\x00\x00\x03\x00\x33'
        }
