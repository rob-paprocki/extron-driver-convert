...
class DeviceSerialClass:
    ...
    def SetAVMute(self, value, qualifier):
        ...
        AVMuteCmdString = ValueStateValues[value].format(self._DeviceID)
    ...
    def UpdateDisplayMode(self, value, qualifier):
        ...
        DisplayModeCmdString = '~{}123 1\r'.format(self._DeviceID)
...
class DeviceEthernetClass:
    ...
    def SetPowerOff(self, value, qualifier):
        ...
        PowerOffCmdString = '~{}00 0\r\r'.format(self._DeviceID)
