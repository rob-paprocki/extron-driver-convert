...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'DEV1024\r\n'), self.__MatchDeviceType, None)
            self.AddMatchString(re.compile(b'E(1[0123])\r\n'), self.__MatchError, None)

    def SetAutoApplyMode(self, value, qualifier):
    ...
    def __MatchDeviceType(self, match, tag):
        ...
        self.WriteStatus('DeviceType', 'VIO 4K', None)

    def SetLayerSource(self, value, qualifier):
        ...
        LayerSourceCmdString = ValueStateValues[value]
        self.__SetHelper('LayerSource', LayerSourceCmdString, value, qualifier)
    ...
    def OnConnected(self):
        ...
        self.SetAutoApplyMode(None, None)
