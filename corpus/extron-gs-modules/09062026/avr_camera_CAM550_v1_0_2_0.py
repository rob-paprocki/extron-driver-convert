...
class DeviceClass:
    ...
    def SetFocusMode(self, value, qualifier):
        ...
        if value in ValueStateValues:
            FocusModeCmdString = self.SetHeader(pack('6B', self._DeviceID, 0x01, 0x04, 0x38, ValueStateValues[value], 0xFF))
    ...
    def SetPanTilt(self, value, qualifier):
        ...
        if 0 <= pan_speed <= 15 and 0 <= tilt_speed <= 15 and value in ValueStateValues:
            if value == 'Stop':
                PanTiltCmdString = self.SetHeader(pack('>6BHB', self._DeviceID, 0x01, 0x06, 0x01, 0x00, 0x00, ValueStateValues[value], 0xFF))
            else:
                PanTiltCmdString = self.SetHeader(pack('>6BHB', self._DeviceID, 0x01, 0x06, 0x01, pan_speed, tilt_speed, ValueStateValues[value], 0xFF))
    ...
    def SetPIPHDMI(self, value, qualifier):
        ...
        if value in ValueStateValues:
            PIPHDMICmdString = self.SetHeader(pack('7B', self._DeviceID, 0x01, 0x04, 0x7F, 0x01, ValueStateValues[value], 0xFF))
    ...
    def SetPreset(self, value, qualifier):
        ...
        if ValueConstraints['Min'] <= int(value) <= ValueConstraints['Max'] and qualifier['Action'] in ActionStates:
            PresetCmdString = self.SetHeader(pack('7B', self._DeviceID, 0x01, 0x04, 0x3F, ActionStates[qualifier['Action']], int(value), 0xFF))
    ...
    def SetTrackingMode(self, value, qualifier):
        ...
        if value in ValueStateValues:
            TrackingModeCmdString = self.SetHeader(pack('7B', self._DeviceID, 0x01, 0x04, 0x7D, ValueStateValues[value], 0x00, 0xFF))
    ...
    def UpdateTrackingMode(self, value, qualifier):
        ...
        TrackingModeCmdString = self.GetHeader(pack('5B', self._DeviceID, 0x09, 0x04, 0x7D, 0xFF))
