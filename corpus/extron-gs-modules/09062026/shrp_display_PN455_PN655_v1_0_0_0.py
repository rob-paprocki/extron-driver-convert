...
class DeviceClass:
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        if tempValue:
            if tempValue in ['DVI', 'RGB']:
                AspectRatioCmdString = 'WIDE   {0}\r'.format(ValueStateValuesDVI[value])
            elif tempValue in ['Component', 'S-Video / Video']:
                AspectRatioCmdString = 'WIDE   {0}\r'.format(ValueStateValuesComp[value])
    ...
    def UpdateAspectRatio(self, value, qualifier):
        ...
        if res and tempValue:
            try:
                if tempValue in ['DVI', 'RGB']:
                    value = ValueStateValuesDVI[res[0]]
                elif tempValue in ['Component', 'S-Video / Video']:
                    value = ValueStateValuesComp[res[0]]
                if value:
