...
class DeviceSerialClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'd [0-9a-f]{2} OK(00|01)x', re.I), self.__MatchVideoMute, None)
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            ...
            self.Discard('Invalid DeviceID, range is from 1 to 99 or Broadcast')
...
class DeviceEthernetClass:
    ...
    def SetPowerOff(self, value, qualifier):
        ...
        self.__SetHelper('PowerOff', 'ka {0} 00\r'.format(self._DeviceID), value, qualifier)
