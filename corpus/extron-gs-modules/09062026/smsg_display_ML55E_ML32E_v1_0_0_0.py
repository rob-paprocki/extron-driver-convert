...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\xAA\xFF[\x00-\xFD]\x03A\x14(\x14|\x18|\x0C|\x08|\x20|\x1F|\x30|\x40|\x21|\x22|\x25)[\x00-\xFF]'), self.__MatchInput, None)
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            self.__DeviceID = pack('B', 0xFE)
        elif 1 <= int(value) <= 224:
            self.__DeviceID = pack('B', int(value))
        else:
            print("Device ID Parameter is incorrect. DeviceID only supports 'Broadcast' and '1' to '224'")
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        AspectRatioCmdString = b'AA\x18' + self.__DeviceID + b'\x01' + ValueStateValues[value]
        AspectRatioCmdString = AspectRatioCmdString + self.checksum(AspectRatioCmdString)
        self.__SetHelper('AspectRatio', AspectRatioCmdString, value, qualifier)

    def UpdateAspectRatio(self, value, qualifier):

        AspectRatioCmdString = b'\xAA\x18' + self.__DeviceID + b'\x00'
        AspectRatioCmdString = AspectRatioCmdString + self.checksum(AspectRatioCmdString)
    ...
    def SetAutoAdjust(self, value, qualifier):
        ...
        AutoAdjustCmdString = b'\xAA\x3D' + self.__DeviceID + b'\x01\x00'
    ...
    def SetExecutiveMode(self, value, qualifier):
        ...
        ExecutiveModeCmdString = b'\xAA\x5D' + self.__DeviceID + b'\x01' + ValueStateValues[value]
        ExecutiveModeCmdString = ExecutiveModeCmdString + self.checksum(ExecutiveModeCmdString)
        self.__SetHelper('ExecutiveMode', ExecutiveModeCmdString, value, qualifier)

    def UpdateExecutiveMode(self, value, qualifier):

        ExecutiveModeCmdString = b'\xAA\x5D' + self.__DeviceID + b'\x00'
        ExecutiveModeCmdString = ExecutiveModeCmdString + self.checksum(ExecutiveModeCmdString)
    ...
    def SetInput(self, value, qualifier):
        ...
        InputCmdString = b'\xAA\x14' + self.__DeviceID + b'\x01' + ValueStateValues[value]
        InputCmdString = InputCmdString + self.checksum(InputCmdString)
        self.__SetHelper('Input', InputCmdString, value, qualifier)

    def UpdateInput(self, value, qualifier):

        InputCmdString = b'\xAA\x14' + self.__DeviceID + b'\x00'
        InputCmdString = InputCmdString + self.checksum(InputCmdString)
    ...
    def SetPiPMode(self, value, qualifier):
        ...
        PiPModeCmdString = b'\xAA\x3C' + self.__DeviceID + b'\x01' + ValueStateValues[value]
        PiPModeCmdString = PiPModeCmdString + self.checksum(PiPModeCmdString)
        self.__SetHelper('PiPMode', PiPModeCmdString, value, qualifier)

    def UpdatePiPMode(self, value, qualifier):

        PiPModeCmdString = b'\xAA\x3C' + self.__DeviceID + b'\x00'
        PiPModeCmdString = PiPModeCmdString + self.checksum(PiPModeCmdString)
    ...
    def SetPower(self, value, qualifier):
        ...
        PowerCmdString = b'\xAA\x11' + self.__DeviceID + b'\x01' + ValueStateValues[value]
    ...
    def UpdatePower(self, value, qualifier):
        ...
        PowerCmdString = b'\xAA\x11' + self.__DeviceID + b'\x00'
        PowerCmdString = PowerCmdString + self.checksum(PowerCmdString)
    ...
    def SetScreenSize(self, value, qualifier):
        ...
        if ValueConstraints['Min'] <= value <= ValueConstraints['Max']:
            ScreenSizeCmdString = b'\xAA\x19' + self.__DeviceID + b'\x01' + pack('B', value)
    ...
    def UpdateScreenSize(self, value, qualifier):
        ...
        ScreenSizeCmdString = b'\xAA\x19' + self.__DeviceID + b'\x00'
        ScreenSizeCmdString = ScreenSizeCmdString + self.checksum(ScreenSizeCmdString)
    ...
    def SetVideoWall(self, value, qualifier):
        ...
        VideoWallCmdString = b'\xAA\x84' + self.__DeviceID + b'\x01' + ValueStateValues[value]
    ...
    def UpdateVideoWall(self, value, qualifier):
        ...
        VideoWallCmdString = b'\xAA\x84' + self.__DeviceID + b'\x00'
        VideoWallCmdString = VideoWallCmdString + self.checksum(VideoWallCmdString)
    ...
    def SetVideoWallMode(self, value, qualifier):
        ...
        VideoWallModeCmdString = b'\xAA\x5C' + self.__DeviceID + b'\x01' + ValueStateValues[value]
    ...
    def UpdateVideoWallMode(self, value, qualifier):
        ...
        VideoWallModeCmdString = b'\xAA\x5C' + self.__DeviceID + b'\x00'
        VideoWallModeCmdString = VideoWallModeCmdString + self.checksum(VideoWallModeCmdString)
    ...
    def SetVideoWallSize(self, value, qualifier):
        ...
        if 1 <= row <= 15 and 1 <= col <= 15 and 1 <= value <= 100:
            if (row * col) <= 100 and value <= (row * col):
                VideoWallSizeCmdString = b'\xAA\x89' + self.__DeviceID + b'\x02' + pack('B', row * 16 + col) + pack('B', value)
    ...
    def UpdateVideoWallSize(self, value, qualifier):
        ...
        VideoWallSizeCmdString = b'\xAA\x89' + self.__DeviceID + b'\x00'
        VideoWallSizeCmdString = VideoWallSizeCmdString + self.checksum(VideoWallSizeCmdString)
    ...
    def SetVolume(self, value, qualifier):
        ...
        if ValueConstraints['Min'] <= value <= ValueConstraints['Max']:
            VolumeCmdString = b'\xAA\x12' + self.__DeviceID + b'\x01' + pack('B', value)
    ...
    def UpdateVolume(self, value, qualifier):
        ...
        VolumeCmdString = b'\xAA\x12' + self.__DeviceID + b'\x00'
        VolumeCmdString = VolumeCmdString + self.checksum(VolumeCmdString)
    ...
    def __UpdateHelper(self, command, commandstring, value, qualifier):
        ...
        if self.Unidirectional == 'True' or self.__DeviceID == 0xFE:
