...
class DeviceSerialClass:
    ...
    def SetFocus(self, value, qualifier):
        ...
        if 0 <= focusSpeed <= 7:
            ...
            if value == 'Near':
                FocusCmdString = self._DeviceID + b'\x01\x04\x08' + bytes([0x20 + focusSpeed]) + b'\xFF'
            elif value == 'Far':
                FocusCmdString = self._DeviceID + b'\x01\x04\x08' + bytes([0x30 + focusSpeed]) + b'\xFF'
            elif value == 'Stop':
    ...
    def SetHome(self, value, qualifier):
        HomeCmdString = self._DeviceID + b'\x01\x06\x0C\xFF'
    ...
    def SetPanTiltZoom(self, value, qualifier):
        ...
        if 1 <= panSpeed <= 24 and 1 <= tiltSpeed <= 20 and 0 <= zoomSpeed <= 7:
...
class DeviceEthernetClass:
    ...
    def SetFocus(self, value, qualifier):
        ...
        elif value == 'Far' or value == 'Near':
            if 1 <= int(focusSpeed) <= 8:
