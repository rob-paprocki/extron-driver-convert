...
class DeviceClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'ControlSpace ESP-880': self.bose_25_159_ESP_1U,
            'ControlSpace ESP-00 Series II': self.bose_25_159_ESP_00,
            'ControlSpace ESP-1240': self.bose_25_159_ESP_1U,
            'ControlSpace ESP-1600': self.bose_25_159_ESP_1U,
            'ControlSpace ESP-4120': self.bose_25_159_ESP_1U,
            'ControlSpace EX-1280C': self.bose_25_159_EX,
            'PowerMatch PM4250N': self.bose_25_159_PM,
            'PowerMatch PM4500N': self.bose_25_159_PM,
            'PowerMatch PM8250N': self.bose_25_159_PM,
            'PowerMatch PM8500N': self.bose_25_159_PM,
            'ControlSpace ESP-1240AD': self.bose_25_159_ESP_1U,
            'ControlSpace ESP-880AD': self.bose_25_159_ESP_1U,
            'ControlSpace EX-12AEC': self.bose_25_159_EX,
            }
        ...
        self.Commands = {
            ...
            'AMMGatedDetection': {'Parameters': ['Name', 'Index 1'], 'Status': {}},
            ...
            'AMMGatedNOM': {'Parameters': ['Name'], 'Status': {}},
            'AMMGatedPriority': {'Parameters': ['Name', 'Index 1'], 'Status': {}},
            'AMMGatedPushToTalk': {'Parameters': ['Name', 'Index 1'], 'Status': {}},
            ...
            'PSTNAction': {'Parameters': ['Name'], 'Status': {}},
            ...
            'RoomCombineLayout': {'Parameters': ['Group', 'Room 1', 'Room 2'], 'Status': {}},
            ...
            'SignalLevel': {'Parameters': ['Module', 'Channel'], 'Status': {}},
            ...
            'StandardRoomCombinerMainInputGain': {'Parameters': ['Name'], 'Status': {}},
            'StandardRoomCombinerMainInputMute': {'Parameters': ['Name'], 'Status': {}},
            'StandardRoomCombinerMainOutputGain': {'Parameters': ['Name'], 'Status': {}},
            'StandardRoomCombinerMainOutputMute': {'Parameters': ['Name'], 'Status': {}},
            'SurroundInputLevel': {'Parameters': ['Name', 'Level'], 'Status': {}},
            'SurroundInputOutputFormat': {'Parameters': ['Name'], 'Status': {}},
            'SurroundInputRoomType': {'Parameters': ['Name'], 'Status': {}},
            'SurroundInputSource': {'Parameters': ['Name'], 'Status': {}},
            'ToneControlGain': {'Parameters': ['Name', 'Type'], 'Status': {}},
            'USBLevel': {'Parameters': ['Name', 'Channel'], 'Status': {}},
            'USBMute': {'Parameters': ['Name', 'Channel'], 'Status': {}},
            'VoIPAction': {'Parameters': ['Name'], 'Status': {}},
    ...
    def SetAECCNEnable(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= 12 and value in ValueStateValues:
    ...
    def SetAECNRLevel(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= 12 and 0 <= value <= 24:
    ...
    def SetAMMGatedAttack(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max and 0.5 <= value <= self.AMMGatedAttack_Value_Max:
    ...
    def UpdateAMMGatedAttack(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max:
    ...
    def SetAMMGatedDecay(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max and self.AMMGatedDecay_Value_Min <= value <= 50000:
            AMMGatedDecayCmdString = 'SA"{}">{}>{}={}\r'.format(name, index1, self.command_index['AMMGatedDecay'], value)
    ...
    def UpdateAMMGatedDecay(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max:
            AMMGatedDecayCmdString = 'GA"{}">{}>{}\r'.format(name, index1, self.command_index['AMMGatedDecay'])
    ...
    def SetAMMGatedDetection(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= 8 and value in ValueStateValues:
            AMMGatedDetectionCmdString = 'SA"{}">{}>3={}\r'.format(name, index1, ValueStateValues[value])
            self.__SetHelper('AMMGatedDetection', AMMGatedDetectionCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetAMMGatedDetection')

    def UpdateAMMGatedDetection(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= 8:
            AMMGatedDetectionCmdString = 'GA"{}">{}>3\r'.format(name, index1)
            res = self.parse(self.__UpdateHelper('AMMGatedDetection', AMMGatedDetectionCmdString, value, qualifier))
            if res:
                try:
                    value = ValueStateValues[res]
                    self.WriteStatus('AMMGatedDetection', value, qualifier)
                except (KeyError, IndexError):
                    self.Error(['AMM Gated Detection: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateAMMGatedDetection')
    ...
    def SetAMMGatedDuckingDepth(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max and -60 <= value <= 0:
            AMMGatedDuckingDepthCmdString = 'SA"{}">{}>{}={:.1f}\r'.format(name, index1, self.command_index['AMMGatedDuckingDepth'], value)
    ...
    def UpdateAMMGatedDuckingDepth(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max:
            AMMGatedDuckingDepthCmdString = 'GA"{}">{}>{}\r'.format(name, index1, self.command_index['AMMGatedDuckingDepth'])
    ...
    def SetAMMGatedGain(self, value, qualifier):
        ...
        if name and 0 <= int(index1) <= self.AMMGated_Index1_Max and -60.5 <= value <= self.AMMGatedGain_Value_Max:
            if index1 == '0':
    ...
    def UpdateAMMGatedGain(self, value, qualifier):
        ...
        if name and 0 <= int(index1) <= self.AMMGated_Index1_Max:
            if index1 == '0':
    ...
    def SetAMMGatedGateDepth(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max and -70 <= value <= 0:
            AMMGatedGateDepthCmdString = 'SA"{}">{}>{}={:.1f}\r'.format(name, index1, self.command_index['AMMGatedGateDepth'], value)
    ...
    def UpdateAMMGatedGateDepth(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max:
            AMMGatedGateDepthCmdString = 'GA"{}">{}>{}\r'.format(name, index1, self.command_index['AMMGatedGateDepth'])
    ...
    def SetAMMGatedHighPass(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max and 20 <= value <= self.AMMGatedHighPass_Value_Max:
            if self.Model == 'ESP':
                AMMGatedHighPassCmdString = 'SA"{}">{}>10={}\r'.format(name, index1, value)
            else:
                value = float('{:.1f}'.format(value))
    ...
    def SetAMMGatedHold(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max and 1 <= value <= 50000:
            AMMGatedHoldCmdString = 'SA"{}">{}>{}={}\r'.format(name, index1, self.command_index['AMMGatedHold'], value)
    ...
    def UpdateAMMGatedHold(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max:
            AMMGatedHoldCmdString = 'GA"{}">{}>{}\r'.format(name, index1, self.command_index['AMMGatedHold'])
    ...
    def SetAMMGatedLowPass(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max and self.AMMGatedLowPass_Value_Min <= value <= 20000:
            if self.Model == 'ESP':
                AMMGatedLowPassCmdString = 'SA"{}">{}>{}={}\r'.format(name, index1, self.command_index['AMMGatedLowPass'], value)
            else:
                value = float('{:.1f}'.format(value))
                AMMGatedLowPassCmdString = 'SA"{}">{}>{}={:.1f}\r'.format(name, index1, self.command_index['AMMGatedLowPass'], value)
    ...
    def UpdateAMMGatedLowPass(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max:
            AMMGatedLowPassCmdString = 'GA"{}">{}>{}\r'.format(name, index1, self.command_index['AMMGatedLowPass'])
    ...
    def SetAMMGatedMute(self, value, qualifier):
        ...
        if name and 0 <= int(index1) <= self.AMMGated_Index1_Max and value in ValueStateValues:
            if index1 == '0':
                AMMGatedMuteCmdString = 'SA"{}">0>{}={}\r'.format(name, self.command_index['AMMGatedMute 0'], ValueStateValues[value])
            else:
                AMMGatedMuteCmdString = 'SA"{}">{}>{}={}\r'.format(name, index1, self.command_index['AMMGatedMute X'], ValueStateValues[value])
    ...
    def UpdateAMMGatedMute(self, value, qualifier):
        ...
        if name and 0 <= int(index1) <= self.AMMGated_Index1_Max:
            if index1 == '0':
                AMMGatedMuteCmdString = 'GA"{}">0>{}\r'.format(name, self.command_index['AMMGatedMute 0'])
            else:
                AMMGatedMuteCmdString = 'GA"{}">{}>{}\r'.format(name, index1, self.command_index['AMMGatedMute X'])
    ...
    def SetAMMGatedNOM(self, value, qualifier):
        ...
        if name and value in ValueStateValues:
            AMMGatedNOMCmdString = 'SA"{}">0>2={}\r'.format(name, ValueStateValues[value])
            self.__SetHelper('AMMGatedNOM', AMMGatedNOMCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetAMMGatedNOM')

    def UpdateAMMGatedNOM(self, value, qualifier):
        ...
        if name:
            AMMGatedNOMCmdString = 'GA"{}">0>2\r'.format(name)
            res = self.parse(self.__UpdateHelper('AMMGatedNOM', AMMGatedNOMCmdString, value, qualifier))
            if res:
                try:
                    value = ValueStateValues[res]
                    self.WriteStatus('AMMGatedNOM', value, qualifier)
                except (KeyError, IndexError):
                    self.Error(['AMM Gated NOM: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateAMMGatedNOM')
    ...
    def SetAMMGatedPriority(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max and value in self.AMMGatedPriority_Set_Values:
            AMMGatedPriorityCmdString = 'SA"{}">{}>1={}\r'.format(name, index1, self.AMMGatedPriority_Set_Values[value])
    ...
    def UpdateAMMGatedPriority(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max:
            ...
            if res:
                try:
                    value = self.AMMGatedPriority_Get_Values[res]
    ...
    def SetAMMGatedPushToTalk(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= 8 and value in ValueStateValues:
            AMMGatedPushToTalkCmdString = 'SA"{}">{}>15={}\r'.format(name, index1, ValueStateValues[value])
            self.__SetHelper('AMMGatedPushToTalk', AMMGatedPushToTalkCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetAMMGatedPushToTalk')

    def UpdateAMMGatedPushToTalk(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= 8:
            AMMGatedPushToTalkCmdString = 'GA"{}">{}>15\r'.format(name, index1)
            res = self.parse(self.__UpdateHelper('AMMGatedPushToTalk', AMMGatedPushToTalkCmdString, value, qualifier))
            if res:
                try:
                    value = ValueStateValues[res]
                    self.WriteStatus('AMMGatedPushToTalk', value, qualifier)
                except (KeyError, IndexError):
                    self.Error(['AMM Gated Push To Talk: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateAMMGatedPushToTalk')
    ...
    def SetAMMGatedRMSAvg(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max and 1 <= value <= self.AMMGatedRMSAvg_Value_Max:
            AMMGatedRMSAvgCmdString = 'SA"{}">{}>{}={}\r'.format(name, index1, self.command_index['AMMGatedRMSAvg'], value)
    ...
    def UpdateAMMGatedRMSAvg(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max:
            AMMGatedRMSAvgCmdString = 'GA"{}">{}>{}\r'.format(name, index1, self.command_index['AMMGatedRMSAvg'])
    ...
    def SetAMMGatedThreshold(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max and self.AMMGatedThreshold_Value_Min <= value <= 0:
            AMMGatedThresholdCmdString = 'SA"{}">{}>{}={:.1f}\r'.format(name, index1, self.command_index['AMMGatedThreshold'], value)
    ...
    def UpdateAMMGatedThreshold(self, value, qualifier):
        ...
        if name and 1 <= int(index1) <= self.AMMGated_Index1_Max:
            AMMGatedThresholdCmdString = 'GA"{}">{}>{}\r'.format(name, index1, self.command_index['AMMGatedThreshold'])
    ...
    def SetClearFaultAlarms(self, value, qualifier):

        ClearFaultAlarmsCmdString = 'CF\r'
        self.__SetHelper('ClearFaultAlarms', ClearFaultAlarmsCmdString, value, qualifier)
    ...
    def SetDelayTime(self, value, qualifier):
        ...
        if name and 1 <= int(output) <= 8 and 0 <= value <= self.DelayTime_Value_Max:
    ...
    def UpdateFaultStatus(self, value, qualifier):
        ...
        FaultStatusCmdString = 'GF\r'
        res = self.__UpdateHelper('FaultStatus', FaultStatusCmdString, value, qualifier)
        if res:
            try:
                res = res.strip(';\r').split()[-1]
                value = ValueStateValues[res]
                self.WriteStatus('FaultStatus', value, qualifier)
            except (KeyError, IndexError):
                self.Error(['Fault Status: Invalid/unexpected response'])
    ...
    def SetGroupLevel(self, value, qualifier):
        ...
        if 1 <= int(group) <= 64 and -60.0 <= value <= self.GroupLevel_Value_Max:
    ...
    def SetRoomCombineLayout(self, value, qualifier):

        group = int(qualifier['Group'])
        room1 = int(qualifier['Room 1'])
        room2 = int(qualifier['Room 2'])
        ...
        if all(1 <= n <= 6 for n in [group, room1, room2]) and value in ValueStateValues:
            RoomCombineLayoutCmdString = 'SRC {},{},{},{}\r'.format(group, room1, room2, ValueStateValues[value])
            self.__SetHelper('RoomCombineLayout', RoomCombineLayoutCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetRoomCombineLayout')

    def UpdateRoomCombineLayout(self, value, qualifier):
        ...
        if all(1 <= n <= 6 for n in [group, room1, room2]):
            RoomCombineLayoutCmdString = 'GRC {},{},{}\r'.format(group, room1, room2)
            res = self.__UpdateHelper('RoomCombineLayout', RoomCombineLayoutCmdString, value, qualifier)
            if res:
                try:
                    res = res.strip(';\r').split(',')[-1]
                    value = ValueStateValues[res]
                    self.WriteStatus('RoomCombineLayout', value, qualifier)
                except (KeyError, IndexError):
                    self.Error(['Room Combine Layout: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateRoomCombineLayout')
    ...
    def UpdateSignalLevel(self, value, qualifier):
        ...
        if module in ModuleStates and 1 <= channel <= 128:
            SignalLevelCmdString = 'GL {}\r'.format(ModuleStates[module])
            res = self.__UpdateHelper('SignalLevel', SignalLevelCmdString, value, qualifier)
            if res:
                try:
                    res = res.strip(';\r').split()[-1].strip('[]').split(',')
                    for c in range(min(len(res), 128)):
                        q = {
                            'Module':   qualifier['Module'],
                            'Channel':  c + 1
                        }
                        value = -60 + (int(res[c].strip(), 16) / 2)

                        self.WriteStatus('SignalLevel', value, q)
                except (ValueError, IndexError):
                    self.Error(['Signal Level: Invalid/unexpected response'])
        else:
            self.Discard('Device Is Busy for UpdateSignalLevel')
    ...
    def SetStandardRoomCombinerMainInputGain(self, value, qualifier):

        name = qualifier['Name']
        value = float('{:.1f}'.format(value))

        if name and -60.5 <= value <= 12.0:
            StandardRoomCombinerMainInputGainCmdString = 'SA"{}">1>4={:.1f}\r'.format(name, value)
            self.__SetHelper('StandardRoomCombinerMainInputGain', StandardRoomCombinerMainInputGainCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetStandardRoomCombinerMainInputGain')

    def UpdateStandardRoomCombinerMainInputGain(self, value, qualifier):

        name = qualifier['Name']

        if name:
            StandardRoomCombinerMainInputGainCmdString = 'GA"{}">1>4\r'.format(name)
            res = self.parse(self.__UpdateHelper('StandardRoomCombinerMainInputGain', StandardRoomCombinerMainInputGainCmdString, value, qualifier))
            if res:
                try:
                    value = float('{:.1f}'.format(float(res)))
                    if value == -999:
                        value = -60.5
                    self.WriteStatus('StandardRoomCombinerMainInputGain', value, qualifier)
                except (ValueError, IndexError):
                    self.Error(['Standard Room Combiner Main Input Gain: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateStandardRoomCombinerMainInputGain')

    def SetStandardRoomCombinerMainInputMute(self, value, qualifier):
        ...
        if name and value in ValueStateValues:
            StandardRoomCombinerMainInputMuteCmdString = 'SA"{}">1>5={}\r'.format(name, ValueStateValues[value])
            self.__SetHelper('StandardRoomCombinerMainInputMute', StandardRoomCombinerMainInputMuteCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetStandardRoomCombinerMainInputMute')

    def UpdateStandardRoomCombinerMainInputMute(self, value, qualifier):
        ...
        if name:
            StandardRoomCombinerMainInputMuteCmdString = 'GA"{}">1>5\r'.format(name)
            res = self.parse(self.__UpdateHelper('StandardRoomCombinerMainInputMute', StandardRoomCombinerMainInputMuteCmdString, value, qualifier))
            if res:
                try:
                    value = ValueStateValues[res]
                    self.WriteStatus('StandardRoomCombinerMainInputMute', value, qualifier)
                except (KeyError, IndexError):
                    self.Error(['Standard Room Combiner Main Input Mute: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateStandardRoomCombinerMainInputMute')

    def SetStandardRoomCombinerMainOutputGain(self, value, qualifier):

        name = qualifier['Name']
        value = float('{:.1f}'.format(value))

        if name and -60.5 <= value <= 12.0:
            StandardRoomCombinerMainOutputGainCmdString = 'SA"{}">1>6={:.1f}\r'.format(name, value)
            self.__SetHelper('StandardRoomCombinerMainOutputGain', StandardRoomCombinerMainOutputGainCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetStandardRoomCombinerMainOutputGain')

    def UpdateStandardRoomCombinerMainOutputGain(self, value, qualifier):

        name = qualifier['Name']

        if name:
            StandardRoomCombinerMainOutputGainCmdString = 'GA"{}">1>6\r'.format(name)
            res = self.parse(self.__UpdateHelper('StandardRoomCombinerMainOutputGain', StandardRoomCombinerMainOutputGainCmdString, value, qualifier))
            if res:
                try:
                    value = float('{:.1f}'.format(float(res)))
                    if value == -999:
                        value = -60.5
                    self.WriteStatus('StandardRoomCombinerMainOutputGain', value, qualifier)
                except (ValueError, IndexError):
                    self.Error(['Standard Room Combiner Main Output Gain: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateStandardRoomCombinerMainOutputGain')

    def SetStandardRoomCombinerMainOutputMute(self, value, qualifier):
        ...
        if name and value in ValueStateValues:
            StandardRoomCombinerMainOutputMuteCmdString = 'SA"{}">1>7={}\r'.format(name, ValueStateValues[value])
            self.__SetHelper('StandardRoomCombinerMainOutputMute', StandardRoomCombinerMainOutputMuteCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetStandardRoomCombinerMainOutputMute')

    def UpdateStandardRoomCombinerMainOutputMute(self, value, qualifier):
        ...
        if name:
            StandardRoomCombinerMainOutputMuteCmdString = 'GA"{}">1>7\r'.format(name)
            res = self.parse(self.__UpdateHelper('StandardRoomCombinerMainOutputMute', StandardRoomCombinerMainOutputMuteCmdString, value, qualifier))
            if res:
                try:
                    value = ValueStateValues[res]
                    self.WriteStatus('StandardRoomCombinerMainOutputMute', value, qualifier)
                except (KeyError, IndexError):
                    self.Error(['Standard Room Combiner Main Output Mute: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateStandardRoomCombinerMainOutputMute')

    def SetSurroundInputLevel(self, value, qualifier):
        ...
        LevelStates = {
            ...
            'Center':               '8',
            'LFE (Sub)':            '9',
            'Back Surround Left':   '10',
            'Back Surround Right':  '11'
        }
        ...
        if name and level in LevelStates and -60.5 <= value <= 12.0:
            SurroundInputLevelCmdString = 'SA"{}">{}={:.1f}\r'.format(name, LevelStates[level], value)
            self.__SetHelper('SurroundInputLevel', SurroundInputLevelCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetSurroundInputLevel')

    def UpdateSurroundInputLevel(self, value, qualifier):
        ...
        if name and level in LevelStates:
            SurroundInputLevelCmdString = 'GA"{}">{}\r'.format(name, LevelStates[level])
            res = self.parse(self.__UpdateHelper('SurroundInputLevel', SurroundInputLevelCmdString, value, qualifier))
            if res:
                try:
                    value = float('{:.1f}'.format(float(res)))
                    if value == -999:
                        value = -60.5
                    self.WriteStatus('SurroundInputLevel', value, qualifier)
                except (ValueError, IndexError):
                    self.Error(['Surround Input Level: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateSurroundInputLevel')

    def UpdateSurroundInputOutputFormat(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'DD51':     'Dolby5.1',
            'DTS51':    'DTS 5.1',
            'ES61D':    'DTS 5.1 Discrete',
            'ES61M':    'DTS 5.1 Matrix',
            'DD1':      'Dolby1.0',
            'DD2':      'Dolby2.0',
            'DTS1':     'DTS1.0',
            'DTS2':     'DTS2.0',
        ...
        if name:
            SurroundInputOutputFormatCmdString = 'GA"{}">2\r'.format(name)
            res = self.parse(self.__UpdateHelper('SurroundInputOutputFormat', SurroundInputOutputFormatCmdString, value, qualifier))
            if res:
                try:
                    value = ValueStateValues[res]
                    self.WriteStatus('SurroundInputOutputFormat', value, qualifier)
                except (KeyError, IndexError):
                    self.Error(['Surround Input Output Format: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateSurroundInputOutputFormat')

    def UpdateSurroundInputRoomType(self, value, qualifier):
        ...
        if name:
            SurroundInputRoomTypeCmdString = 'GA"{}">3\r'.format(name)
            res = self.parse(self.__UpdateHelper('SurroundInputRoomType', SurroundInputRoomTypeCmdString, value, qualifier))
            if res:
                try:
                    value = ValueStateValues[res]
                    self.WriteStatus('SurroundInputRoomType', value, qualifier)
                except (KeyError, IndexError):
                    self.Error(['Surround Input Room Type: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateSurroundInputRoomType')

    def SetSurroundInputSource(self, value, qualifier):
        ...
        if name and value in ValueStateValues:
            SurroundInputSourceCmdString = 'SA"{}">1={}\r'.format(name, ValueStateValues[value])
            self.__SetHelper('SurroundInputSource', SurroundInputSourceCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetSurroundInputSource')

    def UpdateSurroundInputSource(self, value, qualifier):
        ...
        if name:
            SurroundInputSourceCmdString = 'GA"{}">1\r'.format(name)
            res = self.parse(self.__UpdateHelper('SurroundInputSource', SurroundInputSourceCmdString, value, qualifier))
            if res:
                try:
                    value = ValueStateValues[res]
                    self.WriteStatus('SurroundInputSource', value, qualifier)
                except (KeyError, IndexError):
                    self.Error(['Surround Input Source: Invalid/unexpected response'])
        else:
            self.Discard('Invalid Command for UpdateSurroundInputSource')
    ...
    def __SetHelper(self, command, commandstring, value, qualifier):
        ...
        if self.Unidirectional == 'True' or command == 'UserDefinedCommand' or command in {'GroupLevel', 'GroupMute', 'ParameterRecall', 'RoomCombineLayout'}:
    ...
    def OnDisconnected(self):
        ...
        if self.Model == 'EX':
            ...
            self.lastSignalLevelUpdate = defaultdict(float)
            self.lastVoIPCallerIDUpdate = defaultdict(float)

    def bose_25_159_ESP_00(self):
        self.Model = 'ESP'
        self.AMMGated_Index1_Max = 8
        self.AMMGatedAttack_Value_Max = 100.0
        self.AMMGatedDecay_Value_Min = 5
        self.AMMGatedGain_Value_Max = 0.0
        self.AMMGatedHighPass_Value_Max = 1000
        self.AMMGatedLowPass_Value_Min = 300
        self.AMMGatedPriority_Set_Values = {
            'On':   'O',
            'Off':  'F'
        }
        self.AMMGatedPriority_Get_Values = {
            'O': 'On',
            'F': 'Off'
        }
        self.AMMGatedRMSAvg_Value_Max = 500
        self.AMMGatedThreshold_Value_Min = -60.0
        self.DelayTime_Value_Max = 144000
        self.GroupLevel_Value_Max = 12.0
        self.command_index = {
            'AMMGatedDecay':        8,
            'AMMGatedDuckingDepth': 7,
            'AMMGatedGateDepth':    5,
            'AMMGatedHold':         6,
            'AMMGatedLowPass':      11,
            'AMMGatedMute 0':       3,
    ...
    def bose_25_159_ESP_1U(self):
        ...
        self.AMMGatedRMSAvg_Value_Max = 500
        self.AMMGatedThreshold_Value_Min = -60.0
        self.DelayTime_Value_Max = 48000
        self.GroupLevel_Value_Max = 12.0
        self.command_index = {
            'AMMGatedDecay':        8,
            'AMMGatedDuckingDepth': 7,
    ...
    def bose_25_159_EX(self):
        self.Model = 'EX'
        self.AMMGated_Index1_Max = 32
        self.AMMGatedAttack_Value_Max = 500.0
        self.AMMGatedDecay_Value_Min = 1
        self.AMMGatedGain_Value_Max = 12.0
        self.AMMGatedHighPass_Value_Max = 20000.0
        self.AMMGatedLowPass_Value_Min = 20
        self.AMMGatedPriority_Set_Values = {
            '1': '1',
            '2': '2',
            '3': '3',
        ...
        self.AMMGatedPriority_Get_Values = self.AMMGatedPriority_Set_Values
        self.AMMGatedRMSAvg_Value_Max = 1000
        self.AMMGatedThreshold_Value_Min = -80.0
        self.DelayTime_Value_Max = 48000
        self.GroupLevel_Value_Max = 12.0
        self.command_index = {
            'AMMGatedDecay':        16,
            'AMMGatedDuckingDepth': 12,
            'AMMGatedGateDepth':    13,
            'AMMGatedHold':         15,
            'AMMGatedLowPass':      9,
            'AMMGatedMute 0':       2,
            'AMMGatedMute X':       3,
    ...
    def bose_25_159_PM(self):
        self.Model = 'PM'
        self.GroupLevel_Value_Max = 0.0
