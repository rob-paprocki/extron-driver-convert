...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'(On|Off)\r\nOk\r\n'), self.__MatchOutletPower, None)
    ...
    def __MatchOutletPower(self, match, tag):
        ...
        self.WriteStatus('OutletPower', value, None)
    ...
    def __UpdateHelper(self, command, commandstring, value, qualifier):
        ...
        if self.Unidirectional == 'True' or not self.loggedIn:
