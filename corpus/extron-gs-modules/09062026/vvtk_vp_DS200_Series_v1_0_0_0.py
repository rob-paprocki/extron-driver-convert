...
class DeviceClass:
    ...
    def __init__(self):
        ...
        self.Models = {
            'DS234': self.vvtk_1_3117_DS234DX255,
            'DX255': self.vvtk_1_3117_DS234DX255,
            'DX251': self.vvtk_1_3117_DS230DX251,
            'DS230': self.vvtk_1_3117_DS230DX251,
            }
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\$SOUR=(RGB|RGB2|HDMI|VID|SVID)#\r', re.I), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'\$LAMPM=(LNOR|ECO|SECO)#\r', re.I), self.__MatchLampMode, None)
            self.AddMatchString(re.compile(b'\$LTIM=(\d+)#\r', re.I), self.__MatchLampUsage, None)
            self.AddMatchString(re.compile(b'\$APPMOD=(DYNAMIC|PRESET|SRGB|CINE|STD|USER1|USER2)#\r', re.I), self.__MatchPictureMode, None)
    ...
    def __MatchInput(self, match, tag):
        ...
        value = self.InputStateNames[match.group(1).decode().upper()]
    ...
    def SetLampMode(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'Economic': '\r$lampm=eco#\r',
            'Dynamic': '\r$lampm=seco#\r'
        }
    ...
    def SetPictureMode(self, value, qualifier):
        ...
        ValueStateValues = {
            'Bright': '\r$appmod=dynamic#\r',
            'Presentation': '\r$appmod=preset#\r',
            'sRGB': '\r$appmod=srgb#\r',
            'Movie': '\r$appmod=cine#\r',
            'Standard': '\r$appmod=std#\r',
    ...
    def vvtk_1_3117_DS234DX255(self):
    ...
    def vvtk_1_3117_DS230DX251(self):
