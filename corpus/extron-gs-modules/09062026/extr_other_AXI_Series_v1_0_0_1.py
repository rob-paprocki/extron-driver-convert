...
class DeviceClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'AXI 22 AT': self.extr_31_5521_22,
            'AXI 44 AT': self.extr_31_5521_44,
            }
        ...
        self.LevelTypes = {
            'InputGain'                 : {'Min' : 0,  'Max' : 42},
            'ATOutputAttenuation'         : {'Min' : -100, 'Max' : 0},
        }

        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'Exe([012])'), self.__MatchExecutiveMode, None),
    ...
    def extr_31_5521_22(self):
        self.OutputSize = 2
        self.InputSize = 2

    def extr_31_5521_44(self):
        self.OutputSize = 4
        self.InputSize = 4
    ######################################################
