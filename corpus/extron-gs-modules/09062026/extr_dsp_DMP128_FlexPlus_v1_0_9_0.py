...
class DeviceClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'DMP 128 FlexPlus C AT': self.extr_25_4286_128AT,
            'DMP 128 FlexPlus C V AT': self.extr_25_4286_128VAT,
        }
        ...
        self.Commands = {
            ...
            'Dial': {'Parameters':['Line', 'Number'], 'Status': {}},
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'(Pno60-182[01]-10)\r\n'), self.__MatchPartNumber, None)
    ...
    def __MatchDanteGroup(self, match, tag):
        ...
        WriteFunction = {
            'DanteGroupMute'                     : self.WriteDanteGroupMute,
            'DanteGroupPreMixerGain'             : self.WriteDanteGroupPreMixerGain,
            'DanteGroupOutputAttenuation'        : self.WriteDanteGroupOutputAttenuation,
            'DanteGroupMixpointGain'             : self.WriteDanteGroupMixpointGain,
            'DanteGroupPostMixerTrim'            : self.WriteDanteGroupPostMixerTrim,
            'DanteGroupMicLineInputGain'         : self.WriteDanteGroupMicLineInputGain,
        }
        dante_device = match.group(1).decode()
        ...
        if group in self.GroupFunction:
            ...
            if command == 'DanteGroupMute':
                ...
                value = match.group(3).decode()
                WriteFunction[command](GroupMuteStateNames[value], qualifier, 'Live')
                ...
                WriteFunction[command](value, qualifier, 'Live')
    ...
    def SetDanteInputMute(self, value, qualifier):
        ...
        dante_device = qualifier['Dante Device']
        channel = int(qualifier['Input'])
        if value in MuteStateValues and 1 <= channel <= 4 and dante_device:
