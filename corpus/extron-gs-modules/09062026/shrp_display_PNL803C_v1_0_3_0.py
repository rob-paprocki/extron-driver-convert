...
class DeviceClass:
    ...
    def SetAdjustmentLock(self, value, qualifier):
        ...
        AdjustmentLockCmdString = 'ALCK{0: 4}\r\n'.format(AdjustmentLockValues[value])
    ...
    def SetAdjustmentLockTarget(self, value, qualifier):
        ...
        AdjustmentLockCmdString = 'ALTG{0: 4}\r\n'.format(AdjustmentLockTargetValues[value])
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        temp = qualifier['Input']
        if temp in ['AV', 'PC']:
            if temp == 'AV':
                AspectRatioCmdString = 'WIDE{0: 4}\r\n'.format(AspectRatioValuesAV[value])
            else:
                AspectRatioCmdString = 'WIDE{0: 4}\r\n'.format(AspectRatioValuesPC[value])
    ...
    def UpdateAspectRatio(self, value, qualifier):
        ...
        if temp in ['AV', 'PC']:
            ...
            print('Invalid qualifier for UpdateAspectRatio')

    def SetAutoImage(self, value, qualifier):
        AutoImageCmdString = 'ASNC{0: 4}\r\n'.format(1)
    ...
    def SetPIPMode(self, value, qualifier):
        ...
        PIPCmdString = 'MWIN{0: 4}\r\n'.format(PIPStateValues[value])
        self.__SetHelper('PIPMode', PIPCmdString, value, qualifier)
    ...
    def UpdatePIPMode(self, value, qualifier):
        ...
        PIPCmdString = 'MWIN????\r\n'
        res = self.__UpdateHelper('PIPMode', PIPCmdString, value, qualifier)
        if res:
            try:
    ...
    def SetPIPSource(self, value, qualifier):
        ...
        PIPSourceCmdString = 'MWIP{0: 4}\r\n'.format(PIPSourceStateValues[value])
