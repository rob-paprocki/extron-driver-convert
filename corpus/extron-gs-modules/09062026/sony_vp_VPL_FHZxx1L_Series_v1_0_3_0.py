...
class DeviceClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'Input': {'Status': {}},
            'LensFocus': {'Status': {}},
            'LensPositionMemoryDelete': { 'Status': {}},
            'LensPositionMemorySave': { 'Status': {}},
            'LensPositionMemorySelect': { 'Status': {}},
            'LensShift': {'Status': {}},
            'LensZoom': {'Status': {}},
            'LightHours': {'Status': {}},
            'LightMode': {'Status': {}},
    ...
    def UpdateDeviceStatus(self, value, qualifier):
        ...
        if res:
            try:
                ...
                if len(value) == 1:
                    value = ValueStateValues[value[0]]
                else:
    ...
    def SetLensFocus(self, value, qualifier):
        ...
        ValueStateValues = {
            'Focus': '"lens_focus"',
            'Far': '"lens_focus_far"',
            'Near': '"lens_focus_near"',
        }

        if value in ValueStateValues:
            LensFocusCmdString = 'key {}\r\n'.format(ValueStateValues[value])
            self.__SetHelper('LensFocus', LensFocusCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetLensFocus')

    def SetLensPositionMemoryDelete(self, value, qualifier):

        if 1 <= int(value) <= 6:
            LensPositionMemoryDeleteCmdString = 'pic_pos_del "custom{}"\r\n'.format(value)
            self.__SetHelper('LensPositionMemoryDelete', LensPositionMemoryDeleteCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetLensPositionMemoryDelete')

    def SetLensPositionMemorySave(self, value, qualifier):

        if 1 <= int(value) <= 6:
            LensPositionMemorySaveCmdString = 'pic_pos_save "custom{}"\r\n'.format(value)
            self.__SetHelper('LensPositionMemorySave', LensPositionMemorySaveCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetLensPositionMemorySave')

    def SetLensPositionMemorySelect(self, value, qualifier):

        if 1 <= int(value) <= 6:
            LensPositionMemorySelectCmdString = 'pic_pos_sel "custom{}"\r\n'.format(value)
            self.__SetHelper('LensPositionMemorySelect', LensPositionMemorySelectCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetLensPositionMemorySelect')
    ...
    def SetLensShift(self, value, qualifier):
        ...
        ValueStateValues = {
            'Shift': '"lens_shift"',
            'Up': '"lens_shift_up"',
            'Down': '"lens_shift_down"',
            'Left': '"lens_shift_left"',
            'Right': '"lens_shift_right"',
        }

        if value in ValueStateValues:
            LensShiftCmdString = 'key {}\r\n'.format(ValueStateValues[value])
    ...
    def SetLensZoom(self, value, qualifier):
        ...
        if value in ValueStateValues:
            LensZoomCmdString = 'key {}\r\n'.format(ValueStateValues[value])
            self.__SetHelper('LensZoom', LensZoomCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetLensZoom')

    def UpdateLightHours(self, value, qualifier):

        LightHoursCmdString = 'timer ?\r\n'
        res = self.__UpdateHelper('LightHours', LightHoursCmdString, value, qualifier)
        if res:
            try:
                value = json.loads(res)[1]['light_src']
                self.WriteStatus('LightHours', value, qualifier)
            except (json.decoder.JSONDecodeError, IndexError, KeyError):
                self.Error(['Light Hours: Invalid/unexpected response'])

            try:
                value = json.loads(res)[0]['operation']
    ...
    def SetLightMode(self, value, qualifier):
        ...
        if value in ValueStateValues:
            LightModeCmdString = 'light_output_mode {}\r\n'.format(ValueStateValues[value])
    ...
    def UpdateLightMode(self, value, qualifier):
        ...
        LightModeCmdString = 'light_output_mode ?\r\n'
        res = self.__UpdateHelper('LightMode', LightModeCmdString, value, qualifier)
        if res:
            try:
                value = ValueStateValues[res.strip()]
                self.WriteStatus('LightMode', value, qualifier)
            except (KeyError, IndexError):
                self.Error(['Light Mode: Invalid/unexpected response'])
    ...
    def UpdateOperationHours(self, value, qualifier):
        ...
        self.UpdateLightHours(value, qualifier)
    ...
    def OnDisconnected(self):
        ...
        self.sha256hash = ''
        self.__is_authenticated = not self.ConnectionType == 'Ethernet'
