...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'c [a-f0-9]{2} OK(0[26])x', re.I), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'b [a-f0-9]{2} OK(90|91|92|A0|A1|A2|E0)x', re.I), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'y [a-f0-9]{2} OK(.*)x', re.I), self.__MatchSerialNumber, None)
            self.AddMatchString(re.compile(b'z [a-f0-9]{2} OK(.*)x', re.I), self.__MatchSoftwareVersion, None)
            self.AddMatchString(re.compile(b'd [a-f0-9]{2} OK(0[01])x', re.I), self.__MatchVideoMute, None)
            self.AddMatchString(re.compile(b'f [a-f0-9]{2} OK([0-9a-f]{2})x', re.I), self.__MatchVolume, None)
            self.AddMatchString(re.compile(b'([cemblayzdf]) [a-f0-9]{2} NG.*?x', re.I), self.__MatchError, None)

            self.setRegex = re.compile(b'[cemblayzdf] [a-f0-9]{2} (?:OK|NG).*?x', re.I)
    ...
    def UpdateSerialNumber(self, value, qualifier):
        ...
        SerialNumberCmdString = 'fy {} FF\r'.format(self._DeviceID)
    ...
    def UpdateSoftwareVersion(self, value, qualifier):
        ...
        SoftwareVersionCmdString = 'fz {} FF\r'.format(self._DeviceID)
