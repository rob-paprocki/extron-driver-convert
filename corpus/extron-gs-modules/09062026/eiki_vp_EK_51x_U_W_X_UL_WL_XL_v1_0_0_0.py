...
class DeviceClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'EK-510U': self.eiki_1_3536_UW,
            'EK-510UL': self.eiki_1_3536_UW,
            'EK-511W': self.eiki_1_3536_UW,
            'EK-511WL': self.eiki_1_3536_UW,
            'EK-512X': self.eiki_1_3536_X,
            'EK-512XL': self.eiki_1_3536_X,
            }
    ...
    def UpdateInput(self, value, qualifier):
        ...
        if res:
            try:
                value = self.UpdateInputStates[int(res[:-1])]
