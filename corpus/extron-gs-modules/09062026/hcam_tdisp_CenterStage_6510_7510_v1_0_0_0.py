...
class DeviceClass:
    ...
    def SetEco(self, value, qualifier):
        ...
        EcoCmdString = b'\x99\x23\x16\x01\xE9\xAA'
    ...
    def SetInput(self, value, qualifier):
        ...
        InputState = {
            'TV'        : b'\x99\x23\x07\x01\xF8\xAA', 
            'AV'        : b'\x99\x23\x08\x01\xF7\xAA', 
            'YPbPr'     : b'\x99\x23\x0A\x01\xF5\xAA', 
            'VGA'       : b'\x99\x23\x0B\x01\xF4\xAA', 
            'HDMI'      : b'\x99\x23\x0E\x01\xF1\xAA', 
            'PC'        : b'\x99\x23\x11\x01\xEE\xAA', 
            'Multimedia': b'\x99\x23\x27\x01\xD8\xAA'
            }
    ...
    def SetVolume(self, value, qualifier):
        ...
        VolumeState = {
            ...
            'Down'  : b'\x99\x23\x17\x01\xE7\xAA'
            }
