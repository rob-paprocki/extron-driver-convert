...
class DeviceSerialClass:
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        ValueStateValues = {
            'Auto': '\x02AD{0};VSE:00\x03',
            'Normal': '\x02AD{0};VSE:01\x03',
            'Wide': '\x02AD{0};VSE:02\x03',
            'Native': '\x02AD{0};VSE:05\x03',
            'Full': '\x02AD{0};VSE:06\x03',
            'H-Fit': '\x02AD{0};VSE:09\x03',
    ...
    def SetAudioMute(self, value, qualifier):
        ...
        ValueStateValues = {
            'On': '\x02AD{0};AMT:1\x03',
            'Off': '\x02AD{0};AMT:0\x03'
        }

        AudioMuteCmdString = ValueStateValues[value].format(self._DeviceID)
    ...
    def UpdateAudioMute(self, value, qualifier):
        ...
        AudioMuteCmdString = '\x02AD{0};QMT\x03'.format(self._DeviceID)
    ...
    def SetClosedCaption(self, value, qualifier):
        ...
        ValueStateValues = {
            'Off': '\x02AD{0};OCC:0\x03',
            'CC1': '\x02AD{0};OCC:1\x03',
            'CC2': '\x02AD{0};OCC:2\x03',
            'CC3': '\x02AD{0};OCC:3\x03',
            'CC4': '\x02AD{0};OCC:4\x03'
        }

        ClosedCaptionCmdString = ValueStateValues[value].format(self._DeviceID)
    ...
    def UpdateClosedCaption(self, value, qualifier):
        ...
        ClosedCaptionCmdString = '\x02AD{0};QCC\x03'.format(self._DeviceID)
    ...
    def UpdateFilterUsage(self, value, qualifier):
        ...
        FilterUsageCmdString = '\x02AD{0};QFI:0\x03'.format(self._DeviceID)
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            'Computer 1': '\x02AD{0};IIS:RG1\x03',
            'Computer 2': '\x02AD{0};IIS:RG2\x03',
            'Video': '\x02AD{0};IIS:VID\x03',
            'HDMI 1': '\x02AD{0};IIS:HD1\x03',
            'HDMI 2': '\x02AD{0};IIS:HD2\x03'
        }
    ...
    def SetLampMode(self, value, qualifier):
        ...
        ValueStateValues = {
            'Normal': '\x02AD{0};OLP:1\x03',
            'Eco 1': '\x02AD{0};OLP:3\x03',
            'Eco 2': '\x02AD{0};OLP:4\x03'
        }
    ...
    def UpdateOperationHours(self, value, qualifier):
        ...
        OperationHoursCmdString = '\x02AD{0};QVX:RTMI0\x03'.format(self._DeviceID)
    ...
    def SetPictureMode(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'Blackboard': '\x02AD{0};VPM:BBD\x03',
            'Cinema': '\x02AD{0};VPM:CIN\x03',
            'Whiteboard': '\x02AD{0};VPM:WBD\x03'
        }
    ...
    def SetVolume(self, value, qualifier):
        ...
        if 0 <= value <= 63:
            VolumeCmdString = '\x02AD{0};AVL:{1}'.format(self._DeviceID, str(value).zfill(3))
