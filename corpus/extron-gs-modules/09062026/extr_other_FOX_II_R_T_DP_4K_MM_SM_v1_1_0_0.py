...
class DeviceClass:
    ...
    def UpdateAudioGainAttenuation(self, value, qualifier):
        ...
        if res:
            try:
                matched = re.search(self.audioGainRegex, res)
                if matched:
    ...
    def SetAudioInputFormat(self, value, qualifier):
        ...
        AudioInputFormatCmdString = ValueStateValues[value]
    ...
    def UpdateAudioInputFormat(self, value, qualifier):
        ...
        AudioInputFormatCmdString = '\x1BIAFMT\r\n'
        res = self.__UpdateHelper('AudioInputFormat', AudioInputFormatCmdString, value, qualifier)
        if res:
            try:
    ...
    def UpdateAudioMute(self, value, qualifier):
        ...
        AudioMuteCmdString = '{0}Z\r\n'.format(OutputValues[qualifier['Output']])
    ...
    def UpdateOutputResolution(self, value, qualifier):
        ...
        OutputResolutionCmdString = '\x1BRATE\r\n'
    ...
    def UpdateTemperature(self, value, qualifier):
        ...
        TemperatureCmdString = '20S'
        res = self.__UpdateHelper('Temperature', TemperatureCmdString, value, qualifier)
        if res:
            try:
                regex = re.search('([0-9]{1,3})F ([0-9]{1,3})C\r\n', res)
                self.WriteStatus('Temperature', int(regex.group(1)), {'Unit': 'Fahrenheit'})
                self.WriteStatus('Temperature', int(regex.group(2)), {'Unit': 'Celsius'})
