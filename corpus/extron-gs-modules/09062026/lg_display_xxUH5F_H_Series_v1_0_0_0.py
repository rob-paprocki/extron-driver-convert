...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'c [a-f0-9]{2,3} OK(0[26])x', re.I), self.__MatchAspectRatio, None)
            self.AddMatchString(re.compile(b'e [a-f0-9]{2,3} OK(0[01])x', re.I), self.__MatchAudioMute, None)
            self.AddMatchString(re.compile(b'm [a-f0-9]{2,3} OK(0[01])x', re.I), self.__MatchExecutiveMode, None)
            self.AddMatchString(re.compile(b'b [a-f0-9]{2,3} OK(90|a0|91|a1|c2|d2|c0|d0|70|80)x', re.I), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'l [a-f0-9]{2,3} OK(0[01])x', re.I), self.__MatchOnScreenDisplay, None)
            self.AddMatchString(re.compile(b'a [a-f0-9]{2,3} OK(0[01])x', re.I), self.__MatchPower, None)
            self.AddMatchString(re.compile(b'd [a-f0-9]{2,3} OK(0[01])x', re.I), self.__MatchVideoMute, None)
            self.AddMatchString(re.compile(b'f [a-f0-9]{2,3} OK([0-9a-f]{2})x', re.I), self.__MatchVolume, None)
            self.AddMatchString(re.compile(b'([cembladf]) [a-f0-9]{2,3} NG.*?x', re.I), self.__MatchError, None)

        self.setRegex = re.compile(b'[cembladf] [a-f0-9]{2,3} (?:OK|NG).*?x', re.I)
