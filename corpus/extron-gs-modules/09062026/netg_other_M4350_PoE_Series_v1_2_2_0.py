...
class DeviceClass:
    def __init__(self, ipAddress, port, deviceUsername, devicePassword, SSLVerifyMode='On'):
        ...
        self.Models = {
            'M4350-24G4XF': self.netg_31_16864_24,
            'M4350-36X4V': self.netg_31_16864_36,
            'M4350-48G4XF': self.netg_31_16864_48,
        }
    ...
    def netg_31_16864_24(self):

        self.size = 24

    def netg_31_16864_36(self):

        self.size = 36

    def netg_31_16864_48(self):
