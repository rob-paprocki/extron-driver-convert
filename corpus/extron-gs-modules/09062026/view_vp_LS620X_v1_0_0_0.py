...
class DeviceClass:
    ...
    def Set3DSync(self, value, qualifier):
        ...
        States = {
            'Off': b'\x00\x8F',
            'Auto': b'\x01\x7F',
            'Frame Sequential': b'\x02\x91',
            'Frame Packing': b'\x03\x92',
            'Top Bottom': b'\x04\x93',
            'Side By Side': b'\x05\x94'
        }

        CmdString = b'\x06\x14\x00\x04\x00\x34\x11\x32' + States[value]
    ...
    def Update3DSync(self, value, qualifier):
        ...
        res = self.__UpdateHelper('3DSync', b'\x07\x14\x00\x05\x00\x34\x00\x00\x11\x32\x90', value, qualifier)
        if res:
            try:
