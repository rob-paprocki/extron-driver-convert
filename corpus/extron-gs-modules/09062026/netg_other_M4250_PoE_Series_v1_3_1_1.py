# Copyright 2025-2026, Extron. All rights reserved.
...
class DeviceClass:
    def __init__(self, ipAddress, port, deviceUsername, devicePassword, SSLVerifyMode='On'):
        ...
        self.Models = {
            'M4250-26G4XF-PoE+': self.netg_31_6830_24,
            'M4250-40G8XF-PoE+': self.netg_31_6830_40,
            'M4250-10G2XF-PoE++': self.netg_31_6830_8,
            'M4250-10G2F-PoE+': self.netg_31_6830_8,
        }
    ...
    def SetPoEConfiguration(self, value, qualifier):
        ...
        if 1 <= int(qualifier['Port']) <= self.size and qualifier['Power Limit Mode'] in PowerLimitModeStates and qualifier['Classification'] in ClassificationStates and 0 <= qualifier['Current Power'] <= 30000 and 0 <= qualifier['Power Limit'] <= 30000 and qualifier['Status'] in StatusStates and value in ValueStateValues:
    ...
    def UpdatePoEConfigurationStatus(self, value, qualifier):
        ...
        if 1 <= int(qualifier['Port']) <= self.size:
    ...
    def netg_31_6830_24(self):

        self.size = 24

    def netg_31_6830_40(self):

        self.size = 40

    def netg_31_6830_8(self):
