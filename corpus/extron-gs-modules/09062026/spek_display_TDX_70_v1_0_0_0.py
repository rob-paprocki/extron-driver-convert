...
class DeviceClass:
    ...
    def SetIREmulation(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'Channel +': b'\xAA\xBB\xCC\x07\x02\x00\x09\xDD\xEE\xFF',
            'Channel -': b'\xAA\xBB\xCC\x07\x09\x00\x10\xDD\xEE\xFF',
    ...
    def SetPower(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'Off': b'\xAA\xBB\xCC\x01\x00\x00\x02\xDD\xEE\xFF'
        }
    ...
    def SetTVChannel(self, value, qualifier):
        ...
        if ValueConstraints['Min'] <= value <= ValueConstraints['Max']:
            checksum = 5 + 0 + int(value)
            TVChannelCmdString = bytes([0xAA, 0xBB, 0xCC, 0x05, 0x00, int(value), checksum, 0xDD, 0xEE, 0xFF])
    ...
    def SetVolumeMute(self, value, qualifier):
        ...
        VolumeMuteCmdString = ValueStateValues[value]
