...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'ASPECT=([12356A]0)\r:'), self.__MatchAspectRatio, None)
            self.AddMatchString(re.compile(b'ASPECT=[012356A]0 (30)\r:'), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'SOURCE=(30|A0|53|80)\r:'), self.__MatchInput, None)
    ...
    # sending other commands, otherwise the device will close
    # the connection.
