...
class DeviceSerialClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False' or self._DeviceID != 'ZZ':
            ...
            self.VideoMuteRegex = re.compile('\x02(?P<value>[0-1])\x03')
    ...
    def SetVolume(self, value, qualifier):
        ...
        if 0 <= value <= 63:
            VolumeCmdString = '\x02AD{};AVL:{:>03}\x03'.format(self._DeviceID, value)
    ...
    def SetVolumeStep(self, value, qualifier):
        ...
        if value in ValueStateValues:
            VolumeStepCmdString = '\x02AD{};{}\x03'.format(self._DeviceID, ValueStateValues[value])
...
class DeviceEthernetClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'%1INPT=(11|31|32|33|41|51)\r'), self.__MatchInput, None)
