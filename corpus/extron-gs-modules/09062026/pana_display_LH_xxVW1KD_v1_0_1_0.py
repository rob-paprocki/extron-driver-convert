...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\x02AD94;RAD:(\d{3});QMI:(HM1|HM2|DP1|DV1|UD1)\x03'), self.__MatchInput, None)
    ...
    def getHeader(self, DisplayID):
        if DisplayID == 'Broadcast':
            return '\x02AD94;RAD:000;'
        elif 1 <= int(DisplayID) <= 100:
            return '\x02AD94;RAD:{0:03d};'.format (int(DisplayID))
    ...
    def SetAudioMute(self, value, qualifier):
        ...
        Header = self.getHeader(qualifier['Display ID'])
        if Header:
            AudioMuteCmdString = Header + ValueStateValues[value]
    ...
    def UpdateAudioMute(self, value, qualifier):
        ...
        Header = self.getHeader(qualifier['Display ID'])
        if Header:
            AudioMuteCmdString = Header + 'QAM\x03'
    ...
    def __MatchAudioMute(self, match, tag):
        ...
        qualifier = {}
        qualifier['Display ID'] = str(int(match.group(1).decode()))
    ...
    def SetInput(self, value, qualifier):
        ...
        Header = self.getHeader(qualifier['Display ID'])
        if Header:
            InputCmdString = Header + ValueStateValues[value]
    ...
    def SetPower(self, value, qualifier):
        ...
        Header = self.getHeader(qualifier['Display ID'])
        if Header:
            PowerCmdString = Header + ValueStateValues[value]
    ...
    def __MatchPower(self, match, tag):
        ...
        displayID = str(int(match.group(1).decode()))
        value = ValueStateValues[match.group(2).decode()]
        self.WriteStatus('Power', value, {'Display ID':displayID})
    ...
    def SetVideoMute(self, value, qualifier):
        ...
        Header = self.getHeader(qualifier['Display ID'])
        if Header:
            VideoMuteCmdString = Header + ValueStateValues[value]
    ...
    def UpdateVideoMute(self, value, qualifier):
        ...
        Header = self.getHeader(qualifier['Display ID'])
        if Header:
            VideoMuteCmdString = Header + 'QVM\x03'
    ...
    def SetVolume(self, value, qualifier):
        ...
        Header = self.getHeader(qualifier['Display ID'])
        if 0 <= value <= 60 and Header:
            VolumeCmdString = Header + 'AVL:{0:03d}\x03'.format(value)
    ...
    def UpdateVolume(self, value, qualifier):
        ...
        Header = self.getHeader(qualifier['Display ID'])
        if Header:
            VolumeCmdString = Header + 'QAV\x03'
    ...
    def __UpdateHelper(self, command, commandstring, value, qualifier):
        ...
        Reject = False
        if 'Display ID' in qualifier:
            if qualifier['Display ID'] == 'Broadcast':
                Reject = True
