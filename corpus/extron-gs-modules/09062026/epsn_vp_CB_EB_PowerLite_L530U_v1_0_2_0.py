...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'ASPECT=([3456A]0)\r:'), self.__MatchAspectRatio, None)
            self.AddMatchString(re.compile(b'ASPECT=[3456A]0 (30)\r:'), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'SOURCE=(10|20|30|52|53|56|59|80|A0)\r:'), self.__MatchInput, None)
