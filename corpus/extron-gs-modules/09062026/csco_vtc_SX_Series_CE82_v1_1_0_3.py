...
class DeviceClass:
    def __init__(self):
        ...
        self.Models = {
            'SX80 CE8.2.X': self.csco_12_2298_SX80,
            'SX20 CE8.2.X': self.csco_12_2298_SX20_SX10,
            'SX10 CE8.2.X': self.csco_12_2298_SX20_SX10,
        }
    ...
    def SetInputMute(self, value, qualifier):
        ...
        if input_:
            self.__SetHelper('InputMute', 'xConfiguration Audio Input {0} Mode:{1}\r'.format(input_, valueStates[value]),
                             value, qualifier)
        else:
            self.Discard('Invalid Command')
        ...
        if self.MaxLabel != 0 and self.newList:
            if value in ['Up', 'Down', 'Page Up', 'Page Down']:
                ...
                if self.MaxLabel > len(self.newList) and len(
                        self.newList) == self._NumberOfContactsPerSearch:
    ...
    def csco_12_2298_SX20_SX10(self):
