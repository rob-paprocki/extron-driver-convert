...
class DeviceClass:
    ...
    def __init__(self):
        ...
        self.AddMatchString(re.compile(b'\x07\x01\x00ASP(\x01|\x02|\x04)\x08'), self.__MatchAspectRatio, None)
        ...
        self.AddMatchString(re.compile(b'\x07\x01\x00MIN(\x00|\x0D|\x09|\x01)\x08'), self.__MatchInput, None)
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        ValueStateValues = {
            'Full Screen' : '\x07\x01\x02ASP\x01\x08', 
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'HDMI'        : '\x07\x01\x02MIN\x09\x08', 
            'Digital DVI' : '\x07\x01\x02MIN\x01\x08'
        }
    ...
    def UpdateVolume(self, value, qualifier):
        ...
        VolumeCmdString = pack('>7B',0x07,0x01,0x01,0x56,0x4F,0x4C,0x08)
