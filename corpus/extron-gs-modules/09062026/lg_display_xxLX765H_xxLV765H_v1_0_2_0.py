...
class DeviceSerialClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK(00|01|10|11|20|40|90|91)x'), self.__MatchInput, None)
    ...
    def __UpdateHelper(self, command, commandstring, value, qualifier):
        ...
        if self.Unidirectional == 'True' or self._DeviceID == '00':
            ...
            osd = self.ReadStatus('OnScreenDisplay', qualifier)
            if osd in ['Off', None] or command in ['Power', 'OnScreenDisplay']:
                self.Send(commandstring)            
