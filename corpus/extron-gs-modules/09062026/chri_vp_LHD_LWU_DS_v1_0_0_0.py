...
class DeviceClass:
    ...
    def UpdateVolumeLevelStatus(self, value, qualifier):
        ...
        if inputType in VolumeState:
            VolumeLevelStatusCmdString = VolumeState[inputType]
    ...
    def SetVolumeStep(self, value, qualifier):
        ...
        InputSelectStates = {
            ...
            'Video'         : VideoState,
            '3G-SDI'        : SDIState,
            'DisplayPort'   : DisplayPortState,
            'HDMI 1'        : HDMI1State,
            'HDMI 2'        : HDMI2State,
            'HDBaseT'       : HDBaseTState,
            'LAN'           : LANState
            }

        inputType = qualifier['Input']
        if inputType in InputSelectStates:
            VolumeStepCmdString = InputSelectStates[inputType][value]
