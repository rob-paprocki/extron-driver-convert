...
class DeviceClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'PA502S': self.view_1_3681_A,
            'PA502SP': self.view_1_3681_A,
            'PA502X': self.view_1_3681_A,
            'PA502XP': self.view_1_3681_A,
            'PA505W': self.view_1_3681_C,
            'PX705HD': self.view_1_3681_B,
            'PA500S': self.view_1_3681_B,
            'PA503S': self.view_1_3681_B,
            'PA500X': self.view_1_3681_B,
            'PA503X': self.view_1_3681_B,
            'PA503W': self.view_1_3681_C,
            'PA503SP': self.view_1_3681_B,
            'PA503XP': self.view_1_3681_B,
        }
        ...
        if self.Unidirectional == 'False':
            self.updateRegex = re.compile(b'\x05\x14\x00[\x03|\x06]\x00\x00[\x00-\xFF]{3,6}')
    ...
    def Set3DSync(self, value, qualifier):
        ...
        SyncCmdString = b'\x06\x14\x00\x04\x00\x34\x12\x20' + ValueStateValues[value]
        self.__SetHelper('3DSync', SyncCmdString, value, qualifier)
    ...
    def Update3DSync(self, value, qualifier):
        ...
        SyncCmdString = b'\x07\x14\x00\x05\x00\x34\x00\x00\x12\x20\x7F'
        res = self.__UpdateHelper('3DSync', SyncCmdString, value, qualifier)
        if res:
            try:
    ...
    def Set3DSyncInvert(self, value, qualifier):
        ...
        SyncInvertCmdString = b'\x06\x14\x00\x04\x00\x34\x12\x21' + ValueStateValues[value]
    ...
    def Update3DSyncInvert(self, value, qualifier):
        ...
        SyncInvertCmdString = b'\x07\x14\x00\x05\x00\x34\x00\x00\x12\x21\x80'
