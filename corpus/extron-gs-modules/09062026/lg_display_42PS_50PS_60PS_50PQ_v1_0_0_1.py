...
class DeviceClass:
    def __init__(self):
        ...
        self.Models = {
            '60PS60C': self.lg_10_2490_4,
            '42PQ20': self.lg_10_2490_3,
            '50PQ20': self.lg_10_2490_3,
            '42PQ30': self.lg_10_2490_3,
            '50PQ30': self.lg_10_2490_3,
            '42PQ31': self.lg_10_2490_3,
            '50PQ31': self.lg_10_2490_3,
            '42PQ60': self.lg_10_2490_4,
            '50PQ60': self.lg_10_2490_4,
            '50PS30': self.lg_10_2490_3,
            '50PS60': self.lg_10_2490_4,
            '60PS60': self.lg_10_2490_4,
            '42PQ30C': self.lg_10_2490_3,
            '50PQ30C': self.lg_10_2490_3,
            '50PS60C': self.lg_10_2490_4,
            '50PS70': self.lg_10_2490_4,
            '60PS70': self.lg_10_2490_4,
            '50PS80': self.lg_10_2490_4,
            '60PS80': self.lg_10_2490_4,
        }
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'm [0-9a-f]{2} OK0([10])x'), self.__MatchExecutiveMode, None)
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK(00|01|10|11|20|21|40|41|60|90|91|92|93)x'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'l [0-9a-f]{2} OK0([10])x'), self.__MatchOnScreenDisplay, None)
            self.AddMatchString(re.compile(b'a [0-9a-f]{2} OK0([10])x'), self.__MatchPower, None)
            self.AddMatchString(re.compile(b'd [0-9a-f]{2} OK(01|00|10)x'), self.__MatchScreenMute, None)
            self.AddMatchString(re.compile(b'f [0-9a-f]{2} OK([0-9a-fA-F]{2})x'), self.__MatchVolume, None)
            self.AddMatchString(re.compile(b'e [0-9a-f]{2} OK0([10])x'), self.__MatchVolumeMute, None)
            self.AddMatchString(re.compile(b'([jcembladf]) [0-9a-f]{2} NG(.*)x'), self.__MatchError, None)
    ...
    def SetVolumeMute(self, value, qualifier):
        ...
        VolumeMuteCmdString = 'ke {0} {1}\r'.format(self._DeviceID, ValueStateValues[value])
        self.__SetHelper('VolumeMute', VolumeMuteCmdString, value, qualifier)

    def UpdateVolumeMute(self, value, qualifier):

        VolumeMuteCmdString = 'ke {0} FF\r'.format(self._DeviceID)
        self.__UpdateHelper('VolumeMute', VolumeMuteCmdString, value, qualifier)

    def __MatchVolumeMute(self, match, tag):
        ...
        value = ValueStateValues[match.group(1).decode()]
        self.WriteStatus('VolumeMute', value, None)
