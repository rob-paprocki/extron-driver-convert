...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(compile(b'\xAA\xBB\xCC\x40\x07([\x00-\x03])[\x47-\x4A]\xDD\xEE\xFF'), self.__MatchAspectRatio, None)
            self.AddMatchString(compile(b'\xAA\xBB\xCC\x82\x01(\x00|\x01)[\x83\x84]\xDD\xEE\xFF'), self.__MatchAudioMute, None)
            self.AddMatchString(compile(b'\xAA\xBB\xCC\x34\x03(\x01|\x00)[\x38\x37]\xDD\xEE\xFF'), self.__MatchFreeze, None)
            self.AddMatchString(compile(b'\xAA\xBB\xCC\x81([\x05-\x0A])\x00[\x86-\x8B]\xDD\xEE\xFF'), self.__MatchInput, None)
            self.AddMatchString(compile(b'\xAA\xBB\xCC\x40\x01(\x00|\x01)[\x42\x41]\xDD\xEE\xFF'), self.__MatchIRLock, None)
            self.AddMatchString(compile(b'\xAA\xBB\xCC\x40\x00(\x01|\x00)[\x40\x41]\xDD\xEE\xFF'), self.__MatchKeyLock, None)
            self.AddMatchString(compile(b'\xAA\xBB\xCC\x83([\x00-\x02])\x00[\x83-\x85]\xDD\xEE\xFF'), self.__MatchPCPower, None)
            self.AddMatchString(compile(b'\xAA\xBB\xCC\x80(\x01|\x00)\x00[\x80\x81]\xDD\xEE\xFF'), self.__MatchPower, None)
            self.AddMatchString(compile(b'\xAA\xBB\xCC\x40\x12(\x00|\x01)[\x52\x53]\xDD\xEE\xFF'), self.__MatchTouch, None)
            self.AddMatchString(compile(b'\xAA\xBB\xCC\x35\x03(\x00|\x01)[\x38\x39]\xDD\xEE\xFF'), self.__MatchVideoMute, None)
            self.AddMatchString(compile(b'\xAA\xBB\xCC\x82\x00([\x00-\x64])[\x82-\xE6]\xDD\xEE\xFF'), self.__MatchVolume, None)
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            ...
            'DisplayPort': b'\xAA\xBB\xCC\x02\x09\x00\x0B\xDD\xEE\xFF',
            'PC': b'\xAA\xBB\xCC\x02\x08\x00\x0A\xDD\xEE\xFF',
            'Prowise Central (Android)': b'\xAA\xBB\xCC\x02\x0A\x00\x0C\xDD\xEE\xFF'
        }
    ...
    def SetIRLock(self, value, qualifier):
        ...
        ValueStateValues = {
            'On': b'\xAA\xBB\xCC\x38\x05\x00\x3D\xDD\xEE\xFF',
            'Off': b'\xAA\xBB\xCC\x38\x05\x01\x3E\xDD\xEE\xFF'
        }
