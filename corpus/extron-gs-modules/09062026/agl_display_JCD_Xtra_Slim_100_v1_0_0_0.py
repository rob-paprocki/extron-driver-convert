...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\x07\x01\x00\x4D\x49\x4E([\x00\x09\x0A\x0B\x0C\x0D])\x08'), self.__MatchInput, None)
    ...
    def SetFreeze(self, value, qualifier):
        ...
        FreezeCmdString = '\x07\x01\x02\x52\x43\x55\x18\x08'
