...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'c [0-9a-f]{2} OK(0[12469]|1[0-9a-f])x'), self.__MatchAspectRatio, None)
            self.AddMatchString(re.compile(b'm [0-9a-f]{2} OK0(1|0)x'), self.__MatchExecutiveMode, None)
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK([01][01]|20|9[0-3])x', re.I), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'd [0-9a-f]{2} OK(00|01|10)x'), self.__MatchScreenMute, None)
            ...
            self.AddMatchString(re.compile(b'(a|b|c|d|e|f|l|m) [0-9a-f]{2} NG(.*)x'), self.__MatchError, None)
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            ...
            self.Error(['DeviceID variable should a number between 1 to 99 or Broadcast.'])
    ...
    def SetScreenMute(self, value, qualifier):
        ...
        ScreenMuteCmdString = 'kd {0} {1}\r'.format(self._DeviceID, state)
