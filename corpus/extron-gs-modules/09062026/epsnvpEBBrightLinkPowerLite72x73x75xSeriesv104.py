...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'ASPECT=([3-6]0)\r:'), self.__MatchAspectRatio, None)
            self.AddMatchString(re.compile(b'ASPECT=[3-6]0 (30)\r:'), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'SOURCE=(10|20|30|A0|C0|41|51|52|53|56|59)\r:'), self.__MatchInput, None)
    ...
    def SetVolume(self, value, qualifier):
        ...
        if value in ValueStateValues:
            VolumeCmdString = 'VOL {0}\r'.format(ValueStateValues[value])
