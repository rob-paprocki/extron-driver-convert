...
class DeviceClass:
    def __init__(self):
        ...
        self.Models = {
            'Webex Room Kit CE9.14.X': self.csco_12_5086_non_p,
            'Webex Room Kit Plus CE9.14.X': self.csco_12_5086_plus,
            'Webex Room Kit Pro CE9.14.X': self.csco_12_5086_pro,
        }
...
class TimeRE(dict):
    ...
    def compile(self, format):
        return compile(self.pattern(format), IGNORECASE)
