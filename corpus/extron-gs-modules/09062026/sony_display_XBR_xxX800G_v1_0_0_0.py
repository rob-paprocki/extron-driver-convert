...
class DeviceSerialClass:
    ...
    def SetChannelDiscreteCommand(self, value, qualifier):
        ...
        cmdstring = value
        if cmdstring:
            cmdstring = cmdstring.replace('.', ',') #need to replace '.' with ',' for US models
            for x in range(0, 10):
                if x < len(cmdstring):
                    if cmdstring[x] == ',':
                        cmdbyte = b'\x2C'
    ...
    def SetInput(self, value, qualifier):
        ...
        if value == 'Toggle':
            ...
            if value == 'TV':
                ...
                Data = [0x8C, 0x00, 0x02, 0x03, InputStates[value][0], InputStates[value][1]]
    ...
    def UpdateInput(self, value, qualifier):
        ...
        if res:
            try:
                ...
                elif res[2] == 0x03 and res[3] == 0x02 and res[4] == 0x01:
                    self.WriteStatus('Input', 'Video', qualifier)
                elif res[2] == 0x03 and res[3] == 0x03 and res[4] == 0x01:
    ...
    def SetIREmulation(self, value, qualifier):
        ...
        ValueStateValues = {
            'Input'             : b'\x01\x25\x1C', #CAT., DATA, CKS
            'Power'             : b'\x01\x15\x0C',
    ...
    def SetPower(self, value, qualifier):
        ...
        self.__SetHelper('Power', PowerCmdString, value, qualifier)	# query delay per protocol
    ...
    def __UpdateHelper(self, command, commandstring, value, qualifier):
        ...
        if self.Unidirectional == 'True':
            ...
            res = self.SendAndWait(commandstring, self.DefaultResponseTimeout, deliRex=self.CompiledRegex[command])
...
class DeviceEthernetClass:
    ...
    def SetInput(self, value, qualifier):
        ...
        InputCmdString = b''.join([b'*SC', 'INPT'.ljust(11, '0').encode(), InputStates[value][0].ljust(8, '0').encode(), InputStates[value][1], b'\n'])
        self.__SetHelper('Input', InputCmdString, value, qualifier)
