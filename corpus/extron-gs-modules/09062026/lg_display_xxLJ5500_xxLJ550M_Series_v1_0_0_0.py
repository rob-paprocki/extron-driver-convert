...
class DeviceSerialClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'q [0-9A-F]{2} OK0([0-5])x', re.I), self.__MatchEnergySaving, None)
            self.AddMatchString(re.compile(b'm [0-9A-F]{2} OK0([01])x', re.I), self.__MatchExecutiveMode, None)
            self.AddMatchString(re.compile(b'b [0-9A-F]{2} OK([01249][01])x', re.I), self.__MatchInput, None)
            ...
            self.AddMatchString(re.compile(b'([ceqmbladf]) ([0-9A-F]{2}) NG(.*?)x', re.I), self.__MatchError, None)
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            ...
            self.Error(['Device ID should be 1 to 99 or Broadcast.'])
