...
class DeviceSerialClass:
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            ...
            self.Error(['DeviceID range is from 1 to 99 or Broadcast.'])
    ...
    def UpdateAspectRatio(self, value, qualifier):
        CmdString = 'kc {0} FF\r'.format(self.DeviceID)
    ...
    def UpdateAudioMute(self, value, qualifier):
        CmdString = 'ke {0} FF\r'.format(self.DeviceID)
    ...
    def UpdateExecutiveMode(self, value, qualifier):
        CmdString = 'km {0} FF\r'.format(self.DeviceID)
    ...
    def UpdateInput(self, value, qualifier):
        CmdString = 'xb {0} FF\r'.format(self.DeviceID)
    ...
    def UpdatePower(self, value, qualifier):
        ...
        CmdString = 'ka {0} FF\r'.format(self.DeviceID)
    ...
    def UpdateVideoMute(self, value, qualifier):
        CmdString = 'kd {0} FF\r'.format(self.DeviceID)
    ...
    def UpdateVolume(self, value, qualifier):
        CmdString = 'kf {0} FF\r'.format(self.DeviceID)
