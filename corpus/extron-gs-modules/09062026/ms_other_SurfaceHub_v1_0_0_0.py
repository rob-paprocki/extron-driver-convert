...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'Power=(0|1|2|3|4|5)'), self.__MatchPower, None)
            self.AddMatchString(re.compile(b'Source=(0|1|2|3)'), self.__MatchSource, None)
