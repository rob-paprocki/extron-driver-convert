...
class DeviceClass:
    def __init__(self):
        ...
        self.Commands = {
            ...
            'Transport': {'Parameters':['ID'], 'Status': {}},
            }
    ...
    def SetTransport(self, value, qualifier):
        ...
        id = int(qualifier['ID'])
        if 1 <= id <= 999:
            TransportCmdString = 'H-{0}{1:03}'.format(ValueStateValues[value], id)
    ...
    def UpdateTransport(self, value, qualifier):
        ...
        id = int(qualifier['ID'])
        if 1 <= id <= 999:
            TransportCmdString = 'H-4{0:03}'.format(id)
