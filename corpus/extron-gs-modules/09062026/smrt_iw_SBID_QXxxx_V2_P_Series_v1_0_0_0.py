...
class DeviceClass:
    def __init__(self):
        ...
        self.Debug = False
        self.Models = {
            'SBID-QX065-V2-P': self.smrt_38_17205_QX000,
            'SBID-QX075-V2-P': self.smrt_38_17205_QX000,
            'SBID-QX086-V2-P': self.smrt_38_17205_QX000,
            'SBID-QX286-V2-P': self.smrt_38_17205_QX200,
            'SBID-QX265-V2-P': self.smrt_38_17205_QX200,
            'SBID-QX275-V2-P': self.smrt_38_17205_QX200,
        }
    ...
    def UpdateAudioMute(self, value, qualifier):
        ...
        if res:
            try:
                value = ValueStateValues[res[res.index('=')+1:-3]]
    ...
    def UpdateInput(self, value, qualifier):
        ...
        if res:
            try:
                value = self.UpdateInput_ValueStateValues[res[res.index('=')+1:-3]]
