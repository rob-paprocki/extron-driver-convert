...
class DeviceClass:
    ...
    def SetInput(self, value, qualifier):
        ...
        InputState = {
            ...
            'Android Plus'  : b'\xAA\xBB\xCC\x02\x0E\x00\x10\xDD\xEE\xFF', 
    ...
    def SetVolume(self, value, qualifier):
        ...
        if ValueConstraints['Min'] <= value <= ValueConstraints['Max']:
            cks = value + 3
            VolumeCmdString = pack('>10B', 0xAA, 0xBB, 0xCC, 0x03, 0x00, value, cks, 0xDD, 0xEE, 0xFF)
