...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'\x07\x01\x00MIN([\x00\x09-\x0E\x11\x12])\x08'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'\x07\x01\x00PSC([\x00-\x07])\x08'), self.__MatchPIP, None)
            self.AddMatchString(re.compile(b'\x07\x01\x00PIN([\x00\x09-\x0E\x11\x12])\x08'), self.__MatchPIPInput, None)
            self.AddMatchString(re.compile(b'\x07\x01\x00SCM([\x00-\x04])\x08'), self.__MatchPictureMode, None)
            self.AddMatchString(re.compile(b'\x07\x01\x00PIO([\x00\x09-\x0E\x11\x12])\x08'), self.__MatchPIPInputWindow2, None)
            self.AddMatchString(re.compile(b'\x07\x01\x00PIP([\x00\x09-\x0E\x11\x12])\x08'), self.__MatchPIPInputWindow3, None)
    ...
    def SetAspectRatio(self, value, qualifier):
        ...
        ValueStateValues = {
            'Native': b'\x07\x01\x02ASP\x00\x08',
            'Full Screen': b'\x07\x01\x02ASP\x01\x08',
            '4:3': b'\x07\x01\x02ASP\x02\x08',
            'Letterbox': b'\x07\x01\x02ASP\x03\x08'
        }
    ...
    def SetAudioMute(self, value, qualifier):
        ...
        ValueStateValues = {
            'On': b'\x07\x01\x02MUT\x01\x08',
            'Off': b'\x07\x01\x02MUT\x00\x08'
        }
    ...
    def SetExecutiveMode(self, value, qualifier):
        ...
        ValueStateValues = {
            'On': b'\x07\x01\x02KLC\x01\x08',
            'Off': b'\x07\x01\x02KLC\x00\x08'
        }
    ...
    def SetInput(self, value, qualifier):
        ...
        ValueStateValues = {
            'VGA': b'\x07\x01\x02MIN\x00\x08',
            'HDMI 1': b'\x07\x01\x02MIN\x09\x08',
            'HDMI 2': b'\x07\x01\x02MIN\x0A\x08',
            'HDMI 3': b'\x07\x01\x02MIN\x0B\x08',
            'HDMI 4': b'\x07\x01\x02MIN\x0C\x08',
            'HDMI 5 (Front)': b'\x07\x01\x02MIN\x11\x08',
            'DisplayPort': b'\x07\x01\x02MIN\x0D\x08',
            'IPC/OPS': b'\x07\x01\x02MIN\x0E\x08',
            'Media Player (Win/Android)': b'\x07\x01\x02MIN\x12\x08'
        }
    ...
    def SetMenuNavigation(self, value, qualifier):
        ...
        ValueStateValues = {
            'Menu': b'\x07\x01\x02RCU\x00\x08',
            'Info': b'\x07\x01\x02RCU\x01\x08',
            'Up': b'\x07\x01\x02RCU\x02\x08',
            'Down': b'\x07\x01\x02RCU\x03\x08',
            'Left': b'\x07\x01\x02RCU\x04\x08',
            'Right': b'\x07\x01\x02RCU\x05\x08',
            'Enter': b'\x07\x01\x02RCU\x06\x08',
            'Exit': b'\x07\x01\x02RCU\x07\x08'
        }
    ...
    def SetPictureMode(self, value, qualifier):
        ...
        ValueStateValues = {
            'Cinema': b'\x07\x01\x02SCM\x03\x08',
            'Sport': b'\x07\x01\x02SCM\x01\x08',
            'Vivid': b'\x07\x01\x02SCM\x04\x08',
            'User': b'\x07\x01\x02SCM\x00\x08',
            'Game': b'\x07\x01\x02SCM\x02\x08'
        }
    ...
    def SetPIP(self, value, qualifier):
        ...
        ValueStateValues = {
            'Off': b'\x07\x01\x02PSC\x00\x08',
            'Small': b'\x07\x01\x02PSC\x01\x08',
            'Medium': b'\x07\x01\x02PSC\x02\x08',
            'Large': b'\x07\x01\x02PSC\x03\x08',
            'Side by Side': b'\x07\x01\x02PSC\x04\x08',
            '3 Windows': b'\x07\x01\x02PSC\x06\x08',
            '4 Windows': b'\x07\x01\x02PSC\x07\x08'
        }
    ...
    def UpdatePIP(self, value, qualifier):
        ...
        PIPCmdString = b'\x07\x01\x01PSC\x08'
    ...
    def SetPIPInput(self, value, qualifier):
        ...
        ValueStateValues = {
            'VGA': b'\x07\x01\x02PIN\x00\x08',
            'HDMI 1': b'\x07\x01\x02PIN\x09\x08',
            'HDMI 2': b'\x07\x01\x02PIN\x0A\x08',
            'HDMI 3': b'\x07\x01\x02PIN\x0B\x08',
            'HDMI 4': b'\x07\x01\x02PIN\x0C\x08',
            'HDMI 5 (Front)': b'\x07\x01\x02PIN\x11\x08',
            'DisplayPort': b'\x07\x01\x02PIN\x0D\x08',
            'IPC/OPS': b'\x07\x01\x02PIN\x0E\x08',
            'Media Player (Win/Android)': b'\x07\x01\x02PIN\x12\x08'
        }
    ...
    def SetPIPInputWindow2(self, value, qualifier):
        ...
        ValueStateValues = {
            'VGA': b'\x07\x01\x02PIO\x00\x08',
            'HDMI 1': b'\x07\x01\x02PIO\x09\x08',
            'HDMI 2': b'\x07\x01\x02PIO\x0A\x08',
            'HDMI 3': b'\x07\x01\x02PIO\x0B\x08',
            'HDMI 4': b'\x07\x01\x02PIO\x0C\x08',
            'HDMI 5 (Front)': b'\x07\x01\x02PIO\x11\x08',
            'DisplayPort': b'\x07\x01\x02PIO\x0D\x08',
            'IPC/OPS': b'\x07\x01\x02PIO\x0E\x08',
            'Media Player (Win/Android)': b'\x07\x01\x02PIO\x12\x08'
        }
    ...
    def UpdatePIPInputWindow2(self, value, qualifier):
        ...
        PIPInputWindow2CmdString = b'\x07\x01\x01PIO\x08'
    ...
    def SetPIPInputWindow3(self, value, qualifier):
        ...
        ValueStateValues = {
            'VGA': b'\x07\x01\x02PIP\x00\x08',
            'HDMI 1': b'\x07\x01\x02PIP\x09\x08',
            'HDMI 2': b'\x07\x01\x02PIP\x0A\x08',
            'HDMI 3': b'\x07\x01\x02PIP\x0B\x08',
            'HDMI 4': b'\x07\x01\x02PIP\x0C\x08',
            'HDMI 5 (Front)': b'\x07\x01\x02PIP\x11\x08',
            'DisplayPort': b'\x07\x01\x02PIP\x0D\x08',
            'IPC/OPS': b'\x07\x01\x02PIP\x0E\x08',
            'Media Player (Win/Android)': b'\x07\x01\x02PIP\x12\x08'
        }
    ...
    def UpdatePIPInputWindow3(self, value, qualifier):
        ...
        PIPInputWindow3CmdString = b'\x07\x01\x01PIP\x08'
    ...
    def SetPIPPosition(self, value, qualifier):
        ...
        ValueStateValues = {
            'Bottom Left': b'\x07\x01\x02PPO\x00\x08',
            'Bottom Right': b'\x07\x01\x02PPO\x01\x08',
            'Top Left': b'\x07\x01\x02PPO\x02\x08',
            'Top Right': b'\x07\x01\x02PPO\x03\x08'
        }
    ...
    def SetPower(self, value, qualifier):
        ...
        ValueStateValues = {
            'On': b'\x07\x01\x02POW\x01\x08',
            'Off': b'\x07\x01\x02POW\x00\x08'
        }
    ...
    def SetRCEmulation(self, value, qualifier):
        ...
        ValueStateValues = {
            'Freeze': b'\x07\x01\x02RCU\x18\x08',
            'Blank Screen': b'\x07\x01\x02RCU\x2B\x08',
            'Volume Up': b'\x07\x01\x02RCU\x1D\x08',
            'Volume Down': b'\x07\x01\x02RCU\x1E\x08'
        }
    ...
    def SetVolume(self, value, qualifier):
        ...
        if ValueConstraints['Min'] <= value <= ValueConstraints['Max']:
            VolumeCmdString = value.to_bytes(1, 'big').join([b'\x07\x01\x02VOL', b'\x08'])
