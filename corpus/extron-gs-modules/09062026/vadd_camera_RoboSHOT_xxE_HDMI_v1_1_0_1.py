...
class DeviceSerialClass:
    ...
    def SetAutoIris(self, value, qualifier):
        ...
        ValueStateValues = {
            'Auto': b'\x01\x04\x39\x00\xFF',
            'Manual': b'\x01\x04\x39\x03\xFF'
        }

        if value in ValueStateValues:
            AutoIrisCmdString = self._DeviceID + ValueStateValues[value]
    ...
    def SetPanTilt(self, value, qualifier):
        ...
        if value in ValueStateValues and 1 <= int(qualifier['Pan Speed']) <= 24 and 1 <= int(qualifier['Tilt Speed']) <= 20:
            if value == 'Home':
                PanTiltCmdString = self._DeviceID + ValueStateValues[value]
            else:
                PanTiltCmdString = self._DeviceID + b'\x01\x06\x01' + pack('BB', int(qualifier['Pan Speed']), int(qualifier['Tilt Speed'])) \
    ...
    def SetPresetRecall(self, value, qualifier):
        ...
        value = int(value) - 1
        if 0 <= value <= 15:
            PresetRecallCmdString = self._DeviceID + b'\x01\x04\x3F\x02' + pack('B', value) + b'\xFF'
    ...
    def SetPresetSave(self, value, qualifier):
        ...
        value = int(value) - 1
        if 0 <= value <= 15:
            PresetSaveCmdString = self._DeviceID + b'\x01\x04\x3F\x01' + pack('B', value) + b'\xFF'
    ...
    def SetZoom(self, value, qualifier):
        ...
        if value in ValueStateValues and 0 <= int(qualifier['Speed']) <= 7:
            if value == 'Stop':
                ...
                ZoomCmdString = self._DeviceID + b'\x01\x04\x07' + pack('B', ValueStateValues[value] + int(qualifier['Speed'])) + b'\xFF'
...
class DeviceEthernetClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            ...
            self.AddMatchString(re.compile(b'backlight_compensation\s+(on|off)\r\n'), self.__MatchBacklight, None)
            self.AddMatchString(re.compile(b'iris\s+(\d{1,2})\r\n'), self.__MatchIris, None)
    ...
    def SetAutoFocus(self, value, qualifier):
        ...
        ValueStateValues = {
            'Auto'   : 'camera focus mode auto\r\n',
            'Manual' : 'camera focus mode manual\r\n'
        }
    ...
    def SetPan(self, value, qualifier):
        ...
        if value in ValueStateValues and 1 <= int(qualifier['Speed']) <= 24:
            if value == 'Stop':
                PanCmdString = ValueStateValues[value]
            else:
                PanCmdString = ValueStateValues[value] + qualifier['Speed'] + '\r\n'
    ...
    def SetTilt(self, value, qualifier):
        ...
        if value in ValueStateValues and 1 <= int(qualifier['Speed']) <= 20:
            if value == 'Stop':
                TiltCmdString = ValueStateValues[value]
            else:
                TiltCmdString = ValueStateValues[value] + qualifier['Speed'] + '\r\n'
    ...
    def SetZoom(self, value, qualifier):
        ...
        if value in ValueStateValues and 1 <= int(qualifier['Speed']) <= 7:
            if value == 'Stop':
                ZoomCmdString = ValueStateValues[value]
            else:
                ZoomCmdString = ValueStateValues[value] + qualifier['Speed'] + '\r\n'
            self.__SetHelper('Zoom', ZoomCmdString, value, qualifier)
        else:
            self.Discard('Invalid Command for SetZoom')
