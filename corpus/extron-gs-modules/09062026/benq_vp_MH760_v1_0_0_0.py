...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'\*3D=(OFF|AUTO|TB|FS|FP|SBS|DA|IV)#\r', re.I), self.__Match3DMode, None)
            self.AddMatchString(re.compile(b'\*ASP=(AUTO|REAL|4:3|16:9|16:10)#\r', re.I), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'\*SOUR=(RGB|HDMI|HDMI2|SVID|YPBR|VID)#\r', re.I), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'\*LAMPM=(LNOR|ECO)#\r', re.I), self.__MatchLampMode, None)
            ...
            self.AddMatchString(re.compile(b'\*VOL=(\d+)#\r'), self.__MatchVolumeStatus, None)
