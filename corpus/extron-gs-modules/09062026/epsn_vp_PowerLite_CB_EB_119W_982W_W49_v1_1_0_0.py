...
class DeviceClass:
    def __init__(self):
        ...
        self.Models = {
            'PowerLite 119W': self.epsn_1_4533_others,
            'CB-119W': self.epsn_1_4533_others,
            'EB-982W': self.epsn_1_4533_others,
            'PowerLite 982W': self.epsn_1_4533_others,
            'CB-982W': self.epsn_1_4533_others,
            'EB-W49': self.epsn_1_4533_W49,
            'PowerLite W49': self.epsn_1_4533_W49,
            }
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'ASPECT=([02-6]0)\r:'), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'SOURCE=(10|20|30|A0|41|51|52|53)\r:'), self.__MatchInput, None)
            self.AddMatchString(re.compile(b'LUMINANCE=(0[0-2])\r:'), self.__MatchLampMode, None)
    ...
    def SetSplitScreenSource(self, value, qualifier):
        ...
        if side in SideStates and value in self.SetInput_ValueStateValues:
            SplitScreenSourceCmdString = 'SPS {} {}\r'.format(SideStates[side], self.SetInput_ValueStateValues[value])
