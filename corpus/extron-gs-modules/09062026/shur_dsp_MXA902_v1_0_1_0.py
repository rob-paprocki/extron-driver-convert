...
class DeviceClass:
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'< REP (09|10|11|12) AUDIO_GAIN_HI_RES (\d+) >'), self.__MatchAudioGain, None)
            self.AddMatchString(re.compile(b'< REP (09|10|11|12) AUDIO_MUTE (ON|OFF) >', re.I), self.__MatchChannelMute, None)
            ...
            self.AddMatchString(re.compile(b'< REP SPEAKER (ON|OFF) >', re.I), self.__MatchLoudspeakerMute, None)
    ...
    def SetAudioGain(self, value, qualifier):
        ...
        if qualifier['Channel'] in ChannelStates and -110 <= value <= 30:
            AudioGainCmdString = '< SET {} AUDIO_GAIN_HI_RES {} >'.format(ChannelStates[channel], int(value * 10) + 1100)
    ...
    def SetLoudspeakerMute(self, value, qualifier):
        ...
        if value in ValueStateValues:
            LoudspeakerMuteCmdString = '< SET SPEAKER {} >'.format(ValueStateValues[value])
    ...
    def UpdateLoudspeakerMute(self, value, qualifier):
        ...
        LoudspeakerMuteCmdString = '< GET SPEAKER >'
