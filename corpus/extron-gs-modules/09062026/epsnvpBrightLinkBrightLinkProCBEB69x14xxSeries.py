...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'ASPECT=(20 30|00|20|30|40|50|60)\r:'), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'PWR=(00|01|02|03|04)\r:'), self.__MatchPower, None)
