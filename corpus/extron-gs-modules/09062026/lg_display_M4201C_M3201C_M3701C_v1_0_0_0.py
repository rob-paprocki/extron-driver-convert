...
class DeviceClass:
    ...
    def __init__(self):
        ...
        if self.Unidirectional == 'False':
            self.AddMatchString(re.compile(b'c [0-9a-f]{2} OK0([123456789])x', re.I), self.__MatchAspectRatio, None)
            ...
            self.AddMatchString(re.compile(b'b [0-9a-f]{2} OK0([2456789])x', re.I), self.__MatchInput, None)
    ...
    def DeviceID(self, value):
        if value == 'Broadcast':
            ...
            print('Invalid DeviceID value. Range is from 1 to 99 or Broadcast')
    ...
    def __MatchError(self, match, tag):
        ...
        self.Error(['{0} Error: {1}'.format(State[match.group(1).decode()], match.group(2).decode())])
