...
Eight `.pkp` in `out/`, all built from Extron's own 1 Beyond PTZ-IP12/IP20
package (`1bynd_19_4743`). **Install `20027` only.** The first four are the
...
All eight keep the internal identity string `1bynd_19_4743`. T0 established that
