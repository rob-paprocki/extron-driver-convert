...
**feedback on a synthesised numeric status** (20026, 2026-09-17). **Not yet
...
Seven `.pkp` in `out/`, all built from Extron's own 1 Beyond PTZ-IP12/IP20
package (`1bynd_19_4743`). **Install `20026` only.** The first four are the
...
All seven keep the internal identity string `1bynd_19_4743`. T0 established that
