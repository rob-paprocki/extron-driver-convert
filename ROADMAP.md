...
Cheapest failure first. Each session should capture **raw reply bytes**, because a single capture fixes a parser. **Fix R3 (QUICKSTART / PROTOCOL) before sending anyone out** — the current QUICKSTART tells the tester to call a method that raises.
...
| GCP licence expiry ~2026-10-07 | Inferred; the counter read "30 Days" on 09-07, 09-09 and 09-10 | §6 |
